...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$getMessage$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$getMessage$1 extends Lambda implements Function1<MessageResponse, Message> {
    public static final GsonChatApi$getMessage$1 INSTANCE = new GsonChatApi$getMessage$1();

    GsonChatApi$getMessage$1() {
        super(1);
    }
