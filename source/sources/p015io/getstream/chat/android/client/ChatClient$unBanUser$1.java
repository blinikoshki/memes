...
/* renamed from: io.getstream.chat.android.client.ChatClient$unBanUser$1 */
/* compiled from: ChatClient.kt */
final class ChatClient$unBanUser$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final ChatClient$unBanUser$1 INSTANCE = new ChatClient$unBanUser$1();

    ChatClient$unBanUser$1() {
        super(1);
    }
