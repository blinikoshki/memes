...
/* renamed from: io.getstream.chat.android.client.ChatClient$subscribeFor$filter$4 */
/* compiled from: ChatClient.kt */
final class ChatClient$subscribeFor$filter$4 extends Lambda implements Function1<ChatEvent, Boolean> {
    final /* synthetic */ Class[] $eventTypes;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChatClient$subscribeFor$filter$4(Class[] clsArr) {
        super(1);
    ...
    public final boolean invoke(ChatEvent chatEvent) {
        ...
        for (Class isInstance : this.$eventTypes) {
            if (isInstance.isInstance(chatEvent)) {
                return true;
            }
        }
        return false;
