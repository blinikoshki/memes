...
final class CommonSliderFragment$onCreateView$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ CommonSliderFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CommonSliderFragment$onCreateView$1(CommonSliderFragment commonSliderFragment) {
        super(0);
        this.this$0 = commonSliderFragment;
    }

    public final void invoke() {
        this.this$0.getViewModel().resetSlider();
    }
}
