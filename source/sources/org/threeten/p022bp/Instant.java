...
public final class Instant extends DefaultInterfaceTemporalAccessor implements Temporal, TemporalAdjuster, Comparable<Instant>, Serializable {
    ...
    public static Instant ofEpochSecond(long j, long j2) {
        return create(Jdk8Methods.safeAdd(j, Jdk8Methods.floorDiv(j2, (long) C1844C.NANOS_PER_SECOND)), Jdk8Methods.floorMod(j2, 1000000000));
    }
    ...
    public int get(TemporalField temporalField) {
        ...
        int i = C24922.$SwitchMap$org$threeten$bp$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
        if (i == 1) {
            return this.nanos;
        }
        if (i == 2) {
    ...
    public long getLong(TemporalField temporalField) {
        ...
        int i2 = C24922.$SwitchMap$org$threeten$bp$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
        if (i2 == 1) {
            i = this.nanos;
        } else if (i2 == 2) {
            i = this.nanos / 1000;
    ...
    public Instant with(TemporalField temporalField, long j) {
        ...
        int i = C24922.$SwitchMap$org$threeten$bp$temporal$ChronoField[chronoField.ordinal()];
        if (i == 1) {
    ...
    public Instant truncatedTo(TemporalUnit temporalUnit) {
        ...
        if (duration.getSeconds() <= 86400) {
            ...
            if (86400000000000L % nanos2 == 0) {
                long j = ((this.seconds % 86400) * C1844C.NANOS_PER_SECOND) + ((long) this.nanos);
    ...
    static /* synthetic */ class C24922 {
        ...
        static {
            ...
            L_0x0033:
                ...
                org.threeten.bp.temporal.ChronoUnit r5 = org.threeten.p022bp.temporal.ChronoUnit.MINUTES     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                ...
                org.threeten.bp.temporal.ChronoUnit r5 = org.threeten.p022bp.temporal.ChronoUnit.HOURS     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                ...
                org.threeten.bp.temporal.ChronoUnit r5 = org.threeten.p022bp.temporal.ChronoUnit.HALF_DAYS     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                ...
                org.threeten.bp.temporal.ChronoUnit r5 = org.threeten.p022bp.temporal.ChronoUnit.DAYS     // Catch:{ NoSuchFieldError -> 0x0060 }
                int r5 = r5.ordinal()     // Catch:{ NoSuchFieldError -> 0x0060 }
                r6 = 8
                r4[r5] = r6     // Catch:{ NoSuchFieldError -> 0x0060 }
            L_0x0060:
                org.threeten.bp.temporal.ChronoField[] r4 = org.threeten.p022bp.temporal.ChronoField.values()
                int r4 = r4.length
                int[] r4 = new int[r4]
                $SwitchMap$org$threeten$bp$temporal$ChronoField = r4
                org.threeten.bp.temporal.ChronoField r5 = org.threeten.p022bp.temporal.ChronoField.NANO_OF_SECOND     // Catch:{ NoSuchFieldError -> 0x0071 }
            ...
            L_0x0071:
                ...
                org.threeten.bp.temporal.ChronoField r4 = org.threeten.p022bp.temporal.ChronoField.MICRO_OF_SECOND     // Catch:{ NoSuchFieldError -> 0x007b }
            ...
            L_0x007b:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.MILLI_OF_SECOND     // Catch:{ NoSuchFieldError -> 0x0085 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0085 }
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0085 }
            L_0x0085:
                int[] r0 = $SwitchMap$org$threeten$bp$temporal$ChronoField     // Catch:{ NoSuchFieldError -> 0x008f }
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.INSTANT_SECONDS     // Catch:{ NoSuchFieldError -> 0x008f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x008f }
                r0[r1] = r3     // Catch:{ NoSuchFieldError -> 0x008f }
            L_0x008f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.Instant.C24922.<clinit>():void");
        }
    }
    ...
    private Instant plus(long j, long j2) {
        ...
        return ofEpochSecond(Jdk8Methods.safeAdd(Jdk8Methods.safeAdd(this.seconds, j), j2 / C1844C.NANOS_PER_SECOND), ((long) this.nanos) + (j2 % C1844C.NANOS_PER_SECOND));
    }
    ...
    public long toEpochMilli() {
        long j = this.seconds;
        if (j >= 0) {
            return Jdk8Methods.safeAdd(Jdk8Methods.safeMultiply(j, 1000), (long) (this.nanos / NANOS_PER_MILLI));
        }
        return Jdk8Methods.safeSubtract(Jdk8Methods.safeMultiply(j + 1, 1000), 1000 - ((long) (this.nanos / NANOS_PER_MILLI)));
    }
