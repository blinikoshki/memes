...
final class TextSpacingFragment$onCreateView$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ TextSpacingFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TextSpacingFragment$onCreateView$1(TextSpacingFragment textSpacingFragment) {
        super(0);
