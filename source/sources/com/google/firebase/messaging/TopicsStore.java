...
final class TopicsStore {
    ...
    private synchronized void initStore() {
        this.topicOperationsQueue = SharedPreferencesQueue.createInstance(this.sharedPreferences, "topic_operation_queue", Util.EVENT_ID_SEPARATOR, this.syncExecutor);
    }
