...
final class zaa implements PendingResult.StatusListener {
    ...
    public final void onComplete(com.google.android.gms.common.api.Status r5) {
        /*
            ...
            monitor-enter(r0)
            com.google.android.gms.common.api.Batch r1 = r4.zabb     // Catch:{ all -> 0x0066 }
        ...
        L_0x0011:
            ...
            com.google.android.gms.common.api.Batch r5 = r4.zabb     // Catch:{ all -> 0x0066 }
            boolean unused = r5.zabe = true     // Catch:{ all -> 0x0066 }
            goto L_0x0029
        L_0x001e:
            boolean r5 = r5.isSuccess()     // Catch:{ all -> 0x0066 }
            if (r5 != 0) goto L_0x0029
            com.google.android.gms.common.api.Batch r5 = r4.zabb     // Catch:{ all -> 0x0066 }
            boolean unused = r5.zabd = true     // Catch:{ all -> 0x0066 }
        L_0x0029:
            com.google.android.gms.common.api.Batch r5 = r4.zabb     // Catch:{ all -> 0x0066 }
            com.google.android.gms.common.api.Batch.zab(r5)     // Catch:{ all -> 0x0066 }
            com.google.android.gms.common.api.Batch r5 = r4.zabb     // Catch:{ all -> 0x0066 }
            int r5 = r5.zabc     // Catch:{ all -> 0x0066 }
            if (r5 != 0) goto L_0x0064
            com.google.android.gms.common.api.Batch r5 = r4.zabb     // Catch:{ all -> 0x0066 }
            boolean r5 = r5.zabe     // Catch:{ all -> 0x0066 }
        ...
        L_0x0044:
            com.google.android.gms.common.api.Batch r5 = r4.zabb     // Catch:{ all -> 0x0066 }
            boolean r5 = r5.zabd     // Catch:{ all -> 0x0066 }
        ...
        L_0x0056:
            ...
            com.google.android.gms.common.api.PendingResult[] r3 = r1.zabf     // Catch:{ all -> 0x0066 }
