...
final class ZoneRegion extends ZoneId implements Serializable {
    ...
    private static ZoneRegion ofLenient(String str) {
        if (str.equals("Z") || str.startsWith("+") || str.startsWith(CoreConfig.ENTITY_TOKEN_PREFIX)) {
    ...
    public ZoneRules getRules() {
        ...
        return zoneRules != null ? zoneRules : ZoneRulesProvider.getRules(this.f495id, false);
    }
    ...
    public void writeExternal(DataOutput dataOutput) throws IOException {
        dataOutput.writeUTF(this.f495id);
    }
