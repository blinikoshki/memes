...
public class CombinableMatcher<T> extends TypeSafeDiagnosingMatcher<T> {
    ...
    /* renamed from: or */
    public CombinableMatcher<T> mo34479or(Matcher<? super T> matcher2) {
    ...
    public static final class CombinableEitherMatcher<X> {
        ...
        /* renamed from: or */
        public CombinableMatcher<X> mo34481or(Matcher<? super X> matcher) {
            return new CombinableMatcher(this.first).mo34479or(matcher);
        }
    }
}
