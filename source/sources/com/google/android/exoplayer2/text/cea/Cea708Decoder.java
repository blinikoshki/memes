...
public final class Cea708Decoder extends CeaDecoder {
            ...
            if ((i == 2 || i == 3) && z2) {
                if (i == 3) {
                    ...
                    if (dtvCcPacket3 == null) {
                        Log.m354e(TAG, "Encountered DTVCC_PACKET_DATA before DTVCC_PACKET_START");
                    } else {
    ...
    private void handleC1Command(int r5) {
        ...
        L_0x0008:
            ...
            com.google.android.exoplayer2.util.Log.m358w(r0, r5)
            goto L_0x0119
        L_0x0022:
            int r5 = r5 + -152
    ...
    private void handleG2Character(int i) {
        if (i == 32) {
            ...
            this.currentCueInfoBuilder.append(Typography.f372tm);
        } else if (i == 58) {
    ...
    private List<Cue> getDisplayCues() {
        ...
        Collections.sort(arrayList, $$Lambda$Cea708Decoder$dczT9scwCJpSZSpuDkJhAr4tdyI.INSTANCE);
    ...
    private static final class CueInfoBuilder {
        ...
        public com.google.android.exoplayer2.text.cea.Cea708Decoder.Cea708CueInfo build() {
            ...
            L_0x00a7:
                r9 = 2
            L_0x00a8:
                int r11 = r15.windowFillColor
                int r1 = COLOR_SOLID_BLACK
