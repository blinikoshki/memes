...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$sendAction$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$sendAction$1 extends Lambda implements Function1<MessageResponse, Message> {
    public static final GsonChatApi$sendAction$1 INSTANCE = new GsonChatApi$sendAction$1();

    GsonChatApi$sendAction$1() {
        super(1);
    }
