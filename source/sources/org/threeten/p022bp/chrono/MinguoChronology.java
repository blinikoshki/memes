...
public final class MinguoChronology extends Chronology implements Serializable {
    ...
    public MinguoDate date(int i, int i2, int i3) {
        return new MinguoDate(LocalDate.m243of(i + YEARS_DIFFERENCE, i2, i3));
    }
    ...
    static /* synthetic */ class C25291 {
        ...
        static {
            /*
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.PROLEPTIC_MONTH     // Catch:{ NoSuchFieldError -> 0x0012 }
            ...
            L_0x001d:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.YEAR     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.MinguoChronology.C25291.<clinit>():void");
        }
    }

    public ValueRange range(ChronoField chronoField) {
        int i = C25291.$SwitchMap$org$threeten$bp$temporal$ChronoField[chronoField.ordinal()];
        if (i == 1) {
            ValueRange range = ChronoField.PROLEPTIC_MONTH.range();
            return ValueRange.m288of(range.getMinimum() - 22932, range.getMaximum() - 22932);
        } else if (i == 2) {
            ValueRange range2 = ChronoField.YEAR.range();
            return ValueRange.m289of(1, range2.getMaximum() - 1911, (-range2.getMinimum()) + 1 + 1911);
        } else if (i != 3) {
            return chronoField.range();
        } else {
            ValueRange range3 = ChronoField.YEAR.range();
            return ValueRange.m288of(range3.getMinimum() - 1911, range3.getMaximum() - 1911);
        }
    }
