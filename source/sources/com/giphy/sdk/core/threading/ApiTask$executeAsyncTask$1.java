        ...
        try {
            ...
            if (!currentThread.isInterrupted()) {
                this.this$0.completionExecutor.execute(new Runnable(this) {
                    ...
                    public final void run() {
                        this.this$0.$completionHandler.onComplete(call, (Throwable) null);
                    }
                });
                return;
            }
            ...
            this.this$0.completionExecutor.execute(new Runnable(this) {
                ...
                public final void run() {
                    this.this$0.$completionHandler.onComplete(null, e);
                }
            });
            ...
            this.this$0.completionExecutor.execute(new Runnable(this) {
                ...
                public final void run() {
                    this.this$0.$completionHandler.onComplete(null, th);
                }
            });
        }
    }
