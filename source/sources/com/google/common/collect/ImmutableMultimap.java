...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m458of() {
        return ImmutableListMultimap.m446of();
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m459of(K k, V v) {
        return ImmutableListMultimap.m447of(k, v);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m460of(K k, V v, K k2, V v2) {
        return ImmutableListMultimap.m448of(k, v, k2, v2);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m461of(K k, V v, K k2, V v2, K k3, V v3) {
        return ImmutableListMultimap.m449of(k, v, k2, v2, k3, v3);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m462of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        return ImmutableListMultimap.m450of(k, v, k2, v2, k3, v3, k4, v4);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m463of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        return ImmutableListMultimap.m451of(k, v, k2, v2, k3, v3, k4, v4, k5, v5);
    }
