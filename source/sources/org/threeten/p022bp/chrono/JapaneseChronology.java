...
public final class JapaneseChronology extends Chronology implements Serializable {
    ...
    public JapaneseDate date(Era era, int i, int i2, int i3) {
        if (era instanceof JapaneseEra) {
            return JapaneseDate.m281of((JapaneseEra) era, i, i2, i3);
        }
    ...
    public int prolepticYear(Era era, int i) {
        if (era instanceof JapaneseEra) {
            ...
            ValueRange.m288of(1, (long) ((japaneseEra.endDate().getYear() - japaneseEra.startDate().getYear()) + 1)).checkValidValue((long) i, ChronoField.YEAR_OF_ERA);
            return year;
        }
        throw new ClassCastException("Era must be JapaneseEra");
    }
            ...
            default:
                ...
                switch (chronoField) {
                    case ERA:
                        ...
                        return ValueRange.m288of((long) values[0].getValue(), (long) values[values.length - 1].getValue());
                    case YEAR:
                        JapaneseEra[] values2 = JapaneseEra.values();
                        return ValueRange.m288of((long) JapaneseDate.MIN_DATE.getYear(), (long) values2[values2.length - 1].endDate().getYear());
                    case YEAR_OF_ERA:
                        ...
                        return ValueRange.m290of(1, 6, (long) i2, (long) year);
                    case MONTH_OF_YEAR:
                        return ValueRange.m290of((long) (instance.getMinimum(2) + 1), (long) (instance.getGreatestMinimum(2) + 1), (long) (instance.getLeastMaximum(2) + 1), (long) (instance.getMaximum(2) + 1));
                    case DAY_OF_YEAR:
                        ...
                        return ValueRange.m289of(1, (long) i3, 366);
                    default:
        ...
        if (i >= 1) {
            ...
            if (date.getEra() != japaneseEra) {
                if (Math.abs(date.getEra().getValue() - japaneseEra.getValue()) > 1) {
                    throw new DateTimeException("Invalid Era/YearOfEra: " + japaneseEra + StringUtils.SPACE + i);
