...
final class SignatureActivity$onCreate$6<T> implements Observer<MediaContent> {
    final /* synthetic */ SignatureActivity this$0;

    SignatureActivity$onCreate$6(SignatureActivity signatureActivity) {
    ...
    public final void onChanged(MediaContent mediaContent) {
        ...
        Intrinsics.checkNotNullExpressionValue(mediaContent, "content");
        signatureActivity.submitSignatureContent(mediaContent);
    }
}
