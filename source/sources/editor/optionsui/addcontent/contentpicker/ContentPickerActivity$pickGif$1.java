...
final class ContentPickerActivity$pickGif$1 extends Lambda implements Function1<MediaPickResult, Unit> {
    final /* synthetic */ ContentPickerActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ContentPickerActivity$pickGif$1(ContentPickerActivity contentPickerActivity) {
        super(1);
    ...
    public final void invoke(MediaPickResult mediaPickResult) {
        ...
        if (content != null) {
            ...
            Timber.m303e("Unable to pick gif; " + mediaPickResult.getMessage(), new Object[0]);
            this.this$0.exitWithError("Unable to pick gif");
        }
    }
}
