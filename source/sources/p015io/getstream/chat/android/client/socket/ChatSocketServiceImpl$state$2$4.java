...
/* renamed from: io.getstream.chat.android.client.socket.ChatSocketServiceImpl$state$2$4 */
/* compiled from: ChatSocketServiceImpl.kt */
final class ChatSocketServiceImpl$state$2$4 extends Lambda implements Function1<SocketListener, Unit> {
    public static final ChatSocketServiceImpl$state$2$4 INSTANCE = new ChatSocketServiceImpl$state$2$4();

    ChatSocketServiceImpl$state$2$4() {
        super(1);
    }
