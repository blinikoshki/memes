...
final class MediaAdjustFragment$onCreateView$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ MediaAdjustFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MediaAdjustFragment$onCreateView$1(MediaAdjustFragment mediaAdjustFragment) {
        super(0);
        this.this$0 = mediaAdjustFragment;
    }

    public final void invoke() {
        this.this$0.getViewModel().selectNudgeOption();
    }
}
