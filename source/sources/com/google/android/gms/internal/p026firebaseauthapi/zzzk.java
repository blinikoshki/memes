...
final class zzzk extends zzzh {
    private final OutputStream zzf;

    zzzk(OutputStream outputStream, int i) {
        super(i);
    ...
    public final void zzs(String str) throws IOException {
        ...
        try {
            ...
            if (zzA2 == zzA) {
                int i5 = i + zzA2;
                this.zzc = i5;
                int zzd2 = zzacx.zzd(str, this.zza, i5, this.zzb - i5);
                this.zzc = i;
                i2 = (zzd2 - i) - zzA2;
                zzd(i2);
                this.zzc = zzd2;
                ...
                i2 = zzacx.zzc(str);
                zzd(i2);
                this.zzc = zzacx.zzd(str, this.zza, this.zzc, i2);
            }
            this.zzd += i2;
        } catch (zzacv e) {
            this.zzd -= this.zzc - i;
