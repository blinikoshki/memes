...
public class GlPhotoSobelEdgeDetectionFilter extends GlPhotoFilterGroup {
    ...
    public GlPhotoSobelEdgeDetectionFilter() {
        addFilter(new GlPhotoGrayscaleFilter());
        addFilter(new GlPhoto3x3TextureSamplingFilter(SOBEL_EDGE_DETECTION));
    }
