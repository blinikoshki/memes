...
public enum KotlinTarget {
    ...
    FIELD(QuerySort.KEY_FIELD_NAME, false, 2, (boolean) null),
    ...
    static {
        ...
        USE_SITE_MAPPING = MapsKt.mapOf(TuplesKt.m181to(annotationUseSiteTarget, kotlinTarget3), TuplesKt.m181to(annotationUseSiteTarget2, kotlinTarget4), TuplesKt.m181to(AnnotationUseSiteTarget.PROPERTY, PROPERTY), TuplesKt.m181to(AnnotationUseSiteTarget.FILE, FILE), TuplesKt.m181to(AnnotationUseSiteTarget.PROPERTY_GETTER, PROPERTY_GETTER), TuplesKt.m181to(AnnotationUseSiteTarget.PROPERTY_SETTER, PROPERTY_SETTER), TuplesKt.m181to(AnnotationUseSiteTarget.RECEIVER, kotlinTarget3), TuplesKt.m181to(AnnotationUseSiteTarget.SETTER_PARAMETER, kotlinTarget3), TuplesKt.m181to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, kotlinTarget4));
    }
