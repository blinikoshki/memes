...
import androidx.cardview.C0193R;
...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0193R.attr.cardViewStyle);
    }
    ...
    public CardView(Context context, AttributeSet attributeSet, int i) {
        ...
        C01961 r3 = new CardViewDelegate() {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0193R.styleable.CardView, i, C0193R.C0195style.CardView);
        if (obtainStyledAttributes.hasValue(C0193R.styleable.CardView_cardBackgroundColor)) {
            valueOf = obtainStyledAttributes.getColorStateList(C0193R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (fArr[2] > 0.5f) {
                i2 = getResources().getColor(C0193R.C0194color.cardview_light_background);
            } else {
                i2 = getResources().getColor(C0193R.C0194color.cardview_dark_background);
            }
        ...
        rect.left = obtainStyledAttributes.getDimensionPixelSize(C0193R.styleable.CardView_contentPaddingLeft, dimensionPixelSize);
        rect.top = obtainStyledAttributes.getDimensionPixelSize(C0193R.styleable.CardView_contentPaddingTop, dimensionPixelSize);
        rect.right = obtainStyledAttributes.getDimensionPixelSize(C0193R.styleable.CardView_contentPaddingRight, dimensionPixelSize);
        rect.bottom = obtainStyledAttributes.getDimensionPixelSize(C0193R.styleable.CardView_contentPaddingBottom, dimensionPixelSize);
        float f = dimension2 > dimension3 ? dimension2 : dimension3;
        this.mUserSetMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0193R.styleable.CardView_android_minWidth, 0);
        this.mUserSetMinHeight = obtainStyledAttributes.getDimensionPixelSize(C0193R.styleable.CardView_android_minHeight, 0);
