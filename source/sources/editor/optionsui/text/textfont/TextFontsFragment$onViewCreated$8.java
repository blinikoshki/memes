...
final class TextFontsFragment$onViewCreated$8 extends Lambda implements Function1<FontItem, Unit> {
    final /* synthetic */ TextFontsAdapter $adapter;
    final /* synthetic */ TextFontsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TextFontsFragment$onViewCreated$8(TextFontsFragment textFontsFragment, TextFontsAdapter textFontsAdapter) {
        super(1);
    ...
    public final void invoke(final FontItem fontItem) {
        ...
        TextFontsFragment.access$getBinding$p(this.this$0).fontsRecyclerView.post(new Runnable(this) {
            final /* synthetic */ TextFontsFragment$onViewCreated$8 this$0;
            ...
            public final void run() {
                this.this$0.$adapter.removeItem(fontItem);
            }
        });
    }
}
