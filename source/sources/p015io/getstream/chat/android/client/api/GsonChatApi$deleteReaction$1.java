...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$deleteReaction$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$deleteReaction$1 extends Lambda implements Function1<MessageResponse, Message> {
    public static final GsonChatApi$deleteReaction$1 INSTANCE = new GsonChatApi$deleteReaction$1();

    GsonChatApi$deleteReaction$1() {
        super(1);
    }
