...
/* renamed from: com.memes.plus.ui.tagged_posts.TaggedPostsFragment$facebookIntegrationViewModel$2 */
/* compiled from: TaggedPostsFragment.kt */
final class TaggedPostsFragment$facebookIntegrationViewModel$2 extends Lambda implements Function0<FacebookIntegrationViewModel> {
    final /* synthetic */ TaggedPostsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TaggedPostsFragment$facebookIntegrationViewModel$2(TaggedPostsFragment taggedPostsFragment) {
        super(0);
    ...
    public final FacebookIntegrationViewModel invoke() {
        ...
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<FacebookIntegrationViewModel>(this) {
            final /* synthetic */ TaggedPostsFragment$facebookIntegrationViewModel$2 this$0;
