...
/* renamed from: io.getstream.chat.android.livedata.controller.ChannelControllerImpl$sendGiphy$result$1 */
/* compiled from: ChannelControllerImpl.kt */
final class ChannelControllerImpl$sendGiphy$result$1 extends Lambda implements Function0<Call<Message>> {
    final /* synthetic */ SendActionRequest $request;
    final /* synthetic */ ChannelControllerImpl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChannelControllerImpl$sendGiphy$result$1(ChannelControllerImpl channelControllerImpl, SendActionRequest sendActionRequest) {
        super(0);
