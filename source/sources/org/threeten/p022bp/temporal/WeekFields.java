...
public final class WeekFields implements Serializable {
    ...
    public static final WeekFields SUNDAY_START = m292of(DayOfWeek.SUNDAY, 1);
    ...
    /* renamed from: of */
    public static WeekFields m291of(Locale locale) {
        Jdk8Methods.requireNonNull(locale, "locale");
        GregorianCalendar gregorianCalendar = new GregorianCalendar(new Locale(locale.getLanguage(), locale.getCountry()));
        return m292of(DayOfWeek.SUNDAY.plus((long) (gregorianCalendar.getFirstDayOfWeek() - 1)), gregorianCalendar.getMinimalDaysInFirstWeek());
    }

    /* renamed from: of */
    public static WeekFields m292of(DayOfWeek dayOfWeek2, int i) {
    ...
    private Object readResolve() throws InvalidObjectException {
        try {
            return m292of(this.firstDayOfWeek, this.minimalDays);
    ...
    static class ComputedDayOfField implements TemporalField {
        private static final ValueRange DAY_OF_WEEK_RANGE = ValueRange.m288of(1, 7);
        private static final ValueRange WEEK_BASED_YEAR_RANGE = ChronoField.YEAR.range();
        private static final ValueRange WEEK_OF_MONTH_RANGE = ValueRange.m290of(0, 1, 4, 6);
        private static final ValueRange WEEK_OF_WEEK_BASED_YEAR_RANGE = ValueRange.m289of(1, 52, 53);
        private static final ValueRange WEEK_OF_YEAR_RANGE = ValueRange.m290of(0, 1, 52, 54);
        ...
        public ValueRange rangeRefinedBy(TemporalAccessor temporalAccessor) {
            ...
            return ValueRange.m288of((long) computeWeek(startOfWeekOffset, (int) range2.getMinimum()), (long) computeWeek(startOfWeekOffset, (int) range2.getMaximum()));
        }
        ...
        private ValueRange rangeWOWBY(TemporalAccessor temporalAccessor) {
            ...
            return ValueRange.m288of(1, (long) (computeWeek - 1));
        }
