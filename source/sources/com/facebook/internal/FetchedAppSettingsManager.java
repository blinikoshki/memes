...
public final class FetchedAppSettingsManager {
        ...
        if (Utility.isNullOrEmpty(applicationId)) {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() {
                public void run() {
                    ...
                    JSONObject access$000 = FetchedAppSettingsManager.getAppSettingsQueryResponse(applicationId);
                    if (access$000 != null) {
                        FetchedAppSettingsManager.parseAppSettingsFromJSON(applicationId, access$000);
                        sharedPreferences.edit().putString(format, access$000.toString()).apply();
                    }
    ...
    public static JSONObject getAppSettingsQueryResponse(String str) {
        ...
        bundle.putString("fields", TextUtils.join(Util.EVENT_ID_SEPARATOR, new ArrayList(Arrays.asList(APP_SETTING_FIELDS))));
