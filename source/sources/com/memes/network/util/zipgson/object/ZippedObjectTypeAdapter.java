...
public final class ZippedObjectTypeAdapter<T1, T2> extends TypeAdapter<ZippedObject<T1, T2>> {
    ...
    public ZippedObjectTypeAdapter(Gson gson2) {
        Intrinsics.checkNotNullParameter(gson2, "gson");
        this.gson = gson2;
    }

    public void write(JsonWriter jsonWriter, ZippedObject<T1, T2> zippedObject) {
        if (jsonWriter != null && zippedObject != null) {
    ...
    public ZippedObject<T1, T2> read(JsonReader jsonReader) {
