...
/* renamed from: com.memes.plus.ui.auth.recovery.AccountRecoveryViewModel$$special$$inlined$CoroutineExceptionHandler$1 */
/* compiled from: CoroutineExceptionHandler.kt */
public final class C4219x586c4ab0 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    final /* synthetic */ AccountRecoveryViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C4219x586c4ab0(CoroutineContext.Key key, AccountRecoveryViewModel accountRecoveryViewModel) {
        super(key);
    ...
    public void handleException(CoroutineContext coroutineContext, Throwable th) {
        ...
        accountRecoveryViewModel.toast("Account Recovery Error: " + message);
    }
}
