...
final class TextAdjustFragment$onViewCreated$2<T> implements Observer<Float> {
    final /* synthetic */ TextAdjustFragment this$0;

    TextAdjustFragment$onViewCreated$2(TextAdjustFragment textAdjustFragment) {
        this.this$0 = textAdjustFragment;
    }

    public final void onChanged(Float f) {
        ValueSlider valueSlider = TextAdjustFragment.access$getBinding$p(this.this$0).scaleSlider;
