...
final class BottomOptionTabsAdapter$layoutInflater$2 extends Lambda implements Function0<LayoutInflater> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BottomOptionTabsAdapter$layoutInflater$2(Context context) {
        super(0);
