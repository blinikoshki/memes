...
@DebugMetadata(mo26807c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$values$1", mo26808f = "Delay.kt", mo26809i = {0, 0}, mo26810l = {352}, mo26811m = "invokeSuspend", mo26812n = {"$this$produce", "$this$collect$iv"}, mo26813s = {"L$0", "L$1"})
...
final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__DelayKt$debounceInternal$1$values$1.f398p$ = (ProducerScope) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ProducerScope producerScope = this.f398p$;
            Flow flow = this.this$0.$this_debounceInternal;
            this.L$0 = producerScope;
            this.L$1 = flow;
            this.label = 1;
            if (flow.collect(new C2245xec8ab92d(producerScope), this) == coroutine_suspended) {
