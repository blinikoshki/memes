...
final class LayoutBackgroundTabsFragment$layoutTabsViewModel$2 extends Lambda implements Function0<LayoutTabsViewModel> {
    final /* synthetic */ LayoutBackgroundTabsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LayoutBackgroundTabsFragment$layoutTabsViewModel$2(LayoutBackgroundTabsFragment layoutBackgroundTabsFragment) {
        super(0);
    ...
    public final LayoutTabsViewModel invoke() {
        ...
        Function0 function0 = C48621.INSTANCE;
        if (function0 == null) {
