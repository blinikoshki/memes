...
/* renamed from: com.memes.plus.ui.auth.signup.stages.EmailSignUpFragment$signUpViewModel$2 */
/* compiled from: EmailSignUpFragment.kt */
final class EmailSignUpFragment$signUpViewModel$2 extends Lambda implements Function0<SignUpViewModel> {
    final /* synthetic */ EmailSignUpFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EmailSignUpFragment$signUpViewModel$2(EmailSignUpFragment emailSignUpFragment) {
        super(0);
    ...
    public final SignUpViewModel invoke() {
        ...
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<SignUpViewModel>(this) {
            final /* synthetic */ EmailSignUpFragment$signUpViewModel$2 this$0;
