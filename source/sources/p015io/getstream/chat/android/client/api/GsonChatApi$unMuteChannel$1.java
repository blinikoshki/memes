...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$unMuteChannel$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$unMuteChannel$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final GsonChatApi$unMuteChannel$1 INSTANCE = new GsonChatApi$unMuteChannel$1();

    GsonChatApi$unMuteChannel$1() {
        super(1);
    }
