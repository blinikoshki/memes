...
abstract class LineBuffer {
    ...
    public void add(char[] r7, int r8, int r9) throws java.io.IOException {
        ...
        L_0x0052:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.p027io.LineBuffer.add(char[], int, int):void");
    }

    private boolean finishLine(boolean z) throws IOException {
        handleLine(this.line.toString(), this.sawReturn ? z ? "\r\n" : StringUtils.f465CR : z ? StringUtils.f466LF : "");
