...
final class RemoteMemesDataSource$logout$1<T, R> implements Function<Response<ApiMessageResponse>, UniversalResult<Object>> {
    public static final RemoteMemesDataSource$logout$1 INSTANCE = new RemoteMemesDataSource$logout$1();

    RemoteMemesDataSource$logout$1() {
    }
