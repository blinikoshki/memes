...
public class GlPhotoGlassSphereFilter extends GlPhotoFilter {
    ...
    public GlPhotoGlassSphereFilter() {
        this(new PointF(0.5f, 0.5f), 0.25f, 0.71f);
    }

    public GlPhotoGlassSphereFilter(PointF pointF, float f, float f2) {
