...
public class LocalVideoThumbnailProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    public void produceResults(Consumer<CloseableReference<CloseableImage>> consumer, ProducerContext producerContext) {
        ...
        final C14211 r0 = new StatefulProducerRunnable<CloseableReference<CloseableImage>>(consumer, producerListener, producerContext, PRODUCER_NAME) {
            ...
            public CloseableReference<CloseableImage> getResult() throws Exception {
                ...
                producerContext2.setExtra("image_format", "thumbnail");
                closeableStaticBitmap.setImageExtras(producerContext2.getExtras());
                return CloseableReference.m121of(closeableStaticBitmap);
            }

            /* access modifiers changed from: protected */
            public Map<String, String> getExtraMapOnSuccess(CloseableReference<CloseableImage> closeableReference) {
                return ImmutableMap.m29of(LocalVideoThumbnailProducer.CREATED_THUMBNAIL, String.valueOf(closeableReference != null));
            }
