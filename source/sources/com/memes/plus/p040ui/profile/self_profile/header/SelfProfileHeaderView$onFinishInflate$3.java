...
/* renamed from: com.memes.plus.ui.profile.self_profile.header.SelfProfileHeaderView$onFinishInflate$3 */
/* compiled from: SelfProfileHeaderView.kt */
final class SelfProfileHeaderView$onFinishInflate$3 implements View.OnClickListener {
    final /* synthetic */ SelfProfileHeaderView this$0;

    SelfProfileHeaderView$onFinishInflate$3(SelfProfileHeaderView selfProfileHeaderView) {
    ...
    public final void onClick(View view) {
        ...
        if (access$getCallback$p != null) {
            access$getCallback$p.onFollowerCountTapped();
        }
    }
}
