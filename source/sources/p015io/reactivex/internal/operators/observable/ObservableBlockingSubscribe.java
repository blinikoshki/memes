...
public final class ObservableBlockingSubscribe {
    ...
    public static <T> void subscribe(p015io.reactivex.ObservableSource<? extends T> r3, p015io.reactivex.Observer<? super T> r4) {
        /*
        ...
        L_0x002a:
            ...
            java.lang.Object r2 = p015io.reactivex.internal.observers.BlockingObserver.TERMINATED
            if (r3 == r2) goto L_0x003a
            boolean r3 = p015io.reactivex.internal.util.NotificationLite.acceptFull((java.lang.Object) r3, r4)
            if (r3 == 0) goto L_0x0010
        L_0x003a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.observable.ObservableBlockingSubscribe.subscribe(io.reactivex.ObservableSource, io.reactivex.Observer):void");
    }
