...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$rejectInvite$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$rejectInvite$1 extends Lambda implements Function1<ChannelResponse, Channel> {
    final /* synthetic */ GsonChatApi this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GsonChatApi$rejectInvite$1(GsonChatApi gsonChatApi) {
        super(1);
