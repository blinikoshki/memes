...
public final class OffsetTime extends DefaultInterfaceTemporalAccessor implements Temporal, TemporalAdjuster, Comparable<OffsetTime>, Serializable {
    ...
    /* renamed from: of */
    public static OffsetTime m262of(LocalTime localTime, ZoneOffset zoneOffset) {
        return new OffsetTime(localTime, zoneOffset);
    }

    /* renamed from: of */
    public static OffsetTime m261of(int i, int i2, int i3, int i4, ZoneOffset zoneOffset) {
        return new OffsetTime(LocalTime.m254of(i, i2, i3, i4), zoneOffset);
    }
    ...
    public long until(Temporal temporal, TemporalUnit temporalUnit) {
        ...
        switch (C25072.$SwitchMap$org$threeten$bp$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
            ...
            case 4:
                return epochNano / C1844C.NANOS_PER_SECOND;
            case 5:
    ...
    static /* synthetic */ class C25072 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.OffsetTime.C25072.<clinit>():void");
        }
    }

    public OffsetDateTime atDate(LocalDate localDate) {
        return OffsetDateTime.m259of(localDate, this.time, this.offset);
    }
    ...
    private long toEpochNano() {
        return this.time.toNanoOfDay() - (((long) this.offset.getTotalSeconds()) * C1844C.NANOS_PER_SECOND);
    }
    ...
    static OffsetTime readExternal(DataInput dataInput) throws IOException {
        return m262of(LocalTime.readExternal(dataInput), ZoneOffset.readExternal(dataInput));
    }
}
