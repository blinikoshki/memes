...
import androidx.swiperefreshlayout.C0685R;
...
class CircleImageView extends ImageView {
    ...
    CircleImageView(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(C0685R.styleable.SwipeRefreshLayout);
        this.mBackgroundColor = obtainStyledAttributes.getColor(C0685R.styleable.f80xaa980688, DEFAULT_BACKGROUND_COLOR);
