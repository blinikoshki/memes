...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    public final void prepareChildSource(T t, MediaSource mediaSource) {
        ...
        $$Lambda$CompositeMediaSource$lU5TDdLYJk4FzgCLkUChati_nlA r0 = new MediaSource.MediaSourceCaller(t) {
    ...
    private final class ForwardingEventListener implements MediaSourceEventListener, DrmSessionEventListener {
        ...
        private boolean maybeUpdateEventDispatcher(int i, MediaSource.MediaPeriodId mediaPeriodId) {
            ...
            if (mediaPeriodId != null) {
                mediaPeriodId2 = CompositeMediaSource.this.getMediaPeriodIdForChildMediaPeriodId(this.f527id, mediaPeriodId);
            ...
            int windowIndexForChildWindowIndex = CompositeMediaSource.this.getWindowIndexForChildWindowIndex(this.f527id, i);
        ...
        private MediaLoadData maybeUpdateMediaLoadData(MediaLoadData mediaLoadData) {
            long mediaTimeForChildMediaTime = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f527id, mediaLoadData.mediaStartTimeMs);
            long mediaTimeForChildMediaTime2 = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f527id, mediaLoadData.mediaEndTimeMs);
