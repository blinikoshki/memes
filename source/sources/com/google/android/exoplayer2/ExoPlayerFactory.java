...
public final class ExoPlayerFactory {
    ...
    public static ExoPlayer newInstance(Context context, Renderer[] rendererArr, TrackSelector trackSelector, LoadControl loadControl, BandwidthMeter bandwidthMeter, Looper looper) {
        ...
        return new ExoPlayerImpl(rendererArr, trackSelector, new DefaultMediaSourceFactory(context), loadControl, bandwidthMeter, (AnalyticsCollector) null, true, SeekParameters.DEFAULT, false, Clock.DEFAULT, looper);
    }
}
