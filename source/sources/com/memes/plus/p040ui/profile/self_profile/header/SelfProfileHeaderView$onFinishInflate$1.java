...
/* renamed from: com.memes.plus.ui.profile.self_profile.header.SelfProfileHeaderView$onFinishInflate$1 */
/* compiled from: SelfProfileHeaderView.kt */
final class SelfProfileHeaderView$onFinishInflate$1 implements View.OnClickListener {
    final /* synthetic */ SelfProfileHeaderView this$0;

    SelfProfileHeaderView$onFinishInflate$1(SelfProfileHeaderView selfProfileHeaderView) {
    ...
    public final void onClick(View view) {
        ...
        if (access$getCallback$p != null) {
            access$getCallback$p.onProfileOptionsTapped();
        }
    }
}
