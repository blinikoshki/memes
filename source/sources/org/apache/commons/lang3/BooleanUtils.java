...
public class BooleanUtils {
    ...
    public static String toStringTrueFalse(Boolean bool) {
        return toString(bool, ServerProtocol.DIALOG_RETURN_SCOPES_TRUE, "false", (String) null);
    }
    ...
    /* renamed from: or */
    public static boolean m211or(boolean... zArr) {
        if (zArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        } else if (zArr.length != 0) {
            for (boolean z : zArr) {
    ...
    /* renamed from: or */
    public static Boolean m210or(Boolean... boolArr) {
        if (boolArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        } else if (boolArr.length != 0) {
            try {
                return m211or(ArrayUtils.toPrimitive(boolArr)) ? Boolean.TRUE : Boolean.FALSE;
            } catch (NullPointerException unused) {
                throw new IllegalArgumentException("The array must not contain any null elements");
            }
        } else {
