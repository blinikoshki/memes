...
public abstract class ParallelFlowable<T> {
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R mo25728as(ParallelFlowableConverter<T, R> parallelFlowableConverter) {
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <U> U mo25765to(Function<? super ParallelFlowable<T>, U> function) {
        try {
