...
/* renamed from: com.giphy.sdk.ui.pagination.GifDataRepository$loadData$2 */
/* compiled from: GifDataRepository.kt */
final class GifDataRepository$loadData$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ GifDataSourceFactory $sourceFactory;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GifDataRepository$loadData$2(GifDataSourceFactory gifDataSourceFactory) {
        super(0);
