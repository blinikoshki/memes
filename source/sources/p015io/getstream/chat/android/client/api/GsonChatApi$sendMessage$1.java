...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$sendMessage$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$sendMessage$1 extends Lambda implements Function1<MessageResponse, Message> {
    public static final GsonChatApi$sendMessage$1 INSTANCE = new GsonChatApi$sendMessage$1();

    GsonChatApi$sendMessage$1() {
        super(1);
    }
