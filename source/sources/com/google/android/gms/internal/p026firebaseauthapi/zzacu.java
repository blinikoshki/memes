...
/* renamed from: com.google.android.gms.internal.firebase-auth-api.zzacu */
/* compiled from: com.google.firebase:firebase-auth@@20.0.2 */
final class zzacu extends zzact {
    zzacu() {
    }
        ...
        while (r9 < i3) {
            ...
            if (b < 0) {
                if (b < -32) {
                    ...
                    int i6 = i4 + 1;
                    byte b3 = bArr[i4];
                    if (b3 <= -65 && (((b << Ascii.f582FS) + (b3 + 112)) >> 30) == 0) {
                        int i7 = i6 + 1;
                        if (bArr[i6] <= -65) {
                            i4 = i7 + 1;
                            if (bArr[i7] > -65) {
    ...
    public final String zzc(byte[] bArr, int i, int i2) throws zzaal {
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r12 < i4) {
                ...
                if (zzacs.zza(b2)) {
                ...
                } else if (zzacs.zzb(b2)) {
                    if (i6 < i4) {
                        zzacs.zzc(b2, bArr[i6], cArr, i3);
                        r12 = i6 + 1;
                        i3++;
                    } else {
                        throw zzaal.zzi();
                    }
                } else if (zzacs.zzd(b2)) {
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        zzacs.zze(b2, bArr[i6], bArr[i8], cArr, i3);
                        r12 = i8 + 1;
                        i3++;
                    } else {
                        throw zzaal.zzi();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    zzacs.zzf(b2, bArr[i6], bArr[i9], bArr[i10], cArr, i3);
                    i3 += 2;
                    r12 = i10 + 1;
                } else {
                    throw zzaal.zzi();
