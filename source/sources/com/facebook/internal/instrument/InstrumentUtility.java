...
public final class InstrumentUtility {
    ...
    public static File[] listExceptionAnalysisReportFiles() {
        ...
        File[] listFiles = instrumentReportDir.listFiles(new FilenameFilter() {
            public boolean accept(File file, String str) {
                return str.matches(String.format("^%s[0-9]+.json$", new Object[]{InstrumentUtility.ANALYSIS_REPORT_PREFIX}));
            }
        });
    ...
    public static File[] listExceptionReportFiles() {
        ...
        File[] listFiles = instrumentReportDir.listFiles(new FilenameFilter() {
            public boolean accept(File file, String str) {
                return str.matches(String.format("^(%s|%s|%s)[0-9]+.json$", new Object[]{InstrumentUtility.CRASH_REPORT_PREFIX, InstrumentUtility.CRASH_SHIELD_PREFIX, InstrumentUtility.THREAD_CHECK_PREFIX}));
            }
        });
        return listFiles != null ? listFiles : new File[0];
    }
