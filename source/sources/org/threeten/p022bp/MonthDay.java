...
public final class MonthDay extends DefaultInterfaceTemporalAccessor implements TemporalAccessor, TemporalAdjuster, Comparable<MonthDay>, Serializable {
    ...
    public static MonthDay now(Clock clock) {
        ...
        return m257of(now.getMonth(), now.getDayOfMonth());
    }

    /* renamed from: of */
    public static MonthDay m257of(Month month2, int i) {
    ...
    /* renamed from: of */
    public static MonthDay m256of(int i, int i2) {
        return m257of(Month.m255of(i), i2);
    }
    ...
    public static MonthDay from(TemporalAccessor temporalAccessor) {
        ...
        try {
            ...
            return m256of(temporalAccessor.get(ChronoField.MONTH_OF_YEAR), temporalAccessor.get(ChronoField.DAY_OF_MONTH));
    ...
    public ValueRange range(TemporalField temporalField) {
        ...
        if (temporalField == ChronoField.DAY_OF_MONTH) {
            return ValueRange.m289of(1, (long) getMonth().minLength(), (long) getMonth().maxLength());
        }
    ...
    static /* synthetic */ class C25022 {
        ...
        static {
            ...
            L_0x0012:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.MONTH_OF_YEAR     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.MonthDay.C25022.<clinit>():void");
        }
    }
    ...
    public long getLong(TemporalField temporalField) {
        ...
        int i2 = C25022.$SwitchMap$org$threeten$bp$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
        if (i2 == 1) {
            i = this.day;
        } else if (i2 == 2) {
            i = this.month;
    ...
    public LocalDate atYear(int i) {
        return LocalDate.m243of(i, this.month, isValidYear(i) ? this.day : 28);
    }
    ...
    public String toString() {
        ...
        sb.append(this.day < 10 ? "-0" : CoreConfig.ENTITY_TOKEN_PREFIX);
        sb.append(this.day);
        return sb.toString();
    }
    ...
    static MonthDay readExternal(DataInput dataInput) throws IOException {
        return m256of((int) dataInput.readByte(), (int) dataInput.readByte());
    }
}
