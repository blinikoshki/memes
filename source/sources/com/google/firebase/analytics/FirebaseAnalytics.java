...
public final class FirebaseAnalytics {
    ...
    public static FirebaseAnalytics getInstance(Context context) {
        if (zza == null) {
            synchronized (FirebaseAnalytics.class) {
                if (zza == null) {
                    zza = new FirebaseAnalytics(zzbr.zza(context, (String) null, (String) null, (String) null, (Bundle) null));
                }
            }
        }
        return zza;
    ...
    public static zzho getScionFrontendApiImplementation(Context context, Bundle bundle) {
        zzbr zza2 = zzbr.zza(context, (String) null, (String) null, (String) null, bundle);
        if (zza2 == null) {
            return null;
        }
        return new zzc(zza2);
