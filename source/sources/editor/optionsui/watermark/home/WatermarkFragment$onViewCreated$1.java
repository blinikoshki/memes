...
final class WatermarkFragment$onViewCreated$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ WatermarkFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    WatermarkFragment$onViewCreated$1(WatermarkFragment watermarkFragment) {
        super(0);
