...
/* renamed from: io.getstream.chat.android.livedata.ChatDomainImpl$connectionRecovered$cids$1 */
/* compiled from: ChatDomainImpl.kt */
final class ChatDomainImpl$connectionRecovered$cids$1 extends Lambda implements Function1<Map.Entry<String, ChannelControllerImpl>, Boolean> {
    final /* synthetic */ boolean $recoverAll;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChatDomainImpl$connectionRecovered$cids$1(boolean z) {
        super(1);
        this.$recoverAll = z;
    }
    ...
    public final boolean invoke(Map.Entry<String, ChannelControllerImpl> entry) {
        ...
        return entry.getValue().getRecoveryNeeded() || this.$recoverAll;
    }
}
