...
final class ColorsAdapter$layoutInflater$2 extends Lambda implements Function0<LayoutInflater> {
    final /* synthetic */ ColorsAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ColorsAdapter$layoutInflater$2(ColorsAdapter colorsAdapter) {
        super(0);
