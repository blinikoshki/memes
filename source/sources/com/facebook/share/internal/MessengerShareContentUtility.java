...
public class MessengerShareContentUtility {
    ...
    private static String getWebviewHeightRatioString(ShareMessengerURLActionButton.WebviewHeightRatio webviewHeightRatio) {
        ...
        int i = C16021.f156x92e77847[webviewHeightRatio.ordinal()];
        if (i != 1) {
    ...
    private static String getImageRatioString(ShareMessengerGenericTemplateContent.ImageAspectRatio imageAspectRatio) {
        return (imageAspectRatio != null && C16021.f154xb7309c05[imageAspectRatio.ordinal()] == 1) ? IMAGE_RATIO_SQUARE : IMAGE_RATIO_HORIZONTAL;
    }
    ...
    static /* synthetic */ class C16021 {
        ...
        static {
            ...
            L_0x0034:
                int[] r0 = f156x92e77847     // Catch:{ NoSuchFieldError -> 0x003f }
            ...
            L_0x003f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.internal.MessengerShareContentUtility.C16021.<clinit>():void");
        }
    }

    private static String getMediaType(ShareMessengerMediaTemplateContent.MediaType mediaType) {
        return (mediaType != null && C16021.f155x2a75e664[mediaType.ordinal()] == 1) ? "video" : "image";
    }
