...
public class GlPhotoCGAColorspaceFilter extends GlPhotoFilter {
    ...
    public GlPhotoCGAColorspaceFilter() {
        super(GlPhotoFilter.NO_FILTER_VERTEX_SHADER, CGACOLORSPACE_FRAGMENT_SHADER);
    }
}
