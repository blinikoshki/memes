...
/* renamed from: com.memes.plus.ui.editorproxy.EditorProxyActivity$subscriptionStatusViewModel$2 */
/* compiled from: EditorProxyActivity.kt */
final class EditorProxyActivity$subscriptionStatusViewModel$2 extends Lambda implements Function0<SubscriptionStatusViewModel> {
    final /* synthetic */ EditorProxyActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EditorProxyActivity$subscriptionStatusViewModel$2(EditorProxyActivity editorProxyActivity) {
        super(0);
        this.this$0 = editorProxyActivity;
    }
    ...
    public final SubscriptionStatusViewModel invoke() {
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) this.this$0, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<SubscriptionStatusViewModel>(this) {
            final /* synthetic */ EditorProxyActivity$subscriptionStatusViewModel$2 this$0;
