...
public abstract class ChronoLocalDateTime<D extends ChronoLocalDate> extends DefaultInterfaceTemporal implements Temporal, TemporalAdjuster, Comparable<ChronoLocalDateTime<?>> {
    private static final Comparator<ChronoLocalDateTime<?>> DATE_TIME_COMPARATOR = new Comparator<ChronoLocalDateTime<?>>() {
        ...
        public int compare(org.threeten.p022bp.chrono.ChronoLocalDateTime<?> r5, org.threeten.p022bp.chrono.ChronoLocalDateTime<?> r6) {
            /*
                r4 = this;
                ...
                int r0 = org.threeten.p022bp.jdk8.Jdk8Methods.compareLongs(r0, r2)
                ...
                int r0 = org.threeten.p022bp.jdk8.Jdk8Methods.compareLongs(r0, r5)
            L_0x002a:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.ChronoLocalDateTime.C25191.compare(org.threeten.bp.chrono.ChronoLocalDateTime, org.threeten.bp.chrono.ChronoLocalDateTime):int");
        }
    };
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public int compareTo(org.threeten.p022bp.chrono.ChronoLocalDateTime<?> r3) {
        /*
            r2 = this;
            org.threeten.bp.chrono.ChronoLocalDate r0 = r2.toLocalDate()
            org.threeten.bp.chrono.ChronoLocalDate r1 = r3.toLocalDate()
            int r0 = r0.compareTo((org.threeten.p022bp.chrono.ChronoLocalDate) r1)
            if (r0 != 0) goto L_0x0028
            org.threeten.bp.LocalTime r0 = r2.toLocalTime()
            org.threeten.bp.LocalTime r1 = r3.toLocalTime()
            int r0 = r0.compareTo((org.threeten.p022bp.LocalTime) r1)
            if (r0 != 0) goto L_0x0028
            org.threeten.bp.chrono.Chronology r0 = r2.getChronology()
            org.threeten.bp.chrono.Chronology r3 = r3.getChronology()
            int r0 = r0.compareTo((org.threeten.p022bp.chrono.Chronology) r3)
        L_0x0028:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.ChronoLocalDateTime.compareTo(org.threeten.bp.chrono.ChronoLocalDateTime):int");
    }

    /* JADX WARNING: type inference failed for: r6v0, types: [org.threeten.bp.chrono.ChronoLocalDateTime, org.threeten.bp.chrono.ChronoLocalDateTime<?>] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean isAfter(org.threeten.p022bp.chrono.ChronoLocalDateTime<?> r6) {
        /*
            r5 = this;
            org.threeten.bp.chrono.ChronoLocalDate r0 = r5.toLocalDate()
            long r0 = r0.toEpochDay()
        ...
        L_0x002e:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.ChronoLocalDateTime.isAfter(org.threeten.bp.chrono.ChronoLocalDateTime):boolean");
    }

    /* JADX WARNING: type inference failed for: r6v0, types: [org.threeten.bp.chrono.ChronoLocalDateTime, org.threeten.bp.chrono.ChronoLocalDateTime<?>] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean isBefore(org.threeten.p022bp.chrono.ChronoLocalDateTime<?> r6) {
        /*
            r5 = this;
            org.threeten.bp.chrono.ChronoLocalDate r0 = r5.toLocalDate()
            long r0 = r0.toEpochDay()
        ...
        L_0x002e:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.ChronoLocalDateTime.isBefore(org.threeten.bp.chrono.ChronoLocalDateTime):boolean");
    }

    /* JADX WARNING: type inference failed for: r6v0, types: [org.threeten.bp.chrono.ChronoLocalDateTime, org.threeten.bp.chrono.ChronoLocalDateTime<?>] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean isEqual(org.threeten.p022bp.chrono.ChronoLocalDateTime<?> r6) {
        /*
            r5 = this;
            org.threeten.bp.LocalTime r0 = r5.toLocalTime()
            long r0 = r0.toNanoOfDay()
        ...
        L_0x002b:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.ChronoLocalDateTime.isEqual(org.threeten.bp.chrono.ChronoLocalDateTime):boolean");
    }
