...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f100CR = 13;

    /* renamed from: LF */
    private static final byte f101LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f102in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f102in;
        byte[] bArr = this.buf;
