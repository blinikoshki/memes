...
public abstract class CoroutineWorker extends ListenableWorker {
    ...
    public final ListenableFuture<ListenableWorker.Result> startWork() {
        Job unused = BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(getCoroutineContext().plus(this.job)), (CoroutineContext) null, (CoroutineStart) null, new CoroutineWorker$startWork$1(this, (Continuation) null), 3, (Object) null);
        return this.future;
    }
    ...
    public final Object setProgress(Data data, Continuation<? super Unit> continuation) {
        ...
        if (progressAsync.isDone()) {
            ...
            progressAsync.addListener(new C0806xb30e90d1(cancellableContinuationImpl, progressAsync), DirectExecutor.INSTANCE);
    ...
    public final Object setForeground(ForegroundInfo foregroundInfo, Continuation<? super Unit> continuation) {
        ...
        if (foregroundAsync.isDone()) {
            ...
            CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
            cancellableContinuationImpl.initCancellability();
            foregroundAsync.addListener(new C0807xb30e90d2(cancellableContinuationImpl, foregroundAsync), DirectExecutor.INSTANCE);
            obj = cancellableContinuationImpl.getResult();
            if (obj == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(continuation);
            }
