...
/* renamed from: io.getstream.chat.android.livedata.service.sync.PushMessageSyncHandler$firebaseMessageParser$2 */
/* compiled from: PushMessageSyncHandler.kt */
final class PushMessageSyncHandler$firebaseMessageParser$2 extends Lambda implements Function0<FirebaseMessageParserImpl> {
    final /* synthetic */ PushMessageSyncHandler this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PushMessageSyncHandler$firebaseMessageParser$2(PushMessageSyncHandler pushMessageSyncHandler) {
        super(0);
        this.this$0 = pushMessageSyncHandler;
    }

    public final FirebaseMessageParserImpl invoke() {
        return new FirebaseMessageParserImpl(this.this$0.getNotificationConfig());
    }
}
