...
final class TextSpacingFragment$onViewCreated$1<T> implements Observer<Float> {
    final /* synthetic */ TextSpacingFragment this$0;

    TextSpacingFragment$onViewCreated$1(TextSpacingFragment textSpacingFragment) {
        this.this$0 = textSpacingFragment;
    }

    public final void onChanged(Float f) {
        ValueSlider valueSlider = TextSpacingFragment.access$getBinding$p(this.this$0).letterSpacingSlider;
