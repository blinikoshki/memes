...
public final class zzaj {
    ...
    static void zza(com.google.android.gms.measurement.internal.zzei r14, android.database.sqlite.SQLiteDatabase r15, java.lang.String r16, java.lang.String r17, java.lang.String r18, java.lang.String[] r19) throws android.database.sqlite.SQLiteException {
        /*
            r9 = r15
            r10 = r16
            r11 = r19
        ...
        L_0x0031:
            ...
            r1 = r13
        L_0x0033:
            com.google.android.gms.measurement.internal.zzeg r2 = r14.zze()     // Catch:{ all -> 0x00f7 }
        ...
        L_0x00d1:
            ...
            com.google.android.gms.measurement.internal.zzeg r1 = r14.zze()     // Catch:{ SQLiteException -> 0x00ec }
        ...
        L_0x00ec:
            r0 = move-exception
            com.google.android.gms.measurement.internal.zzeg r1 = r14.zzb()
    ...
    static void zzb(zzei zzei, SQLiteDatabase sQLiteDatabase) {
        if (zzei != null) {
            File file = new File(sQLiteDatabase.getPath());
            if (!file.setReadable(false, false)) {
                zzei.zze().zza("Failed to turn off database read permission");
            }
            if (!file.setWritable(false, false)) {
                zzei.zze().zza("Failed to turn off database write permission");
            }
            if (!file.setReadable(true, true)) {
                zzei.zze().zza("Failed to turn on database read permission for owner");
            }
            if (!file.setWritable(true, true)) {
                zzei.zze().zza("Failed to turn on database write permission for owner");
                return;
            }
            return;
        }
