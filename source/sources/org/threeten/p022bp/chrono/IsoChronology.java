...
import org.threeten.p022bp.ZonedDateTime;
...
public final class IsoChronology extends Chronology implements Serializable {
    ...
    public LocalDate date(int i, int i2, int i3) {
        return LocalDate.m243of(i, i2, i3);
    }
    ...
    public LocalDate resolveDate(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        ...
        if (map.containsKey(ChronoField.MONTH_OF_YEAR)) {
            if (map.containsKey(ChronoField.DAY_OF_MONTH)) {
                ...
                if (resolverStyle == ResolverStyle.LENIENT) {
                    return LocalDate.m243of(checkValidIntValue, 1, 1).plusMonths((long) Jdk8Methods.safeSubtract(safeToInt, 1)).plusDays((long) Jdk8Methods.safeSubtract(safeToInt2, 1));
                } else if (resolverStyle != ResolverStyle.SMART) {
                    return LocalDate.m243of(checkValidIntValue, safeToInt, safeToInt2);
                } else {
                ...
                if (map.containsKey(ChronoField.ALIGNED_DAY_OF_WEEK_IN_MONTH)) {
                    ...
                    if (resolverStyle == ResolverStyle.LENIENT) {
                        return LocalDate.m243of(checkValidIntValue4, 1, 1).plusMonths(Jdk8Methods.safeSubtract(map.remove(ChronoField.MONTH_OF_YEAR).longValue(), 1)).plusWeeks(Jdk8Methods.safeSubtract(map.remove(ChronoField.ALIGNED_WEEK_OF_MONTH).longValue(), 1)).plusDays(Jdk8Methods.safeSubtract(map.remove(ChronoField.DAY_OF_WEEK).longValue(), 1));
                    }
                    int checkValidIntValue5 = ChronoField.MONTH_OF_YEAR.checkValidIntValue(map.remove(ChronoField.MONTH_OF_YEAR).longValue());
                    LocalDate with = LocalDate.m243of(checkValidIntValue4, checkValidIntValue5, 1).plusWeeks((long) (ChronoField.ALIGNED_WEEK_OF_MONTH.checkValidIntValue(map.remove(ChronoField.ALIGNED_WEEK_OF_MONTH).longValue()) - 1)).with(TemporalAdjusters.nextOrSame(DayOfWeek.m241of(ChronoField.DAY_OF_WEEK.checkValidIntValue(map.remove(ChronoField.DAY_OF_WEEK).longValue()))));
        ...
        if (map.containsKey(ChronoField.DAY_OF_YEAR)) {
            ...
            if (map.containsKey(ChronoField.ALIGNED_DAY_OF_WEEK_IN_YEAR)) {
                ...
                if (resolverStyle == ResolverStyle.LENIENT) {
                    return LocalDate.m243of(checkValidIntValue7, 1, 1).plusWeeks(Jdk8Methods.safeSubtract(map.remove(ChronoField.ALIGNED_WEEK_OF_YEAR).longValue(), 1)).plusDays(Jdk8Methods.safeSubtract(map.remove(ChronoField.ALIGNED_DAY_OF_WEEK_IN_YEAR).longValue(), 1));
                }
                LocalDate plusDays2 = LocalDate.m243of(checkValidIntValue7, 1, 1).plusDays((long) (((ChronoField.ALIGNED_WEEK_OF_YEAR.checkValidIntValue(map.remove(ChronoField.ALIGNED_WEEK_OF_YEAR).longValue()) - 1) * 7) + (ChronoField.ALIGNED_DAY_OF_WEEK_IN_YEAR.checkValidIntValue(map.remove(ChronoField.ALIGNED_DAY_OF_WEEK_IN_YEAR).longValue()) - 1)));
                ...
                if (resolverStyle == ResolverStyle.LENIENT) {
                    return LocalDate.m243of(checkValidIntValue8, 1, 1).plusWeeks(Jdk8Methods.safeSubtract(map.remove(ChronoField.ALIGNED_WEEK_OF_YEAR).longValue(), 1)).plusDays(Jdk8Methods.safeSubtract(map.remove(ChronoField.DAY_OF_WEEK).longValue(), 1));
                }
                LocalDate with2 = LocalDate.m243of(checkValidIntValue8, 1, 1).plusWeeks((long) (ChronoField.ALIGNED_WEEK_OF_YEAR.checkValidIntValue(map.remove(ChronoField.ALIGNED_WEEK_OF_YEAR).longValue()) - 1)).with(TemporalAdjusters.nextOrSame(DayOfWeek.m241of(ChronoField.DAY_OF_WEEK.checkValidIntValue(map.remove(ChronoField.DAY_OF_WEEK).longValue()))));
