...
final class EditorEntrySelectionActivity$draftsViewModel$2 extends Lambda implements Function0<EditorDraftsViewModel> {
    final /* synthetic */ EditorEntrySelectionActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EditorEntrySelectionActivity$draftsViewModel$2(EditorEntrySelectionActivity editorEntrySelectionActivity) {
        super(0);
    ...
    public final EditorDraftsViewModel invoke() {
        ViewModel viewModel = ViewModelProviders.m18of((FragmentActivity) this.this$0, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<EditorDraftsViewModel>(this) {
            final /* synthetic */ EditorEntrySelectionActivity$draftsViewModel$2 this$0;
            ...
            public final EditorDraftsViewModel invoke() {
                return new EditorDraftsViewModel(EditorDatabaseManager.INSTANCE.mo63492db(this.this$0.this$0).getEditorDraftsDao(), this.this$0.this$0.getOutputTargetGenerator());
            }
