...
/* renamed from: io.getstream.chat.android.client.clientstate.ClientStateService$stateMachine$2$1$5$2 */
/* compiled from: ClientStateService.kt */
final class ClientStateService$stateMachine$2$1$5$2 extends Lambda implements Function3<FiniteStateMachine<ClientState, ClientStateService.ClientStateEvent>, ClientState.User.Authorized.Connected, ClientStateService.ClientStateEvent.DisconnectRequestedEvent, ClientState> {
    public static final ClientStateService$stateMachine$2$1$5$2 INSTANCE = new ClientStateService$stateMachine$2$1$5$2();

    ClientStateService$stateMachine$2$1$5$2() {
        super(3);
    }

    public final ClientState invoke(FiniteStateMachine<ClientState, ClientStateService.ClientStateEvent> finiteStateMachine, ClientState.User.Authorized.Connected connected, ClientStateService.ClientStateEvent.DisconnectRequestedEvent disconnectRequestedEvent) {
