...
public final class IsoFields {
    ...
    private enum Field implements TemporalField {
        DAY_OF_QUARTER {
            ...
            public ValueRange range() {
                return ValueRange.m289of(1, 90, 92);
            }
            ...
            public ValueRange rangeRefinedBy(TemporalAccessor temporalAccessor) {
                if (temporalAccessor.isSupported(this)) {
                    ...
                    if (j == 1) {
                        return IsoChronology.INSTANCE.isLeapYear(temporalAccessor.getLong(ChronoField.YEAR)) ? ValueRange.m288of(1, 91) : ValueRange.m288of(1, 90);
                    } else if (j == 2) {
                        return ValueRange.m288of(1, 91);
                    } else {
                        if (j == 3 || j == 4) {
                            return ValueRange.m288of(1, 92);
                        }
                        return range();
                    }
                } else {
            ...
            public org.threeten.p022bp.temporal.TemporalAccessor resolve(java.util.Map<org.threeten.p022bp.temporal.TemporalField, java.lang.Long> r11, org.threeten.p022bp.temporal.TemporalAccessor r12, org.threeten.p022bp.format.ResolverStyle r13) {
                /*
                    r10 = this;
                    org.threeten.bp.temporal.ChronoField r12 = org.threeten.p022bp.temporal.ChronoField.YEAR
                    ...
                    goto L_0x00a8
                L_0x0016:
                    org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.YEAR
                    ...
                    org.threeten.bp.format.ResolverStyle r3 = org.threeten.p022bp.format.ResolverStyle.LENIENT
                    r4 = 3
                    r5 = 1
                    r7 = 1
                    if (r13 != r3) goto L_0x0051
                    long r8 = r0.longValue()
                    org.threeten.bp.LocalDate r12 = org.threeten.p022bp.LocalDate.m243of((int) r12, (int) r7, (int) r7)
                    long r7 = org.threeten.p022bp.jdk8.Jdk8Methods.safeSubtract((long) r8, (long) r5)
                    long r3 = org.threeten.p022bp.jdk8.Jdk8Methods.safeMultiply((long) r7, (int) r4)
                    org.threeten.bp.LocalDate r12 = r12.plusMonths(r3)
                    long r0 = org.threeten.p022bp.jdk8.Jdk8Methods.safeSubtract((long) r1, (long) r5)
                ...
                L_0x0051:
                    ...
                    org.threeten.bp.format.ResolverStyle r3 = org.threeten.p022bp.format.ResolverStyle.STRICT
                    if (r13 != r3) goto L_0x0086
                    r13 = 92
                    r3 = 91
                    if (r0 != r7) goto L_0x0078
                    org.threeten.bp.chrono.IsoChronology r13 = org.threeten.p022bp.chrono.IsoChronology.INSTANCE
                    long r8 = (long) r12
                ...
                L_0x007d:
                    long r8 = (long) r13
                    org.threeten.bp.temporal.ValueRange r13 = org.threeten.p022bp.temporal.ValueRange.m288of(r5, r8)
                ...
                L_0x008d:
                    ...
                    int r0 = r0 * 3
                    int r0 = r0 + r7
                    org.threeten.bp.LocalDate r12 = org.threeten.p022bp.LocalDate.m243of((int) r12, (int) r0, (int) r7)
                    long r1 = r1 - r5
                    org.threeten.bp.LocalDate r12 = r12.plusDays(r1)
                L_0x009a:
                    r11.remove(r10)
                    org.threeten.bp.temporal.ChronoField r13 = org.threeten.p022bp.temporal.ChronoField.YEAR
                    r11.remove(r13)
                ...
                L_0x00a8:
                    ...
                    return r11
                */
                throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.temporal.IsoFields.Field.C25441.resolve(java.util.Map, org.threeten.bp.temporal.TemporalAccessor, org.threeten.bp.format.ResolverStyle):org.threeten.bp.temporal.TemporalAccessor");
            }
        },
        QUARTER_OF_YEAR {
            public String toString() {
        ...
        WEEK_OF_WEEK_BASED_YEAR {
            ...
            public ValueRange range() {
                return ValueRange.m289of(1, 52, 53);
            }
            ...
            public TemporalAccessor resolve(Map<TemporalField, Long> map, TemporalAccessor temporalAccessor, ResolverStyle resolverStyle) {
                ...
                if (resolverStyle2 == ResolverStyle.LENIENT) {
                    ...
                    localDate = LocalDate.m243of(checkValidIntValue, 1, 4).plusWeeks(longValue - 1).plusWeeks(j).with((TemporalField) ChronoField.DAY_OF_WEEK, longValue2);
                } else {
                    int checkValidIntValue2 = ChronoField.DAY_OF_WEEK.checkValidIntValue(l2.longValue());
                    if (resolverStyle2 == ResolverStyle.STRICT) {
                        Field.getWeekRange(LocalDate.m243of(checkValidIntValue, 1, 4)).checkValidValue(longValue, this);
                    } else {
                        range().checkValidValue(longValue, this);
                    }
                    localDate = LocalDate.m243of(checkValidIntValue, 1, 4).plusWeeks(longValue - 1).with((TemporalField) ChronoField.DAY_OF_WEEK, (long) checkValidIntValue2);
                }
                map2.remove(this);
        ...
        WEEK_BASED_YEAR {
            ...
            public <R extends Temporal> R adjustInto(R r, long j) {
                if (isSupportedBy(r)) {
                    ...
                    LocalDate of = LocalDate.m243of(checkValidIntValue, 1, 4);
        ...
        public static ValueRange getWeekRange(LocalDate localDate) {
            return ValueRange.m288of(1, (long) getWeekRange(getWeekBasedYear(localDate)));
        }

        /* access modifiers changed from: private */
        public static int getWeekRange(int i) {
            LocalDate of = LocalDate.m243of(i, 1, 1);
    ...
    private enum Unit implements TemporalUnit {
        ...
        public <R extends Temporal> R addTo(R r, long j) {
            int i = C25431.$SwitchMap$org$threeten$bp$temporal$IsoFields$Unit[ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C25431 {
        ...
        static {
            /*
                org.threeten.bp.temporal.IsoFields$Unit[] r0 = org.threeten.p022bp.temporal.IsoFields.Unit.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$org$threeten$bp$temporal$IsoFields$Unit = r0
                org.threeten.bp.temporal.IsoFields$Unit r1 = org.threeten.p022bp.temporal.IsoFields.Unit.WEEK_BASED_YEARS     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$org$threeten$bp$temporal$IsoFields$Unit     // Catch:{ NoSuchFieldError -> 0x001d }
                org.threeten.bp.temporal.IsoFields$Unit r1 = org.threeten.p022bp.temporal.IsoFields.Unit.QUARTER_YEARS     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.temporal.IsoFields.C25431.<clinit>():void");
        }
    }
}
