...
/* renamed from: com.memes.chat.ui.channel.info.ChannelInfoActivity$channelEventsViewModel$2 */
/* compiled from: ChannelInfoActivity.kt */
final class ChannelInfoActivity$channelEventsViewModel$2 extends Lambda implements Function0<ChannelEventsViewModel> {
    final /* synthetic */ ChannelInfoActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChannelInfoActivity$channelEventsViewModel$2(ChannelInfoActivity channelInfoActivity) {
        super(0);
    ...
    public final ChannelEventsViewModel invoke() {
        ...
        Function0 function0 = C40951.INSTANCE;
        if (function0 == null) {
            viewModel = new ViewModelProvider(channelInfoActivity).get(ChannelEventsViewModel.class);
            Intrinsics.checkNotNullExpressionValue(viewModel, "ViewModelProvider(this).get(T::class.java)");
        } else {
            viewModel = new ViewModelProvider((ViewModelStoreOwner) channelInfoActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(function0)).get(ChannelEventsViewModel.class);
