...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues(ViewHierarchyConstants.DIMENSION_WIDTH_KEY)) {
            arrayList.add(motionSpec2.getAnimator(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec2.hasPropertyValues(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY)) {
            arrayList.add(motionSpec2.getAnimator(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
