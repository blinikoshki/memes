...
/* renamed from: io.getstream.chat.android.livedata.controller.ChannelControllerImpl$deleteReaction$result$1 */
/* compiled from: ChannelControllerImpl.kt */
final class ChannelControllerImpl$deleteReaction$result$1 extends Lambda implements Function0<Call<Message>> {
    final /* synthetic */ Reaction $reaction;
    final /* synthetic */ ChannelControllerImpl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChannelControllerImpl$deleteReaction$result$1(ChannelControllerImpl channelControllerImpl, Reaction reaction) {
        super(0);
    ...
    public final Call<Message> invoke() {
        return this.this$0.getClient().deleteReaction(this.$reaction.getMessageId(), this.$reaction.getType());
    }
}
