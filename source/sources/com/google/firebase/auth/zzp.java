...
final class zzp implements OnCompleteListener<zze> {
    ...
    public final void onComplete(Task<zze> task) {
        ...
        if (zzag.zze()) {
            this.zzb.zze.zzM(zzag, this.zza.zzb(), this.zzb.zzi, longValue, this.zza.zzf() != null, this.zza.zzh(), str2, str, zztp.zza(), zzD, this.zza.zze(), this.zza.zzi());
        } else {
            this.zzb.zze.zzO(zzag, this.zza.zzj(), this.zzb.zzi, longValue, this.zza.zzf() != null, this.zza.zzh(), str2, str, zztp.zza(), zzD, this.zza.zze(), this.zza.zzi());
        }
    }
}
