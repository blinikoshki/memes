...
final class MessageSchema<T> implements Schema<T> {
    ...
    static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo structuralMessageInfo, NewInstanceSchema newInstanceSchema2, ListFieldSchema listFieldSchema2, UnknownFieldSchema<?, ?> unknownFieldSchema2, ExtensionSchema<?> extensionSchema2, MapFieldSchema mapFieldSchema2) {
        ...
        for (FieldInfo fieldInfo : fields) {
            if (fieldInfo.getType() == FieldType.MAP) {
                i4++;
            } else if (fieldInfo.getType().mo52578id() >= 18 && fieldInfo.getType().mo52578id() <= 49) {
                i5++;
            }
        }
        int[] iArr2 = null;
        ...
        while (i6 < fields.length) {
            ...
            if (fieldInfo2.getType() == FieldType.MAP) {
                iArr3[i9] = i7;
                i9++;
            } else if (fieldInfo2.getType().mo52578id() >= 18 && fieldInfo2.getType().mo52578id() <= 49) {
                i3 = i7;
    ...
    static /* synthetic */ class C36281 {
        ...
        static {
            ...
            L_0x00cc:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.MessageSchema.C36281.<clinit>():void");
        }
    }
    ...
    private int decodeMapEntryValue(byte[] r2, int r3, int r4, com.google.crypto.tink.shaded.protobuf.WireFormat.FieldType r5, java.lang.Class<?> r6, com.google.crypto.tink.shaded.protobuf.ArrayDecoders.Registers r7) throws java.io.IOException {
        /*
            r1 = this;
            int[] r0 = com.google.crypto.tink.shaded.protobuf.MessageSchema.C36281.$SwitchMap$com$google$protobuf$WireFormat$FieldType
            int r5 = r5.ordinal()
            r5 = r0[r5]
            switch(r5) {
    ...
    private boolean isFieldPresent(T t, int i) {
        if (this.proto3) {
            ...
            switch (type(typeAndOffsetAt)) {
                case 0:
                    if (UnsafeUtil.getDouble((Object) t, offset) != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                        return true;
                    }
                    return false;
                case 1:
