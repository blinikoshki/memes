...
public final class KeyTemplate {
    ...
    /* renamed from: kt */
    private final com.google.crypto.tink.proto.KeyTemplate f664kt;
    ...
    private static OutputPrefixType fromProto(com.google.crypto.tink.proto.OutputPrefixType outputPrefixType) {
        int i = C34781.$SwitchMap$com$google$crypto$tink$proto$OutputPrefixType[outputPrefixType.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C34781 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.KeyTemplate.C34781.<clinit>():void");
        }
    }

    private static com.google.crypto.tink.proto.OutputPrefixType toProto(OutputPrefixType outputPrefixType) {
        int i = C34781.$SwitchMap$com$google$crypto$tink$KeyTemplate$OutputPrefixType[outputPrefixType.ordinal()];
        if (i == 1) {
    ...
    public String getTypeUrl() {
        return this.f664kt.getTypeUrl();
    }

    public byte[] getValue() {
        return this.f664kt.getValue().toByteArray();
    }

    public OutputPrefixType getOutputPrefixType() {
        return fromProto(this.f664kt.getOutputPrefixType());
    }
}
