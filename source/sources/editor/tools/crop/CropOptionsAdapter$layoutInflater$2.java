...
final class CropOptionsAdapter$layoutInflater$2 extends Lambda implements Function0<LayoutInflater> {
    final /* synthetic */ CropOptionsAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CropOptionsAdapter$layoutInflater$2(CropOptionsAdapter cropOptionsAdapter) {
        super(0);
