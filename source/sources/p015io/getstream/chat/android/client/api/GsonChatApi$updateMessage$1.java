...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$updateMessage$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$updateMessage$1 extends Lambda implements Function1<MessageResponse, Message> {
    public static final GsonChatApi$updateMessage$1 INSTANCE = new GsonChatApi$updateMessage$1();

    GsonChatApi$updateMessage$1() {
        super(1);
    }
