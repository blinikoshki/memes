...
public class WorkTypeConverters {
    ...
    public static int stateToInt(WorkInfo.State state) {
        switch (C08681.$SwitchMap$androidx$work$WorkInfo$State[state.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
    ...
    public static int backoffPolicyToInt(BackoffPolicy backoffPolicy) {
        int i = C08681.$SwitchMap$androidx$work$BackoffPolicy[backoffPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    static /* synthetic */ class C08681 {
        ...
        static {
            ...
            L_0x009d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.model.WorkTypeConverters.C08681.<clinit>():void");
        }
    }

    public static int networkTypeToInt(NetworkType networkType) {
        int i = C08681.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
