...
public final class RxAndroidPlugins {
    ...
    static p015io.reactivex.Scheduler applyRequireNonNull(p015io.reactivex.functions.Function<java.util.concurrent.Callable<p015io.reactivex.Scheduler>, p015io.reactivex.Scheduler> r0, java.util.concurrent.Callable<p015io.reactivex.Scheduler> r1) {
        /*
            java.lang.Object r0 = apply(r0, r1)
            io.reactivex.Scheduler r0 = (p015io.reactivex.Scheduler) r0
            java.lang.String r1 = "Scheduler Callable returned null"
            java.util.Objects.requireNonNull(r0, r1)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.android.plugins.RxAndroidPlugins.applyRequireNonNull(io.reactivex.functions.Function, java.util.concurrent.Callable):io.reactivex.Scheduler");
    }
