...
import com.google.android.gms.internal.p026firebaseauthapi.zztx;
...
public class GenericIdpActivity extends FragmentActivity implements zzty {
    ...
    public final Uri.Builder zzg(Uri.Builder builder, Intent intent, String str, String str2) {
        ...
        String join = (stringArrayListExtra == null || stringArrayListExtra.isEmpty()) ? null : TextUtils.join(Util.EVENT_ID_SEPARATOR, stringArrayListExtra);
