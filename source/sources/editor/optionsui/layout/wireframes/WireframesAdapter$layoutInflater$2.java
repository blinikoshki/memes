...
final class WireframesAdapter$layoutInflater$2 extends Lambda implements Function0<LayoutInflater> {
    final /* synthetic */ WireframesAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    WireframesAdapter$layoutInflater$2(WireframesAdapter wireframesAdapter) {
        super(0);
