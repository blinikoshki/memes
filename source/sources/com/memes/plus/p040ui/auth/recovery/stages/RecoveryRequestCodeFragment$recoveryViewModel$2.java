...
/* renamed from: com.memes.plus.ui.auth.recovery.stages.RecoveryRequestCodeFragment$recoveryViewModel$2 */
/* compiled from: RecoveryRequestCodeFragment.kt */
final class RecoveryRequestCodeFragment$recoveryViewModel$2 extends Lambda implements Function0<AccountRecoveryViewModel> {
    final /* synthetic */ RecoveryRequestCodeFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RecoveryRequestCodeFragment$recoveryViewModel$2(RecoveryRequestCodeFragment recoveryRequestCodeFragment) {
        super(0);
    ...
    public final AccountRecoveryViewModel invoke() {
        ...
        Function0 function0 = C42261.INSTANCE;
        if (function0 == null) {
