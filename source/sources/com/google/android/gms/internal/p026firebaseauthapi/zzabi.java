...
final class zzabi {
    static String zza(zzabg zzabg, String str) {
    ...
    static final void zzb(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                sb.append(zzace.zza(zzzb.zzo((String) obj)));
                sb.append(Typography.quote);
            } else if (obj instanceof zzzb) {
                sb.append(": \"");
                sb.append(zzace.zza((zzzb) obj));
                sb.append(Typography.quote);
            } else if (obj instanceof zzaad) {
                sb.append(" {");
                zzc((zzaad) obj, sb, i + 2);
    ...
    private static void zzc(zzabg zzabg, StringBuilder sb, int i) {
        String str;
        boolean z;
        String str2;
        String str3;
        ...
        for (Method method : zzabg.getClass().getDeclaredMethods()) {
        ...
        for (String str4 : treeSet) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zzb(sb, i, zzd(str3), zzaad.zzA(method2, zzabg, new Object[0]));
                }
            }
            if (substring.endsWith("Map") && !substring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zzb(sb, i, zzd(str2), zzaad.zzA(method3, zzabg, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object zzA = zzaad.zzA(method4, zzabg, new Object[0]);
                    if (method5 == null) {
                        if (zzA instanceof Boolean) {
                            ...
                            if (zzA instanceof String) {
                                ...
                                z = zzA.equals(zzzb.zzb);
                            } else if (zzA instanceof zzabg) {
                                if (zzA == ((zzabg) zzA).zzo()) {
                                }
                            } else if ((zzA instanceof Enum) && ((Enum) zzA).ordinal() == 0) {
                            }
                            if (z) {
                            }
                        } else if (((Double) zzA).doubleValue() == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                        }
                    } else if (!((Boolean) zzaad.zzA(method5, zzabg, new Object[0])).booleanValue()) {
                    }
                    zzb(sb, i, zzd(concat), zzA);
                }
            }
        }
        if (!(zzabg instanceof zzaaa)) {
            zzach zzach = ((zzaad) zzabg).zzc;
            if (zzach != null) {
                zzach.zzg(sb, i);
                return;
            }
