...
/* renamed from: io.getstream.chat.android.client.clientstate.ClientStateService$stateMachine$2$1$2$5 */
/* compiled from: ClientStateService.kt */
final class ClientStateService$stateMachine$2$1$2$5 extends Lambda implements Function3<FiniteStateMachine<ClientState, ClientStateService.ClientStateEvent>, ClientState.Idle, ClientStateService.ClientStateEvent.ConnectedEvent, ClientState> {
    public static final ClientStateService$stateMachine$2$1$2$5 INSTANCE = new ClientStateService$stateMachine$2$1$2$5();

    ClientStateService$stateMachine$2$1$2$5() {
        super(3);
    }

    public final ClientState invoke(FiniteStateMachine<ClientState, ClientStateService.ClientStateEvent> finiteStateMachine, ClientState.Idle idle, ClientStateService.ClientStateEvent.ConnectedEvent connectedEvent) {
