...
final class LayoutBackgroundTabsFragment$patternsViewModel$2 extends Lambda implements Function0<PatternsViewModel> {
    final /* synthetic */ LayoutBackgroundTabsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LayoutBackgroundTabsFragment$patternsViewModel$2(LayoutBackgroundTabsFragment layoutBackgroundTabsFragment) {
        super(0);
    ...
    public final PatternsViewModel invoke() {
        ...
        ViewModel viewModel = ViewModelProviders.m18of(requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<PatternsViewModel>(this) {
            final /* synthetic */ LayoutBackgroundTabsFragment$patternsViewModel$2 this$0;
            ...
            public final PatternsViewModel invoke() {
                return new PatternsViewModel(this.this$0.this$0.getAssetsProvider());
            }
