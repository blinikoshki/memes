...
public final class DefaultDataSource implements DataSource {
    ...
    public DefaultDataSource(Context context2, boolean z) {
        this(context2, ExoPlayerLibraryInfo.DEFAULT_USER_AGENT, 8000, 8000, z);
    }
    ...
    public DefaultDataSource(Context context2, String str, int i, int i2, boolean z) {
        this(context2, (DataSource) new DefaultHttpDataSource(str, i, i2, z, (HttpDataSource.RequestProperties) null));
    }
    ...
    private DataSource getRtmpDataSource() {
        if (this.rtmpDataSource == null) {
            try {
                ...
                Log.m358w(TAG, "Attempting to play RTMP stream without depending on the RTMP extension");
            } catch (Exception e) {
