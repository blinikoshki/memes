...
public class GlPhotoKuwaharaFilter extends GlPhotoFilter {
    ...
    public GlPhotoKuwaharaFilter() {
        this(3);
    }

    public GlPhotoKuwaharaFilter(int i) {
        super(GlPhotoFilter.NO_FILTER_VERTEX_SHADER, KUWAHARA_FRAGMENT_SHADER);
        this.radius = i;
    }
    ...
    public void setRadius(int i) {
        this.radius = i;
        setInteger(this.radiusLocation, i);
    }
}
