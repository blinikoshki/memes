...
final class DeepFryFiltersFragment$editorPlanViewModel$2 extends Lambda implements Function0<EditorPlanViewModel> {
    final /* synthetic */ DeepFryFiltersFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DeepFryFiltersFragment$editorPlanViewModel$2(DeepFryFiltersFragment deepFryFiltersFragment) {
        super(0);
    ...
    public final EditorPlanViewModel invoke() {
        ...
        Function0 function0 = C49251.INSTANCE;
        if (function0 == null) {
