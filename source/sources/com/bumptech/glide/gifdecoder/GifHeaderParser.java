...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f105ix = readShort();
        this.header.currentFrame.f106iy = readShort();
        this.header.currentFrame.f104iw = readShort();
        this.header.currentFrame.f103ih = readShort();
        int read = read();
        boolean z = false;
