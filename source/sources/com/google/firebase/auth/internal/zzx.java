...
public final class zzx extends FirebaseUser {
    ...
    public final String getTenantId() {
        Map map;
        zzwv zzwv = this.zza;
        if (zzwv == null || zzwv.zze() == null || (map = (Map) zzay.zza(this.zza.zze()).getClaims().get("firebase")) == null) {
            return null;
        }
    ...
    public final boolean isAnonymous() {
        ...
        if (bool == null || bool.booleanValue()) {
            zzwv zzwv = this.zza;
            String signInProvider = zzwv != null ? zzay.zza(zzwv.zze()).getSignInProvider() : "";
            boolean z = false;
