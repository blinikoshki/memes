...
class ViewGroupUtilsApi14 {
    ...
    static void suppressLayout(android.view.ViewGroup r5, boolean r6) {
        ...
        L_0x0039:
            ...
            int r0 = androidx.transition.C0727R.C0730id.transition_layout_save
            r5.setTag(r0, r6)
        L_0x0042:
        ...
        L_0x007f:
            ...
            r5.requestLayout()
        L_0x0084:
            int r6 = androidx.transition.C0727R.C0730id.transition_layout_save
    ...
    private static void cancelLayoutTransition(LayoutTransition layoutTransition) {
        if (!sCancelMethodFetched) {
            try {
                Method declaredMethod = LayoutTransition.class.getDeclaredMethod(ModelType.action_cancel, new Class[0]);
