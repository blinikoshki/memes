...
final class MediaSelectionActivity$initPhotosSelection$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ MediaSelectionActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MediaSelectionActivity$initPhotosSelection$1(MediaSelectionActivity mediaSelectionActivity) {
        super(0);
        this.this$0 = mediaSelectionActivity;
    }

    public final void invoke() {
        this.this$0.pickContent(ContentPickerTarget.PHOTO);
    }
}
