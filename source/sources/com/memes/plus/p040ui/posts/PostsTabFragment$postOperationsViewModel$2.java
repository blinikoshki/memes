...
/* renamed from: com.memes.plus.ui.posts.PostsTabFragment$postOperationsViewModel$2 */
/* compiled from: PostsTabFragment.kt */
final class PostsTabFragment$postOperationsViewModel$2 extends Lambda implements Function0<PostOperationsViewModel> {
    final /* synthetic */ PostsTabFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PostsTabFragment$postOperationsViewModel$2(PostsTabFragment postsTabFragment) {
        super(0);
    ...
    public final PostOperationsViewModel invoke() {
        ...
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<PostOperationsViewModel>(this) {
            final /* synthetic */ PostsTabFragment$postOperationsViewModel$2 this$0;
