...
final class MediaPeriodInfo {
    ...
    /* renamed from: id */
    public final MediaSource.MediaPeriodId f194id;
    ...
    public MediaPeriodInfo copyWithStartPositionUs(long j) {
        ...
        return new MediaPeriodInfo(this.f194id, j, this.requestedContentPositionUs, this.endPositionUs, this.durationUs, this.isLastInTimelinePeriod, this.isLastInTimelineWindow, this.isFinal);
    }
    ...
    public MediaPeriodInfo copyWithRequestedContentPositionUs(long j) {
        ...
        return new MediaPeriodInfo(this.f194id, this.startPositionUs, j, this.endPositionUs, this.durationUs, this.isLastInTimelinePeriod, this.isLastInTimelineWindow, this.isFinal);
    }
    ...
    public int hashCode() {
        return ((((((((((((((527 + this.f194id.hashCode()) * 31) + ((int) this.startPositionUs)) * 31) + ((int) this.requestedContentPositionUs)) * 31) + ((int) this.endPositionUs)) * 31) + ((int) this.durationUs)) * 31) + (this.isLastInTimelinePeriod ? 1 : 0)) * 31) + (this.isLastInTimelineWindow ? 1 : 0)) * 31) + (this.isFinal ? 1 : 0);
    }
}
