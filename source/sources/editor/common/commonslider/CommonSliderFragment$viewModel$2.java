...
final class CommonSliderFragment$viewModel$2 extends Lambda implements Function0<CommonSliderViewModel> {
    final /* synthetic */ CommonSliderFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CommonSliderFragment$viewModel$2(CommonSliderFragment commonSliderFragment) {
        super(0);
    ...
    public final CommonSliderViewModel invoke() {
        ...
        Function0 function0 = C46581.INSTANCE;
        if (function0 == null) {
            viewModel = ViewModelProviders.m17of(requireActivity).get(CommonSliderViewModel.class);
            Intrinsics.checkNotNullExpressionValue(viewModel, "ViewModelProviders.of(this).get(T::class.java)");
        } else {
            viewModel = ViewModelProviders.m18of(requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(function0)).get(CommonSliderViewModel.class);
