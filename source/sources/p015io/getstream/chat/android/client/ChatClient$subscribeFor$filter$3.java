...
/* renamed from: io.getstream.chat.android.client.ChatClient$subscribeFor$filter$3 */
/* compiled from: ChatClient.kt */
final class ChatClient$subscribeFor$filter$3 extends Lambda implements Function1<ChatEvent, Boolean> {
    final /* synthetic */ Class[] $eventTypes;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChatClient$subscribeFor$filter$3(Class[] clsArr) {
        super(1);
