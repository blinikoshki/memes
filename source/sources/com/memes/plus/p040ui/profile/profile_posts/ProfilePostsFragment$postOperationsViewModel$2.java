...
/* renamed from: com.memes.plus.ui.profile.profile_posts.ProfilePostsFragment$postOperationsViewModel$2 */
/* compiled from: ProfilePostsFragment.kt */
final class ProfilePostsFragment$postOperationsViewModel$2 extends Lambda implements Function0<PostOperationsViewModel> {
    final /* synthetic */ ProfilePostsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ProfilePostsFragment$postOperationsViewModel$2(ProfilePostsFragment profilePostsFragment) {
        super(0);
    ...
    public final PostOperationsViewModel invoke() {
        ...
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<PostOperationsViewModel>(this) {
            final /* synthetic */ ProfilePostsFragment$postOperationsViewModel$2 this$0;
