...
import p015io.reactivex.internal.operators.single.SingleDoOnTerminate;
...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo24350as(SingleConverter<T, ? extends R> singleConverter) {
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo24425to(Function<? super Single<T>, R> function) {
        try {
