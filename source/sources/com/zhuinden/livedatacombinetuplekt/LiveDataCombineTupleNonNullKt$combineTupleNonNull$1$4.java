...
final class LiveDataCombineTupleNonNullKt$combineTupleNonNull$1$4<T> implements Observer<T2> {
    final /* synthetic */ MediatorLiveData $mediator;

    LiveDataCombineTupleNonNullKt$combineTupleNonNull$1$4(MediatorLiveData mediatorLiveData) {
