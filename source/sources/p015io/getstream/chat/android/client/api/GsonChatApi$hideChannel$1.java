...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$hideChannel$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$hideChannel$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final GsonChatApi$hideChannel$1 INSTANCE = new GsonChatApi$hideChannel$1();

    GsonChatApi$hideChannel$1() {
        super(1);
    }
