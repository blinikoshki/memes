...
/* renamed from: io.getstream.chat.android.client.ChatClient$subscribeFor$filter$2 */
/* compiled from: ChatClient.kt */
final class ChatClient$subscribeFor$filter$2 extends Lambda implements Function1<ChatEvent, Boolean> {
    final /* synthetic */ String[] $eventTypes;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChatClient$subscribeFor$filter$2(String[] strArr) {
        super(1);
