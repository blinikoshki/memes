...
final class zzacw extends zzact {
                ...
                if (b >= -32) {
                    if (b >= -16) {
                        if (i9 >= 3) {
                            i8 = i9 - 3;
                            long j7 = j5 + 1;
                            byte zzp = zzacr.zzp(bArr2, j5);
                            if (zzp > -65 || (((b << Ascii.f582FS) + (zzp + 112)) >> 30) != 0) {
                                break;
                            }
                            long j8 = j7 + 1;
                            if (zzacr.zzp(bArr2, j7) > -65) {
                                break;
                            }
                            j = j8 + 1;
                            if (zzacr.zzp(bArr2, j8) > -65) {
                                break;
                            }
                        } else {
                        ...
                        i8 = i9 - 2;
                        long j9 = j5 + 1;
                        byte zzp2 = zzacr.zzp(bArr2, j5);
                        if (zzp2 > -65 || ((b == -32 && zzp2 < -96) || (b == -19 && zzp2 >= -96))) {
                            break;
                        }
                        j5 = j9 + 1;
                        if (zzacr.zzp(bArr2, j9) > -65) {
                            break;
                        }
                    } else {
                        return zze(bArr2, b, j5, i9);
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r12 < i4) {
                ...
                if (zzacs.zza(zzp2)) {
                    ...
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        zzacs.zze(zzp2, zzacr.zzp(bArr, (long) i6), zzacr.zzp(bArr, (long) i8), cArr, i3);
                        r12 = i8 + 1;
                        i3++;
                    } else {
                        throw zzaal.zzi();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    zzacs.zzf(zzp2, zzacr.zzp(bArr, (long) i6), zzacr.zzp(bArr, (long) i9), zzacr.zzp(bArr, (long) i10), cArr, i3);
                    i3 += 2;
                    r12 = i10 + 1;
                } else {
                    throw zzaal.zzi();
    ...
    public final int zzd(java.lang.CharSequence r23, byte[] r24, int r25, int r26) {
        ...
        L_0x001a:
            ...
            long r11 = r11 + r4
            byte r3 = (byte) r13
            com.google.android.gms.internal.p026firebaseauthapi.zzacr.zzq(r1, r4, r3)
            int r2 = r2 + 1
            r4 = r11
            goto L_0x001a
        L_0x002f:
        ...
        L_0x0031:
            ...
            long r14 = r4 + r11
            byte r13 = (byte) r13
            com.google.android.gms.internal.p026firebaseauthapi.zzacr.zzq(r1, r4, r13)
            r4 = r11
            r12 = r14
        L_0x0045:
        ...
        L_0x0049:
            ...
            r5 = r5 | r13
            byte r5 = (byte) r5
            com.google.android.gms.internal.p026firebaseauthapi.zzacr.zzq(r1, r14, r5)
            r20 = r11
            r11 = 128(0x80, float:1.794E-43)
            r12 = r3
            r4 = r20
        ...
        L_0x007c:
            ...
            r5 = r5 | r11
            byte r5 = (byte) r5
            com.google.android.gms.internal.p026firebaseauthapi.zzacr.zzq(r1, r3, r5)
            r12 = r18
            r4 = 1
            goto L_0x0045
        L_0x00aa:
            ...
            byte r15 = (byte) r15
            com.google.android.gms.internal.p026firebaseauthapi.zzacr.zzq(r1, r4, r15)
            long r4 = r13 + r11
            int r15 = r2 >>> 12
            r15 = r15 & 63
            r11 = 128(0x80, float:1.794E-43)
            ...
            byte r12 = (byte) r12
            com.google.android.gms.internal.p026firebaseauthapi.zzacr.zzq(r1, r13, r12)
            r12 = 1
            long r14 = r4 + r12
            int r16 = r2 >>> 6
            r12 = r16 & 63
            r12 = r12 | r11
            byte r12 = (byte) r12
            com.google.android.gms.internal.p026firebaseauthapi.zzacr.zzq(r1, r4, r12)
            r4 = 1
            long r12 = r14 + r4
            r2 = r2 & 63
            r2 = r2 | r11
            byte r2 = (byte) r2
            com.google.android.gms.internal.p026firebaseauthapi.zzacr.zzq(r1, r14, r2)
            r2 = r3
        L_0x00f6:
            int r2 = r2 + 1
            r3 = 128(0x80, float:1.794E-43)
        ...
        L_0x0143:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p026firebaseauthapi.zzacw.zzd(java.lang.CharSequence, byte[], int, int):int");
    }
}
