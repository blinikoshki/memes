...
final class zzhq implements Runnable {
    ...
    public zzhq(zzhr zzhr, String str, URL url, byte[] bArr, Map map, zzfj zzfj, byte[] bArr2) {
        this.zza = zzhr;
    ...
    private final void zzb(int i, Exception exc, byte[] bArr, Map<String, List<String>> map) {
        this.zza.zzx.zzau().zzh(new zzhp(this, i, exc, bArr, map));
    }
    ...
    public final void run() {
        /*
            ...
            r0 = 0
            r1 = 0
            com.google.android.gms.measurement.internal.zzhr r2 = r9.zza     // Catch:{ IOException -> 0x006c, all -> 0x005e }
