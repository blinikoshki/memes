...
public final class OffsetDateTime extends DefaultInterfaceTemporal implements Temporal, TemporalAdjuster, Comparable<OffsetDateTime>, Serializable {
    ...
    /* renamed from: of */
    public static OffsetDateTime m259of(LocalDate localDate, LocalTime localTime, ZoneOffset zoneOffset) {
        return new OffsetDateTime(LocalDateTime.m251of(localDate, localTime), zoneOffset);
    }

    /* renamed from: of */
    public static OffsetDateTime m260of(LocalDateTime localDateTime, ZoneOffset zoneOffset) {
        return new OffsetDateTime(localDateTime, zoneOffset);
    }

    /* renamed from: of */
    public static OffsetDateTime m258of(int i, int i2, int i3, int i4, int i5, int i6, int i7, ZoneOffset zoneOffset) {
        return new OffsetDateTime(LocalDateTime.m247of(i, i2, i3, i4, i5, i6, i7), zoneOffset);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x001c, code lost:
        return ofInstant(org.threeten.p022bp.Instant.from(r3), r0);
     */
    /* JADX WARNING: Missing exception handler attribute for start block: B:9:0x0014 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static org.threeten.p022bp.OffsetDateTime from(org.threeten.p022bp.temporal.TemporalAccessor r3) {
        /*
            boolean r0 = r3 instanceof org.threeten.p022bp.OffsetDateTime
            if (r0 == 0) goto L_0x0007
            org.threeten.bp.OffsetDateTime r3 = (org.threeten.p022bp.OffsetDateTime) r3
            return r3
        L_0x0007:
            org.threeten.bp.ZoneOffset r0 = org.threeten.p022bp.ZoneOffset.from(r3)     // Catch:{ DateTimeException -> 0x001d }
            org.threeten.bp.LocalDateTime r1 = org.threeten.p022bp.LocalDateTime.from(r3)     // Catch:{ DateTimeException -> 0x0014 }
            org.threeten.bp.OffsetDateTime r3 = m260of(r1, r0)     // Catch:{ DateTimeException -> 0x0014 }
            return r3
        L_0x0014:
            org.threeten.bp.Instant r1 = org.threeten.p022bp.Instant.from(r3)     // Catch:{ DateTimeException -> 0x001d }
        ...
        L_0x001d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.OffsetDateTime.from(org.threeten.bp.temporal.TemporalAccessor):org.threeten.bp.OffsetDateTime");
    }
    ...
    static /* synthetic */ class C25053 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.OffsetDateTime.C25053.<clinit>():void");
        }
    }
    ...
    public int get(TemporalField temporalField) {
        ...
        int i = C25053.$SwitchMap$org$threeten$bp$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
        if (i == 1) {
    ...
    public OffsetDateTime with(TemporalField temporalField, long j) {
        ...
        int i = C25053.$SwitchMap$org$threeten$bp$temporal$ChronoField[chronoField.ordinal()];
        if (i == 1) {
    ...
    public OffsetTime toOffsetTime() {
        return OffsetTime.m262of(this.dateTime.toLocalTime(), this.offset);
    }

    public ZonedDateTime toZonedDateTime() {
        return ZonedDateTime.m272of(this.dateTime, this.offset);
    }
    ...
    static OffsetDateTime readExternal(DataInput dataInput) throws IOException {
        return m260of(LocalDateTime.readExternal(dataInput), ZoneOffset.readExternal(dataInput));
    }
}
