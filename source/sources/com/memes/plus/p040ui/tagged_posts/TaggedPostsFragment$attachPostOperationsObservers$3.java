...
/* renamed from: com.memes.plus.ui.tagged_posts.TaggedPostsFragment$attachPostOperationsObservers$3 */
/* compiled from: TaggedPostsFragment.kt */
final class TaggedPostsFragment$attachPostOperationsObservers$3<T> implements Observer<PostDeleteResult> {
    final /* synthetic */ TaggedPostsFragment this$0;

    TaggedPostsFragment$attachPostOperationsObservers$3(TaggedPostsFragment taggedPostsFragment) {
    ...
    public final void onChanged(PostDeleteResult postDeleteResult) {
        ...
        access$getPostsLayoutSwitcher$p.applyUpdate(postDeleteResult);
