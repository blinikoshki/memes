...
public final class TypeDeserializer {
    ...
    /* renamed from: c */
    public final DeserializationContext f363c;
    ...
    public TypeDeserializer(DeserializationContext deserializationContext, TypeDeserializer typeDeserializer, List<ProtoBuf.TypeParameter> list, String str, String str2, boolean z) {
        ...
        this.f363c = deserializationContext;
        ...
        if (list.isEmpty()) {
            ...
            for (ProtoBuf.TypeParameter next : list) {
                linkedHashMap.put(Integer.valueOf(next.getId()), new DeserializedTypeParameterDescriptor(this.f363c, next, i));
                i++;
            }
            map = linkedHashMap;
        }
    ...
    public final KotlinType type(ProtoBuf.Type type) {
        ...
        String string = this.f363c.getNameResolver().getString(type.getFlexibleTypeCapabilitiesId());
        SimpleType simpleType$default = simpleType$default(this, type, false, 2, (Object) null);
        ProtoBuf.Type flexibleUpperBound = ProtoTypeTableUtilKt.flexibleUpperBound(type, this.f363c.getTypeTable());
        Intrinsics.checkNotNull(flexibleUpperBound);
        return this.f363c.getComponents().getFlexibleTypeDeserializer().create(type, string, simpleType$default, simpleType$default(this, flexibleUpperBound, false, 2, (Object) null));
    }
    ...
    public final SimpleType simpleType(ProtoBuf.Type type, boolean z) {
        ...
        DeserializedAnnotations deserializedAnnotations = new DeserializedAnnotations(this.f363c.getStorageManager(), new TypeDeserializer$simpleType$annotations$1(this, type));
        ...
        ProtoBuf.Type abbreviatedType = ProtoTypeTableUtilKt.abbreviatedType(type, this.f363c.getTypeTable());
        ...
        return this.f363c.getComponents().getPlatformDependentTypeTransformer().transformPlatformType(NameResolverUtilKt.getClassId(this.f363c.getNameResolver(), type.getClassName()), simpleType2);
    }
    ...
    private static final List<ProtoBuf.Type.Argument> simpleType$collectAllArguments(ProtoBuf.Type type, TypeDeserializer typeDeserializer) {
        ...
        ProtoBuf.Type outerType = ProtoTypeTableUtilKt.outerType(type, typeDeserializer.f363c.getTypeTable());
    ...
    private static final ClassDescriptor typeConstructor$notFoundClass(TypeDeserializer typeDeserializer, ProtoBuf.Type type, int i) {
        ClassId classId = NameResolverUtilKt.getClassId(typeDeserializer.f363c.getNameResolver(), i);
        List mutableList = SequencesKt.toMutableList(SequencesKt.map(SequencesKt.generateSequence(type, new C2181x131ab842(typeDeserializer)), C2182x131ab843.INSTANCE));
        int count = SequencesKt.count(SequencesKt.generateSequence(classId, C2180x1c22db09.INSTANCE));
        while (mutableList.size() < count) {
            mutableList.add(0);
        }
        return typeDeserializer.f363c.getComponents().getNotFoundClasses().getClass(classId, mutableList);
    }
    ...
    private final TypeConstructor typeConstructor(ProtoBuf.Type type) {
        ...
        if (type.hasClassName()) {
            ...
            DeclarationDescriptor containingDeclaration = this.f363c.getContainingDeclaration();
            String string = this.f363c.getNameResolver().getString(type.getTypeParameterName());
    ...
    private final SimpleType transformRuntimeFunctionTypeToSuspendFunction(KotlinType kotlinType) {
        boolean releaseCoroutines = this.f363c.getComponents().getConfiguration().getReleaseCoroutines();
    ...
    public final ClassifierDescriptor computeClassifierDescriptor(int i) {
        ClassId classId = NameResolverUtilKt.getClassId(this.f363c.getNameResolver(), i);
        if (classId.isLocal()) {
            return this.f363c.getComponents().deserializeClass(classId);
        }
        return FindClassInModuleKt.findClassifierAcrossModuleDependencies(this.f363c.getComponents().getModuleDescriptor(), classId);
    }

    private final SimpleType computeLocalClassifierReplacementType(int i) {
        if (NameResolverUtilKt.getClassId(this.f363c.getNameResolver(), i).isLocal()) {
            return this.f363c.getComponents().getLocalClassifierTypeSettings().getReplacementTypeForLocalClassifiers();
        }
        return null;
    }
    ...
    public final ClassifierDescriptor computeTypeAliasDescriptor(int i) {
        ...
        return FindClassInModuleKt.findTypeAliasAcrossModuleDependencies(this.f363c.getComponents().getModuleDescriptor(), classId);
    }
    ...
    private final TypeProjection typeArgument(TypeParameterDescriptor typeParameterDescriptor, ProtoBuf.Type.Argument argument) {
        if (argument.getProjection() != ProtoBuf.Type.Argument.Projection.STAR) {
            ...
            ProtoBuf.Type type = ProtoTypeTableUtilKt.type(argument, this.f363c.getTypeTable());
            if (type == null) {
            ...
            return new StarProjectionForAbsentTypeParameter(this.f363c.getComponents().getModuleDescriptor().getBuiltIns());
        } else {
