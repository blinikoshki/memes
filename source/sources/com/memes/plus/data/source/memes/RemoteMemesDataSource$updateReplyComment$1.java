...
final class RemoteMemesDataSource$updateReplyComment$1<T, R> implements Function<Response<ApiObjectResponse<Reply>>, UniversalResult<Reply>> {
    public static final RemoteMemesDataSource$updateReplyComment$1 INSTANCE = new RemoteMemesDataSource$updateReplyComment$1();

    RemoteMemesDataSource$updateReplyComment$1() {
    }
