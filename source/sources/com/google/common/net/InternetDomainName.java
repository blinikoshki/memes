...
public final class InternetDomainName {
    ...
    private static final Joiner DOT_JOINER = Joiner.m402on((char) ClassUtils.PACKAGE_SEPARATOR_CHAR);
    private static final Splitter DOT_SPLITTER = Splitter.m415on((char) ClassUtils.PACKAGE_SEPARATOR_CHAR);
    ...
    static {
        ...
        DASH_MATCHER = anyOf;
        PART_CHAR_MATCHER = CharMatcher.javaLetterOrDigit().mo46498or(anyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m404of(PublicSuffixType.REGISTRY));
    }
