...
final class EditorActivity$watermarkViewModel$2 extends Lambda implements Function0<WatermarkViewModel> {
    final /* synthetic */ EditorActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EditorActivity$watermarkViewModel$2(EditorActivity editorActivity) {
        super(0);
    ...
    public final WatermarkViewModel invoke() {
        ...
        Function0 function0 = C46861.INSTANCE;
        if (function0 == null) {
            viewModel = ViewModelProviders.m17of((FragmentActivity) editorActivity).get(WatermarkViewModel.class);
            Intrinsics.checkNotNullExpressionValue(viewModel, "ViewModelProviders.of(this).get(T::class.java)");
        } else {
            viewModel = ViewModelProviders.m18of((FragmentActivity) editorActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(function0)).get(WatermarkViewModel.class);
