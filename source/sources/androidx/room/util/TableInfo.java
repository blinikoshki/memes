...
public class TableInfo {
        ...
        try {
            ...
            if (!(columnIndex == -1 || columnIndex2 == -1)) {
                if (columnIndex3 != -1) {
                    HashSet hashSet = new HashSet();
                    while (query.moveToNext()) {
                        if (com.appsflyer.share.Constants.URL_CAMPAIGN.equals(query.getString(columnIndex2))) {
                            String string = query.getString(columnIndex);
                            boolean z = true;
    ...
    public static class Column {
        ...
        public int hashCode() {
            return (((((this.name.hashCode() * 31) + this.affinity) * 31) + (this.notNull ? MediaType.PHOTO : MediaType.GIFV)) * 31) + this.primaryKeyPosition;
        }
