...
/* renamed from: io.getstream.chat.android.client.ChatClient$subscribeForSingle$filter$1 */
/* compiled from: ChatClient.kt */
final class ChatClient$subscribeForSingle$filter$1 extends Lambda implements Function1<ChatEvent, Boolean> {
    final /* synthetic */ String $eventType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChatClient$subscribeForSingle$filter$1(String str) {
        super(1);
        this.$eventType = str;
    }
