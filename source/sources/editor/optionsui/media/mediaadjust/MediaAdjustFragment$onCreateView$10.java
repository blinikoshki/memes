...
final class MediaAdjustFragment$onCreateView$10<T> implements Observer<Boolean> {
    final /* synthetic */ MediaAdjustFragment this$0;

    MediaAdjustFragment$onCreateView$10(MediaAdjustFragment mediaAdjustFragment) {
        this.this$0 = mediaAdjustFragment;
    }

    public final void onChanged(Boolean bool) {
        SmallOptionButton smallOptionButton = MediaAdjustFragment.access$getBinding$p(this.this$0).flipHorizontalOptionView;
        Intrinsics.checkNotNullExpressionValue(smallOptionButton, "binding.flipHorizontalOptionView");
