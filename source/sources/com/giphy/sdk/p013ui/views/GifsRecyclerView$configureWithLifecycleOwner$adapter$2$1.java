...
/* renamed from: com.giphy.sdk.ui.views.GifsRecyclerView$configureWithLifecycleOwner$adapter$2$1 */
/* compiled from: GifsRecyclerView.kt */
final class GifsRecyclerView$configureWithLifecycleOwner$adapter$2$1 extends FunctionReference implements Function2<List<? extends Media>, Integer, Unit> {
    GifsRecyclerView$configureWithLifecycleOwner$adapter$2$1(GifsRecyclerView gifsRecyclerView) {
    ...
    public final void invoke(List<Media> list, int i) {
        ...
        ((GifsRecyclerView) this.receiver).gifClickListener(list, i);
    }
}
