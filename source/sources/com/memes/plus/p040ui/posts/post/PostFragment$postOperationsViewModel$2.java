...
/* renamed from: com.memes.plus.ui.posts.post.PostFragment$postOperationsViewModel$2 */
/* compiled from: PostFragment.kt */
final class PostFragment$postOperationsViewModel$2 extends Lambda implements Function0<PostOperationsViewModel> {
    final /* synthetic */ PostFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PostFragment$postOperationsViewModel$2(PostFragment postFragment) {
        super(0);
    ...
    public final PostOperationsViewModel invoke() {
        ...
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<PostOperationsViewModel>(this) {
            final /* synthetic */ PostFragment$postOperationsViewModel$2 this$0;
