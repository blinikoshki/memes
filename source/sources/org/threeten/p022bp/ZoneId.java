...
import org.threeten.p022bp.zone.ZoneRulesException;
...
public abstract class ZoneId implements Serializable {
    ...
    public static ZoneId systemDefault() {
        return m268of(TimeZone.getDefault().getID(), SHORT_IDS);
    }
    ...
    /* renamed from: of */
    public static ZoneId m268of(String str, Map<String, String> map) {
    ...
    /* renamed from: of */
    public static ZoneId m267of(String str) {
        Jdk8Methods.requireNonNull(str, "zoneId");
        if (str.equals("Z")) {
        ...
        } else if (str.startsWith("+") || str.startsWith(CoreConfig.ENTITY_TOKEN_PREFIX)) {
            return ZoneOffset.m269of(str);
        } else {
            if (str.equals("UTC") || str.equals("GMT") || str.equals("UT")) {
                return new ZoneRegion(str, ZoneOffset.UTC.getRules());
            }
            if (str.startsWith("UTC+") || str.startsWith("GMT+") || str.startsWith("UTC-") || str.startsWith("GMT-")) {
                ZoneOffset of = ZoneOffset.m269of(str.substring(3));
                ...
                ZoneOffset of2 = ZoneOffset.m269of(str.substring(2));
