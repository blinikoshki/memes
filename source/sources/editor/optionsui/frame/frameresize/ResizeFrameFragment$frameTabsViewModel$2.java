...
final class ResizeFrameFragment$frameTabsViewModel$2 extends Lambda implements Function0<FrameTabsViewModel> {
    final /* synthetic */ ResizeFrameFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ResizeFrameFragment$frameTabsViewModel$2(ResizeFrameFragment resizeFrameFragment) {
        super(0);
    ...
    public final FrameTabsViewModel invoke() {
        ...
        Function0 function0 = C48451.INSTANCE;
        if (function0 == null) {
