...
public abstract class Chronology implements Comparable<Chronology> {
    ...
    /* renamed from: of */
    public static Chronology m274of(String str) {
        init();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:0x001a, code lost:
        return org.threeten.p022bp.chrono.ChronoZonedDateTimeImpl.ofBest(ensureChronoLocalDateTime(localDateTime(r5)), r0, (org.threeten.p022bp.ZoneOffset) null);
     */
    /* JADX WARNING: Exception block dominator not found, dom blocks: [] */
    /* JADX WARNING: Missing exception handler attribute for start block: B:5:0x000d */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public org.threeten.p022bp.chrono.ChronoZonedDateTime<?> zonedDateTime(org.threeten.p022bp.temporal.TemporalAccessor r5) {
        /*
            r4 = this;
            org.threeten.bp.ZoneId r0 = org.threeten.p022bp.ZoneId.from(r5)     // Catch:{ DateTimeException -> 0x001b }
            org.threeten.bp.Instant r1 = org.threeten.p022bp.Instant.from(r5)     // Catch:{ DateTimeException -> 0x000d }
        ...
        L_0x000d:
            ...
            r2 = 0
            org.threeten.bp.chrono.ChronoZonedDateTime r5 = org.threeten.p022bp.chrono.ChronoZonedDateTimeImpl.ofBest(r1, r0, r2)     // Catch:{ DateTimeException -> 0x001b }
            return r5
        L_0x001b:
            r0 = move-exception
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.Chronology.zonedDateTime(org.threeten.bp.temporal.TemporalAccessor):org.threeten.bp.chrono.ChronoZonedDateTime");
    }
    ...
    private Object writeReplace() {
        return new Ser(Ascii.f592VT, this);
    }
    ...
    static Chronology readExternal(DataInput dataInput) throws IOException {
        return m274of(dataInput.readUTF());
    }
}
