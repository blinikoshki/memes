...
/* renamed from: io.getstream.chat.android.client.ChatClient$connectAnonymousUser$1 */
/* compiled from: ChatClient.kt */
final class ChatClient$connectAnonymousUser$1 extends Lambda implements Function1<InitConnectionListener, Unit> {
    final /* synthetic */ ChatClient this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChatClient$connectAnonymousUser$1(ChatClient chatClient) {
        super(1);
    ...
    public final void invoke(InitConnectionListener initConnectionListener) {
        ...
        this.this$0.setAnonymousUser(initConnectionListener);
    }
}
