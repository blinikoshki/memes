...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C2727R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C2727R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C2727R.attr.colorSurface, 0);
