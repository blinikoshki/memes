...
final class ChannelViewModelFactory$factories$2 extends Lambda implements Function0<ViewModel> {
    final /* synthetic */ ChannelViewModelFactory this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChannelViewModelFactory$factories$2(ChannelViewModelFactory channelViewModelFactory) {
        super(0);
        this.this$0 = channelViewModelFactory;
    }

    public final ViewModel invoke() {
        return new MessageInputViewModel(this.this$0.cid, (ChatDomain) null, 2, (DefaultConstructorMarker) null);
    }
}
