...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$addMembers$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$addMembers$1 extends Lambda implements Function1<ChannelResponse, Channel> {
    final /* synthetic */ GsonChatApi this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GsonChatApi$addMembers$1(GsonChatApi gsonChatApi) {
        super(1);
