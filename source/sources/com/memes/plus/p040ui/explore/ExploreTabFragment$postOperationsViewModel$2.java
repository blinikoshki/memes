...
/* renamed from: com.memes.plus.ui.explore.ExploreTabFragment$postOperationsViewModel$2 */
/* compiled from: ExploreTabFragment.kt */
final class ExploreTabFragment$postOperationsViewModel$2 extends Lambda implements Function0<PostOperationsViewModel> {
    final /* synthetic */ ExploreTabFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ExploreTabFragment$postOperationsViewModel$2(ExploreTabFragment exploreTabFragment) {
        super(0);
    ...
    public final PostOperationsViewModel invoke() {
        ...
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<PostOperationsViewModel>(this) {
            final /* synthetic */ ExploreTabFragment$postOperationsViewModel$2 this$0;
