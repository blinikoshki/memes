...
/* renamed from: io.getstream.chat.android.client.utils.observable.ChatEventsObservable$subscribe$1 */
/* compiled from: ChatEventsObservable.kt */
final class ChatEventsObservable$subscribe$1 extends Lambda implements Function1<ChatEvent, Boolean> {
    public static final ChatEventsObservable$subscribe$1 INSTANCE = new ChatEventsObservable$subscribe$1();

    ChatEventsObservable$subscribe$1() {
        super(1);
    }
