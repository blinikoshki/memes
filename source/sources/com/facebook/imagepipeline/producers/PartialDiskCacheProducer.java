...
public class PartialDiskCacheProducer implements Producer<EncodedImage> {
    ...
    static Map<String, String> getExtraMap(ProducerListener2 producerListener2, ProducerContext producerContext, boolean z, int i) {
        ...
        if (z) {
            return ImmutableMap.m30of("cached_value_found", String.valueOf(z), "encodedImageSize", String.valueOf(i));
        }
        return ImmutableMap.m29of("cached_value_found", String.valueOf(z));
    }
            ...
            if (!isNotLast(i)) {
                if (this.mPartialEncodedImageFromCache != null && encodedImage.getBytesRange() != null) {
                    try {
                        ...
                        FLog.m58e(PartialDiskCacheProducer.PRODUCER_NAME, "Error while merging image data", (Throwable) e);
