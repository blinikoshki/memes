...
import p015io.reactivex.internal.operators.maybe.MaybeDoOnTerminate;
...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo23855as(MaybeConverter<T, ? extends R> maybeConverter) {
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo23943to(Function<? super Maybe<T>, R> function) {
        try {
