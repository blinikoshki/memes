...
public final class Decoder {
    private static final String[] DIGIT_TABLE = {"CTRL_PS", StringUtils.SPACE, "0", "1", ExifInterface.GPS_MEASUREMENT_2D, ExifInterface.GPS_MEASUREMENT_3D, ProductSubscriptionType.YEARLY, ProductSubscriptionType.MONTHLY, "6", "7", "8", "9", Util.EVENT_ID_SEPARATOR, ".", "CTRL_UL", "CTRL_US"};
    private static final String[] LOWER_TABLE = {"CTRL_PS", StringUtils.SPACE, FfmpegCommand.AUDIO_STREAM, "b", Constants.URL_CAMPAIGN, "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", TtmlNode.TAG_P, "q", "r", FfmpegCommand.SUBTITLE_STREAM, "t", "u", FfmpegCommand.VIDEO_STREAM, "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = {"CTRL_PS", StringUtils.SPACE, "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", StringUtils.f466LF, "\u000b", "\f", StringUtils.f465CR, "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", "|", "~", "", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", StringUtils.f465CR, "\r\n", ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", "(", ")", "*", "+", Util.EVENT_ID_SEPARATOR, CoreConfig.ENTITY_TOKEN_PREFIX, ".", "/", ":", ";", "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
    ...
    static /* synthetic */ class C39351 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.aztec.decoder.Decoder.C39351.<clinit>():void");
        }
    }

    private static String getCharacter(Table table, int i) {
        int i2 = C39351.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
