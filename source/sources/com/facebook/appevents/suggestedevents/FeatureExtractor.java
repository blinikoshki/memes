...
final class FeatureExtractor {
    ...
    static void initialize(File file) {
        try {
            ...
            languageInfo.put(ViewHierarchyConstants.JAPANESE, ProductSubscriptionType.YEARLY);
            ...
            eventInfo.put(ViewHierarchyConstants.INITIATE_CHECKOUT, ProductSubscriptionType.YEARLY);
            eventInfo.put(ViewHierarchyConstants.ADD_PAYMENT_INFO, ProductSubscriptionType.MONTHLY);
            ...
            textTypeInfo.put(ViewHierarchyConstants.BUTTON_ID, ProductSubscriptionType.YEARLY);
            initialized = true;
