...
final class FrameTabsFragment$onViewCreated$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ FrameTabsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FrameTabsFragment$onViewCreated$1(FrameTabsFragment frameTabsFragment) {
        super(0);
