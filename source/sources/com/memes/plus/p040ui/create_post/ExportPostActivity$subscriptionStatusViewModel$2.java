...
/* renamed from: com.memes.plus.ui.create_post.ExportPostActivity$subscriptionStatusViewModel$2 */
/* compiled from: ExportPostActivity.kt */
final class ExportPostActivity$subscriptionStatusViewModel$2 extends Lambda implements Function0<SubscriptionStatusViewModel> {
    final /* synthetic */ ExportPostActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ExportPostActivity$subscriptionStatusViewModel$2(ExportPostActivity exportPostActivity) {
        super(0);
    ...
    public final SubscriptionStatusViewModel invoke() {
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) this.this$0, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<SubscriptionStatusViewModel>(this) {
            final /* synthetic */ ExportPostActivity$subscriptionStatusViewModel$2 this$0;
