...
final class TextEditFragment$setTextAlignmentListeners$3 implements View.OnClickListener {
    final /* synthetic */ TextEditFragment this$0;

    TextEditFragment$setTextAlignmentListeners$3(TextEditFragment textEditFragment) {
    ...
    public final void onClick(View view) {
        ...
        this.this$0.getTextEditViewModel().changeAlignment(TextAlignment.RIGHT);
        AppCompatImageView appCompatImageView = TextEditFragment.access$getBinding$p(this.this$0).alignLeftOptionView;
        Intrinsics.checkNotNullExpressionValue(appCompatImageView, "binding.alignLeftOptionView");
        appCompatImageView.setSelected(false);
        AppCompatImageView appCompatImageView2 = TextEditFragment.access$getBinding$p(this.this$0).alignCenterOptionView;
