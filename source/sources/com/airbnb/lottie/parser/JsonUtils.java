...
class JsonUtils {
    ...
    static /* synthetic */ class C09961 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.parser.JsonUtils.C09961.<clinit>():void");
        }
    }

    static PointF jsonToPoint(JsonReader jsonReader, float f) throws IOException {
        int i = C09961.$SwitchMap$android$util$JsonToken[jsonReader.peek().ordinal()];
        if (i == 1) {
    ...
    static float valueFromObject(JsonReader jsonReader) throws IOException {
        ...
        int i = C09961.$SwitchMap$android$util$JsonToken[peek.ordinal()];
        if (i == 1) {
