...
final class LayoutBackgroundTabsFragment$gradientsViewModel$2 extends Lambda implements Function0<GradientsViewModel> {
    final /* synthetic */ LayoutBackgroundTabsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LayoutBackgroundTabsFragment$gradientsViewModel$2(LayoutBackgroundTabsFragment layoutBackgroundTabsFragment) {
        super(0);
    ...
    public final GradientsViewModel invoke() {
        ...
        ViewModel viewModel = ViewModelProviders.m18of(requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<GradientsViewModel>(this) {
            final /* synthetic */ LayoutBackgroundTabsFragment$gradientsViewModel$2 this$0;
            ...
            public final GradientsViewModel invoke() {
                return new GradientsViewModel(this.this$0.this$0.getAssetsProvider());
            }
