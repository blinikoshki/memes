...
public final class Internal {
    ...
    public static final Response cacheGet(Cache cache, Request request) {
        Intrinsics.checkNotNullParameter(cache, OutputTarget.FOLDER_CACHE);
