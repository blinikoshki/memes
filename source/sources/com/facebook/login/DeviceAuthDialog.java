...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        this.dialog = new Dialog(getActivity(), C1285R.C1291style.com_facebook_auth_dialog);
    ...
    public void startLogin(LoginClient.Request request) {
        ...
        bundle.putString("scope", TextUtils.join(Util.EVENT_ID_SEPARATOR, request.getPermissions()));
    ...
    public View initializeContentView(boolean z) {
        ...
        this.progressBar = inflate.findViewById(C1285R.C1288id.progress_bar);
        this.confirmationCode = (TextView) inflate.findViewById(C1285R.C1288id.confirmation_code);
        ((Button) inflate.findViewById(C1285R.C1288id.cancel_button)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DeviceAuthDialog.this.onCancel();
            }
        });
        TextView textView = (TextView) inflate.findViewById(C1285R.C1288id.com_facebook_device_auth_instructions);
        this.instructions = textView;
        textView.setText(Html.fromHtml(getString(C1285R.string.com_facebook_device_auth_instructions)));
        return inflate;
    }

    /* access modifiers changed from: protected */
    public int getLayoutResId(boolean z) {
        return z ? C1285R.C1290layout.com_facebook_smart_device_dialog_fragment : C1285R.C1290layout.com_facebook_device_auth_dialog_fragment;
    }
    ...
    public void presentConfirmation(String str, Utility.PermissionsLists permissionsLists, String str2, String str3, Date date, Date date2) {
        String string = getResources().getString(C1285R.string.com_facebook_smart_login_confirmation_title);
        String string2 = getResources().getString(C1285R.string.com_facebook_smart_login_confirmation_continue_as);
        String string3 = getResources().getString(C1285R.string.com_facebook_smart_login_confirmation_cancel);
