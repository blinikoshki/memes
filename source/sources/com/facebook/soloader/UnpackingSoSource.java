...
public abstract class UnpackingSoSource extends DirectorySoSource {
    ...
    private boolean refreshLocked(com.facebook.soloader.FileLocker r12, int r13, byte[] r14) throws java.io.IOException {
        ...
        L_0x0043:
            ...
            r7.<init>(r5, r2)
            long r9 = r7.length()     // Catch:{ all -> 0x00f6 }
            int r2 = (int) r9     // Catch:{ all -> 0x00f6 }
            byte[] r9 = new byte[r2]     // Catch:{ all -> 0x00f6 }
            int r10 = r7.read(r9)     // Catch:{ all -> 0x00f6 }
            if (r10 == r2) goto L_0x0069
            java.lang.String r2 = "short read of so store deps file: marking unclean"
            android.util.Log.v(r0, r2)     // Catch:{ all -> 0x00f6 }
            r4 = 0
        L_0x0069:
            boolean r2 = java.util.Arrays.equals(r9, r14)     // Catch:{ all -> 0x00f6 }
        ...
        L_0x007e:
            ...
            android.util.Log.v(r0, r1)     // Catch:{ all -> 0x00f6 }
            writeState(r6, r3)     // Catch:{ all -> 0x00f6 }
            com.facebook.soloader.UnpackingSoSource$Unpacker r0 = r11.makeUnpacker()     // Catch:{ all -> 0x00f6 }
            ...
            r11.regenerate(r4, r1, r2)     // Catch:{ all -> 0x00da }
        ...
        L_0x00e3:
            r14 = move-exception
            r12.addSuppressed(r14)     // Catch:{ all -> 0x00e8 }
        L_0x00e7:
        ...
        L_0x00f1:
            r14 = move-exception
            r12.addSuppressed(r14)     // Catch:{ all -> 0x00f6 }
        L_0x00f5:
