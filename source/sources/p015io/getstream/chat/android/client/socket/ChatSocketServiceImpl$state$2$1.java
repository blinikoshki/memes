...
/* renamed from: io.getstream.chat.android.client.socket.ChatSocketServiceImpl$state$2$1 */
/* compiled from: ChatSocketServiceImpl.kt */
final class ChatSocketServiceImpl$state$2$1 extends Lambda implements Function1<SocketListener, Unit> {
    public static final ChatSocketServiceImpl$state$2$1 INSTANCE = new ChatSocketServiceImpl$state$2$1();

    ChatSocketServiceImpl$state$2$1() {
        super(1);
    }
