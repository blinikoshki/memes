...
/* renamed from: io.getstream.chat.android.client.api2.MoshiChatApi$updateMessage$1 */
/* compiled from: MoshiChatApi.kt */
final class MoshiChatApi$updateMessage$1 extends Lambda implements Function1<MessageResponse, Message> {
    public static final MoshiChatApi$updateMessage$1 INSTANCE = new MoshiChatApi$updateMessage$1();

    MoshiChatApi$updateMessage$1() {
        super(1);
    }
