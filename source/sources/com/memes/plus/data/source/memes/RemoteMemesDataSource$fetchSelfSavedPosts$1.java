...
final class RemoteMemesDataSource$fetchSelfSavedPosts$1<T, R> implements Function<Response<ApiListResponse<Post>>, UniversalResult<Post>> {
    final /* synthetic */ int $page;

    RemoteMemesDataSource$fetchSelfSavedPosts$1(int i) {
        this.$page = i;
    }
