...
/* renamed from: com.memes.plus.ui.profile.self_profile.SelfProfileFragment$onObserversRequested$3 */
/* compiled from: SelfProfileFragment.kt */
final class SelfProfileFragment$onObserversRequested$3<T> implements Observer<ContentVisibilityAction> {
    final /* synthetic */ SelfProfileFragment this$0;

    SelfProfileFragment$onObserversRequested$3(SelfProfileFragment selfProfileFragment) {
        this.this$0 = selfProfileFragment;
    }

    public final void onChanged(ContentVisibilityAction contentVisibilityAction) {
        ContentLayout contentLayout = ((SelfProfileFragmentBinding) this.this$0.getBinding()).fullPageContentLayout;
