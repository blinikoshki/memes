...
/* renamed from: com.memes.chat.ui.channel.members.ChannelMembersActivity$onRemoveChannelMemberViewTapped$1 */
/* compiled from: ChannelMembersActivity.kt */
final class ChannelMembersActivity$onRemoveChannelMemberViewTapped$1 implements DialogInterface.OnClickListener {
    final /* synthetic */ Member $channelMember;
    final /* synthetic */ ChannelMembersActivity this$0;

    ChannelMembersActivity$onRemoveChannelMemberViewTapped$1(ChannelMembersActivity channelMembersActivity, Member member) {
        this.this$0 = channelMembersActivity;
        this.$channelMember = member;
    }

    public final void onClick(DialogInterface dialogInterface, int i) {
        this.this$0.getChannelMembersViewModel().removeChannelMember(this.$channelMember);
    }
}
