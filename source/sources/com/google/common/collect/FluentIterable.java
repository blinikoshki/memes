...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo46466or(this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m423of() {
        return from(ImmutableList.m433of());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m424of(@NullableDecl E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m404of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m404of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m404of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m404of(next);
    }
