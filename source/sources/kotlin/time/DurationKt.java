...
public final class DurationKt {
    ...
    private static final double m2348timesmvk6XK0(int i, double d) {
        return Duration.m2328timesUwyO8pc(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m2347timeskIfJnKk(double d, double d2) {
        return Duration.m2327timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkNotNullParameter(timeUnit, "unit");
        return Duration.m2301constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
