...
/* renamed from: io.getstream.chat.android.client.socket.ChatSocketServiceImpl$state$2$3 */
/* compiled from: ChatSocketServiceImpl.kt */
final class ChatSocketServiceImpl$state$2$3 extends Lambda implements Function1<SocketListener, Unit> {
    public static final ChatSocketServiceImpl$state$2$3 INSTANCE = new ChatSocketServiceImpl$state$2$3();

    ChatSocketServiceImpl$state$2$3() {
        super(1);
    }
