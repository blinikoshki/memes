...
final class MediaEditFragment$onCreateView$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ MediaEditFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MediaEditFragment$onCreateView$1(MediaEditFragment mediaEditFragment) {
        super(0);
        this.this$0 = mediaEditFragment;
    }

    public final void invoke() {
        this.this$0.getViewModel().selectFullSizeOption();
    }
}
