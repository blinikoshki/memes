...
abstract class zzhm<T extends zzhe> {
    ...
    static <T extends zzhe> T zzb(Class<T> cls) {
        ...
        try {
            return (zzhe) cls.cast(((zzhm) Class.forName(str, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).zza());
            ...
            try {
                return (zzhe) cls.getMethod("combine", new Class[]{Collection.class}).invoke((Object) null, new Object[]{arrayList});
