...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$unmuteUser$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$unmuteUser$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final GsonChatApi$unmuteUser$1 INSTANCE = new GsonChatApi$unmuteUser$1();

    GsonChatApi$unmuteUser$1() {
        super(1);
    }
