...
public abstract class Clock {
    ...
    public static Clock tickSeconds(ZoneId zoneId) {
        return new TickClock(system(zoneId), C1844C.NANOS_PER_SECOND);
    }
    ...
    public static Clock tick(Clock clock, Duration duration) {
        ...
        if (!duration.isNegative()) {
            ...
            if (nanos % 1000000 != 0 && C1844C.NANOS_PER_SECOND % nanos != 0) {
    ...
    static final class FixedClock extends Clock implements Serializable {
        ...
        public String toString() {
            return "FixedClock[" + this.instant + Util.EVENT_ID_SEPARATOR + this.zone + "]";
        }
    }
    ...
    static final class OffsetClock extends Clock implements Serializable {
        ...
        public String toString() {
            return "OffsetClock[" + this.baseClock + Util.EVENT_ID_SEPARATOR + this.offset + "]";
        }
    }
    ...
    static final class TickClock extends Clock implements Serializable {
        ...
        public String toString() {
            return "TickClock[" + this.baseClock + Util.EVENT_ID_SEPARATOR + Duration.ofNanos(this.tickNanos) + "]";
        }
    }
}
