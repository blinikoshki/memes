...
public class WorkerWrapper implements Runnable {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:10:0x001f A[Catch:{ all -> 0x0067 }] */
    /* JADX WARNING: Removed duplicated region for block: B:12:0x0028 A[Catch:{ all -> 0x0067 }] */
    ...
    private void resolve(boolean r6) {
        /*
            ...
            r0.beginTransaction()
            androidx.work.impl.WorkDatabase r0 = r5.mWorkDatabase     // Catch:{ all -> 0x0067 }
            androidx.work.impl.model.WorkSpecDao r0 = r0.workSpecDao()     // Catch:{ all -> 0x0067 }
            java.util.List r0 = r0.getAllUnfinishedWork()     // Catch:{ all -> 0x0067 }
            r1 = 1
            r2 = 0
        ...
        L_0x001d:
            ...
            android.content.Context r0 = r5.mAppContext     // Catch:{ all -> 0x0067 }
            java.lang.Class<androidx.work.impl.background.systemalarm.RescheduleReceiver> r3 = androidx.work.impl.background.systemalarm.RescheduleReceiver.class
            androidx.work.impl.utils.PackageManagerHelper.setComponentEnabled(r0, r3, r2)     // Catch:{ all -> 0x0067 }
        L_0x0026:
            if (r6 == 0) goto L_0x003e
            androidx.work.impl.model.WorkSpecDao r0 = r5.mWorkSpecDao     // Catch:{ all -> 0x0067 }
            androidx.work.WorkInfo$State r3 = androidx.work.WorkInfo.State.ENQUEUED     // Catch:{ all -> 0x0067 }
            java.lang.String[] r1 = new java.lang.String[r1]     // Catch:{ all -> 0x0067 }
            java.lang.String r4 = r5.mWorkSpecId     // Catch:{ all -> 0x0067 }
            r1[r2] = r4     // Catch:{ all -> 0x0067 }
            r0.setState(r3, r1)     // Catch:{ all -> 0x0067 }
            androidx.work.impl.model.WorkSpecDao r0 = r5.mWorkSpecDao     // Catch:{ all -> 0x0067 }
            java.lang.String r1 = r5.mWorkSpecId     // Catch:{ all -> 0x0067 }
            r2 = -1
            r0.markWorkSpecScheduled(r1, r2)     // Catch:{ all -> 0x0067 }
        L_0x003e:
            androidx.work.impl.model.WorkSpec r0 = r5.mWorkSpec     // Catch:{ all -> 0x0067 }
            if (r0 == 0) goto L_0x0053
            androidx.work.ListenableWorker r0 = r5.mWorker     // Catch:{ all -> 0x0067 }
            if (r0 == 0) goto L_0x0053
            boolean r0 = r0.isRunInForeground()     // Catch:{ all -> 0x0067 }
            if (r0 == 0) goto L_0x0053
            androidx.work.impl.foreground.ForegroundProcessor r0 = r5.mForegroundProcessor     // Catch:{ all -> 0x0067 }
            java.lang.String r1 = r5.mWorkSpecId     // Catch:{ all -> 0x0067 }
            r0.stopForeground(r1)     // Catch:{ all -> 0x0067 }
        L_0x0053:
            androidx.work.impl.WorkDatabase r0 = r5.mWorkDatabase     // Catch:{ all -> 0x0067 }
            r0.setTransactionSuccessful()     // Catch:{ all -> 0x0067 }
            androidx.work.impl.WorkDatabase r0 = r5.mWorkDatabase
            r0.endTransaction()
