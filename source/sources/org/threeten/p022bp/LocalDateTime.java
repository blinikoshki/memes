...
public final class LocalDateTime extends ChronoLocalDateTime<LocalDate> implements Temporal, TemporalAdjuster, Serializable {
    ...
    public static final LocalDateTime MAX = m251of(LocalDate.MAX, LocalTime.MAX);
    public static final LocalDateTime MIN = m251of(LocalDate.MIN, LocalTime.MIN);
    ...
    /* renamed from: of */
    public static LocalDateTime m248of(int i, Month month, int i2, int i3, int i4) {
        return new LocalDateTime(LocalDate.m244of(i, month, i2), LocalTime.m252of(i3, i4));
    }

    /* renamed from: of */
    public static LocalDateTime m249of(int i, Month month, int i2, int i3, int i4, int i5) {
        return new LocalDateTime(LocalDate.m244of(i, month, i2), LocalTime.m253of(i3, i4, i5));
    }

    /* renamed from: of */
    public static LocalDateTime m250of(int i, Month month, int i2, int i3, int i4, int i5, int i6) {
        return new LocalDateTime(LocalDate.m244of(i, month, i2), LocalTime.m254of(i3, i4, i5, i6));
    }

    /* renamed from: of */
    public static LocalDateTime m245of(int i, int i2, int i3, int i4, int i5) {
        return new LocalDateTime(LocalDate.m243of(i, i2, i3), LocalTime.m252of(i4, i5));
    }

    /* renamed from: of */
    public static LocalDateTime m246of(int i, int i2, int i3, int i4, int i5, int i6) {
        return new LocalDateTime(LocalDate.m243of(i, i2, i3), LocalTime.m253of(i4, i5, i6));
    }

    /* renamed from: of */
    public static LocalDateTime m247of(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        return new LocalDateTime(LocalDate.m243of(i, i2, i3), LocalTime.m254of(i4, i5, i6, i7));
    }

    /* renamed from: of */
    public static LocalDateTime m251of(LocalDate localDate, LocalTime localTime) {
    ...
    public static LocalDateTime ofInstant(Instant instant, ZoneId zoneId) {
        Jdk8Methods.requireNonNull(instant, Payload.INSTANT);
    ...
    static /* synthetic */ class C24962 {
        ...
        static {
            /*
                ...
                org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.p022bp.temporal.ChronoUnit.NANOS     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x001d }
                org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.p022bp.temporal.ChronoUnit.MICROS     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0028 }
                org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.p022bp.temporal.ChronoUnit.MILLIS     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0033 }
                org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.p022bp.temporal.ChronoUnit.SECONDS     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x003e }
                org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.p022bp.temporal.ChronoUnit.MINUTES     // Catch:{ NoSuchFieldError -> 0x003e }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r2 = 5
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                int[] r0 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0049 }
                org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.p022bp.temporal.ChronoUnit.HOURS     // Catch:{ NoSuchFieldError -> 0x0049 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
                r2 = 6
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0049 }
            L_0x0049:
                int[] r0 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0054 }
                org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.p022bp.temporal.ChronoUnit.HALF_DAYS     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.LocalDateTime.C24962.<clinit>():void");
        }
    }
    ...
    private LocalDateTime plusWithOverflow(LocalDate localDate, long j, long j2, long j3, long j4, int i) {
        ...
        long j5 = (long) i;
        long j6 = (j4 % 86400000000000L) + ((j3 % 86400) * C1844C.NANOS_PER_SECOND) + ((j2 % 1440) * 60000000000L) + ((j % 24) * 3600000000000L);
    ...
    public long until(Temporal temporal, TemporalUnit temporalUnit) {
        ...
        if (chronoUnit.isTimeBased()) {
            ...
            switch (C24962.$SwitchMap$org$threeten$bp$temporal$ChronoUnit[chronoUnit.ordinal()]) {
                case 1:
                ...
                case 3:
                    return Jdk8Methods.safeAdd(Jdk8Methods.safeMultiply(daysUntil, (long) DateUtils.MILLIS_PER_DAY), nanoOfDay / 1000000);
                case 4:
                    return Jdk8Methods.safeAdd(Jdk8Methods.safeMultiply(daysUntil, 86400), nanoOfDay / C1844C.NANOS_PER_SECOND);
                case 5:
    ...
    public OffsetDateTime atOffset(ZoneOffset zoneOffset) {
        return OffsetDateTime.m260of(this, zoneOffset);
    }

    public ZonedDateTime atZone(ZoneId zoneId) {
        return ZonedDateTime.m272of(this, zoneId);
    }
    ...
    static LocalDateTime readExternal(DataInput dataInput) throws IOException {
        return m251of(LocalDate.readExternal(dataInput), LocalTime.readExternal(dataInput));
    }
}
