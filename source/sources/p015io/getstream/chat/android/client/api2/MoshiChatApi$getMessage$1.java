...
/* renamed from: io.getstream.chat.android.client.api2.MoshiChatApi$getMessage$1 */
/* compiled from: MoshiChatApi.kt */
final class MoshiChatApi$getMessage$1 extends Lambda implements Function1<MessageResponse, Message> {
    public static final MoshiChatApi$getMessage$1 INSTANCE = new MoshiChatApi$getMessage$1();

    MoshiChatApi$getMessage$1() {
        super(1);
    }
