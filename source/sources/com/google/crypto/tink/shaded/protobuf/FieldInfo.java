...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static FieldInfo forField(Field field2, int i, FieldType fieldType, boolean z) {
        ...
        checkFieldNumber(i);
        Field field3 = field2;
        Internal.checkNotNull(field2, QuerySort.KEY_FIELD_NAME);
    ...
    static /* synthetic */ class C36191 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.FieldInfo.C36191.<clinit>():void");
        }
    }

    public Class<?> getMessageFieldClass() {
        int i = C36191.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i == 1 || i == 2) {
    ...
    public static Builder newBuilder() {
        return new Builder((C36191) null);
    }
