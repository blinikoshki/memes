...
final class TextEditFragment$setTextCapModeListeners$2 implements View.OnClickListener {
    final /* synthetic */ TextEditFragment this$0;

    TextEditFragment$setTextCapModeListeners$2(TextEditFragment textEditFragment) {
    ...
    public final void onClick(View view) {
        ...
        this.this$0.getTextEditViewModel().changeCapMode(new TextCapMode(false, view.isSelected(), false, 5, (DefaultConstructorMarker) null));
