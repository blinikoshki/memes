...
final class RemoteMemesDataSource$fetchSelfPosts$1<T, R> implements Function<Response<ApiListResponse<Post>>, UniversalResult<Post>> {
    final /* synthetic */ int $page;

    RemoteMemesDataSource$fetchSelfPosts$1(int i) {
        this.$page = i;
    }
