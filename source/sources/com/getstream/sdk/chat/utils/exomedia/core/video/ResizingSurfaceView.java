...
public class ResizingSurfaceView extends SurfaceView implements ClearableSurface {
    ...
    public void clearSurface() {
        try {
            ...
            ChatLogger.Companion.getInstance().logE((Object) TAG, "Error clearing surface", (Throwable) e);
        }
    }
    ...
    private class AttachedListener implements View.OnAttachStateChangeListener {
        ...
        public void onViewAttachedToWindow(View view) {
            ...
            ResizingSurfaceView.this.getViewTreeObserver().addOnGlobalLayoutListener(ResizingSurfaceView.this.globalLayoutMatrixListener);
