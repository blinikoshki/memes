...
class HlsChunkSource {
    ...
    private long liveEdgeInPeriodTimeUs = C1844C.TIME_UNSET;
    ...
    public boolean onPlaylistError(Uri uri, long j) {
        ...
        if (j == C1844C.TIME_UNSET || this.trackSelection.blacklist(indexOf, j)) {
            return true;
        }
        return false;
    }
    ...
    private long resolveTimeToLiveEdgeUs(long j) {
        ...
        return (j2 > C1844C.TIME_UNSET ? 1 : (j2 == C1844C.TIME_UNSET ? 0 : -1)) != 0 ? j2 - j : C1844C.TIME_UNSET;
    }
