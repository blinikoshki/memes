...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(TaskRunner taskRunner, Request request, WebSocketListener webSocketListener, Random random2, long j, WebSocketExtensions webSocketExtensions, long j2) {
        ...
        if (Intrinsics.areEqual((Object) GPHPingbackClient.HTTP_GET, (Object) request.method())) {
    ...
    public final void connect(OkHttpClient okHttpClient) {
        ...
        Request build2 = this.originalRequest.newBuilder().header(HttpHeaders.UPGRADE, "websocket").header(HttpHeaders.CONNECTION, HttpHeaders.UPGRADE).header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").header("Sec-WebSocket-Extensions", "permessage-deflate").build();
    ...
    public final synchronized boolean close(int r9, java.lang.String r10, long r11) {
        /*
            r8 = this;
            monitor-enter(r8)
            okhttp3.internal.ws.WebSocketProtocol r0 = okhttp3.internal.p021ws.WebSocketProtocol.INSTANCE     // Catch:{ all -> 0x005d }
        ...
        L_0x005d:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p021ws.RealWebSocket.close(int, java.lang.String, long):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x0127, code lost:
        if ((r0.element instanceof okhttp3.internal.p021ws.RealWebSocket.Message) == false) goto L_0x015b;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x012d, code lost:
        r0 = (okhttp3.internal.p021ws.RealWebSocket.Message) r0;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x015f, code lost:
        if ((r0.element instanceof okhttp3.internal.p021ws.RealWebSocket.Close) == false) goto L_0x01cd;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:54:0x0165, code lost:
        r0 = (okhttp3.internal.p021ws.RealWebSocket.Close) r0;
        kotlin.jvm.internal.Intrinsics.checkNotNull(r1);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:58:0x017b, code lost:
        if (((okhttp3.internal.p021ws.RealWebSocket.Streams) r1.element) == null) goto L_0x0192;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:60:0x0192, code lost:
        r1 = (okhttp3.internal.p021ws.RealWebSocket.Streams) r1.element;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:63:0x019e, code lost:
        r1 = (okhttp3.internal.p021ws.WebSocketReader) r23.element;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:66:0x01ab, code lost:
        r1 = (okhttp3.internal.p021ws.WebSocketWriter) r22.element;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:84:0x01ef, code lost:
        r1 = (okhttp3.internal.p021ws.WebSocketReader) r2.element;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:87:0x01fa, code lost:
        r1 = (okhttp3.internal.p021ws.WebSocketWriter) r3.element;
     */
    ...
    public final boolean writeOneFrame$okhttp() throws java.io.IOException {
        /*
            ...
            r12.<init>()
            r3 = r1
            okhttp3.internal.ws.RealWebSocket$Streams r3 = (okhttp3.internal.p021ws.RealWebSocket.Streams) r3
            r12.element = r3
            kotlin.jvm.internal.Ref$ObjectRef r11 = new kotlin.jvm.internal.Ref$ObjectRef
            r11.<init>()
            r3 = r1
            okhttp3.internal.ws.WebSocketReader r3 = (okhttp3.internal.p021ws.WebSocketReader) r3
            r11.element = r3
            kotlin.jvm.internal.Ref$ObjectRef r10 = new kotlin.jvm.internal.Ref$ObjectRef
            r10.<init>()
            r3 = r1
            okhttp3.internal.ws.WebSocketWriter r3 = (okhttp3.internal.p021ws.WebSocketWriter) r3
            r10.element = r3
            monitor-enter(r27)
        ...
        L_0x0042:
            ...
            boolean r3 = r3 instanceof okhttp3.internal.p021ws.RealWebSocket.Close     // Catch:{ all -> 0x0206 }
            ...
            r2 = r1
            okhttp3.internal.ws.RealWebSocket$Streams r2 = (okhttp3.internal.p021ws.RealWebSocket.Streams) r2     // Catch:{ all -> 0x0206 }
            ...
            r2 = r1
            okhttp3.internal.ws.WebSocketReader r2 = (okhttp3.internal.p021ws.WebSocketReader) r2     // Catch:{ all -> 0x0206 }
            ...
            okhttp3.internal.ws.WebSocketWriter r1 = (okhttp3.internal.p021ws.WebSocketWriter) r1     // Catch:{ all -> 0x0206 }
        ...
        L_0x008a:
            ...
            okhttp3.internal.ws.RealWebSocket$Close r1 = (okhttp3.internal.p021ws.RealWebSocket.Close) r1     // Catch:{ all -> 0x0206 }
        ...
        L_0x0121:
            ...
            boolean r2 = r2 instanceof okhttp3.internal.p021ws.RealWebSocket.Message     // Catch:{ all -> 0x01dd }
            if (r2 == 0) goto L_0x015b
            T r0 = r0.element     // Catch:{ all -> 0x01dd }
            if (r0 == 0) goto L_0x0153
            okhttp3.internal.ws.RealWebSocket$Message r0 = (okhttp3.internal.p021ws.RealWebSocket.Message) r0     // Catch:{ all -> 0x01dd }
        ...
        L_0x015b:
            T r2 = r0.element     // Catch:{ all -> 0x01dd }
            boolean r2 = r2 instanceof okhttp3.internal.p021ws.RealWebSocket.Close     // Catch:{ all -> 0x01dd }
            if (r2 == 0) goto L_0x01cd
            T r0 = r0.element     // Catch:{ all -> 0x01dd }
            if (r0 == 0) goto L_0x01bf
            okhttp3.internal.ws.RealWebSocket$Close r0 = (okhttp3.internal.p021ws.RealWebSocket.Close) r0     // Catch:{ all -> 0x01dd }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x01dd }
            ...
            okhttp3.internal.ws.RealWebSocket$Streams r0 = (okhttp3.internal.p021ws.RealWebSocket.Streams) r0     // Catch:{ all -> 0x01b9 }
        ...
        L_0x0192:
            r0 = 1
            T r1 = r1.element
            okhttp3.internal.ws.RealWebSocket$Streams r1 = (okhttp3.internal.p021ws.RealWebSocket.Streams) r1
        ...
        L_0x019e:
            r2 = r23
            T r1 = r2.element
            okhttp3.internal.ws.WebSocketReader r1 = (okhttp3.internal.p021ws.WebSocketReader) r1
        ...
        L_0x01ab:
            r3 = r22
            T r1 = r3.element
            okhttp3.internal.ws.WebSocketWriter r1 = (okhttp3.internal.p021ws.WebSocketWriter) r1
    ...
    public final void writePingFrame$okhttp() {
        ...
        L_0x005d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p021ws.RealWebSocket.writePingFrame$okhttp():void");
    }
    ...
    public final void failWebSocket(java.lang.Exception r6, okhttp3.Response r7) {
        ...
        L_0x000c:
            ...
            r1 = 0
            r2 = r1
            okhttp3.internal.ws.RealWebSocket$Streams r2 = (okhttp3.internal.p021ws.RealWebSocket.Streams) r2     // Catch:{ all -> 0x0063 }
            r5.streams = r2     // Catch:{ all -> 0x0063 }
            okhttp3.internal.ws.WebSocketReader r2 = r5.reader     // Catch:{ all -> 0x0063 }
            r3 = r1
            okhttp3.internal.ws.WebSocketReader r3 = (okhttp3.internal.p021ws.WebSocketReader) r3     // Catch:{ all -> 0x0063 }
            r5.reader = r3     // Catch:{ all -> 0x0063 }
            okhttp3.internal.ws.WebSocketWriter r3 = r5.writer     // Catch:{ all -> 0x0063 }
            okhttp3.internal.ws.WebSocketWriter r1 = (okhttp3.internal.p021ws.WebSocketWriter) r1     // Catch:{ all -> 0x0063 }
    ...
    @Metadata(mo26105bv = {1, 0, 3}, mo26106d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u000b"}, mo26107d2 = {"Lokhttp3/internal/ws/RealWebSocket$Message;", "", "formatOpcode", "", "data", "Lokio/ByteString;", "(ILokio/ByteString;)V", "getData", "()Lokio/ByteString;", "getFormatOpcode", "()I", "okhttp"}, mo26108k = 1, mo26109mv = {1, 4, 0})
    ...
    @Metadata(mo26105bv = {1, 0, 3}, mo26106d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\b\b\u0000\u0018\u00002\u00020\u0001B\u001f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0013\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, mo26107d2 = {"Lokhttp3/internal/ws/RealWebSocket$Close;", "", "code", "", "reason", "Lokio/ByteString;", "cancelAfterCloseMillis", "", "(ILokio/ByteString;J)V", "getCancelAfterCloseMillis", "()J", "getCode", "()I", "getReason", "()Lokio/ByteString;", "okhttp"}, mo26108k = 1, mo26109mv = {1, 4, 0})
    ...
    @Metadata(mo26105bv = {1, 0, 3}, mo26106d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\b\b&\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, mo26107d2 = {"Lokhttp3/internal/ws/RealWebSocket$Streams;", "Ljava/io/Closeable;", "client", "", "source", "Lokio/BufferedSource;", "sink", "Lokio/BufferedSink;", "(ZLokio/BufferedSource;Lokio/BufferedSink;)V", "getClient", "()Z", "getSink", "()Lokio/BufferedSink;", "getSource", "()Lokio/BufferedSource;", "okhttp"}, mo26108k = 1, mo26109mv = {1, 4, 0})
    ...
    @Metadata(mo26105bv = {1, 0, 3}, mo26106d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, mo26107d2 = {"Lokhttp3/internal/ws/RealWebSocket$WriterTask;", "Lokhttp3/internal/concurrent/Task;", "(Lokhttp3/internal/ws/RealWebSocket;)V", "runOnce", "", "okhttp"}, mo26108k = 1, mo26109mv = {1, 4, 0})
    ...
    @Metadata(mo26105bv = {1, 0, 3}, mo26106d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0014\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\bX\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, mo26107d2 = {"Lokhttp3/internal/ws/RealWebSocket$Companion;", "", "()V", "CANCEL_AFTER_CLOSE_MILLIS", "", "DEFAULT_MINIMUM_DEFLATE_SIZE", "MAX_QUEUE_SIZE", "ONLY_HTTP1", "", "Lokhttp3/Protocol;", "okhttp"}, mo26108k = 1, mo26109mv = {1, 4, 0})
