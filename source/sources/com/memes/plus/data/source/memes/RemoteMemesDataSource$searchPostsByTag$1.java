...
final class RemoteMemesDataSource$searchPostsByTag$1<T, R> implements Function<Response<ApiListResponse<Post>>, UniversalResult<Post>> {
    final /* synthetic */ int $page;

    RemoteMemesDataSource$searchPostsByTag$1(int i) {
        this.$page = i;
    }
