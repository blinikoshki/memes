...
/* renamed from: io.getstream.chat.android.client.ChatClient$removeShadowBan$1 */
/* compiled from: ChatClient.kt */
final class ChatClient$removeShadowBan$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final ChatClient$removeShadowBan$1 INSTANCE = new ChatClient$removeShadowBan$1();

    ChatClient$removeShadowBan$1() {
        super(1);
    }
