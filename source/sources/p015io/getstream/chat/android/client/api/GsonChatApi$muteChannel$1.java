...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$muteChannel$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$muteChannel$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final GsonChatApi$muteChannel$1 INSTANCE = new GsonChatApi$muteChannel$1();

    GsonChatApi$muteChannel$1() {
        super(1);
    }
