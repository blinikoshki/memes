...
/* renamed from: com.memes.plus.ui.create_post.ExportPostViewModel$prepareMemeForExternalSharing$$inlined$CoroutineExceptionHandler$1 */
/* compiled from: CoroutineExceptionHandler.kt */
public final class C4243xbbe1955c extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    final /* synthetic */ ExportPostViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C4243xbbe1955c(CoroutineContext.Key key, ExportPostViewModel exportPostViewModel) {
        super(key);
    ...
    public void handleException(CoroutineContext coroutineContext, Throwable th) {
        ...
        String str = "Unable to share meme.";
