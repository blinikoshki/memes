...
final class TextAdjustFragment$initScaleSlider$1 extends Lambda implements Function2<Float, Boolean, Unit> {
    final /* synthetic */ TextAdjustFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TextAdjustFragment$initScaleSlider$1(TextAdjustFragment textAdjustFragment) {
        super(2);
    ...
    public final void invoke(float f, boolean z) {
        if (z) {
            this.this$0.getViewModel().changeScale(f);
        }
    }
}
