...
public final class AnkoContextKt {
    ...
    /* renamed from: UI */
    public static final AnkoContext<Context> m231UI(Context context, Function1<? super AnkoContext<? extends Context>, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(context, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        AnkoInternals ankoInternals = AnkoInternals.INSTANCE;
    ...
    /* renamed from: UI */
    public static final AnkoContext<Fragment> m230UI(Fragment fragment, Function1<? super AnkoContext<? extends Fragment>, Unit> function1) {
