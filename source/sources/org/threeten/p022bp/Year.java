...
public final class Year extends DefaultInterfaceTemporalAccessor implements Temporal, TemporalAdjuster, Comparable<Year>, Serializable {
    ...
    public static Year now(Clock clock) {
        return m264of(LocalDate.now(clock).getYear());
    }

    /* renamed from: of */
    public static Year m264of(int i) {
    ...
    public static Year from(TemporalAccessor temporalAccessor) {
        ...
        try {
            ...
            return m264of(temporalAccessor.get(ChronoField.YEAR));
    ...
    public ValueRange range(TemporalField temporalField) {
        ...
        return ValueRange.m288of(1, this.year <= 0 ? C1844C.NANOS_PER_SECOND : 999999999);
    }
    ...
    public long getLong(TemporalField temporalField) {
        ...
        int i = C25092.$SwitchMap$org$threeten$bp$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
        int i2 = 1;
        if (i == 1) {
            int i3 = this.year;
            if (i3 < 1) {
    ...
    public Year with(TemporalField temporalField, long j) {
        ...
        int i = C25092.$SwitchMap$org$threeten$bp$temporal$ChronoField[chronoField.ordinal()];
        if (i == 1) {
            if (this.year < 1) {
                j = 1 - j;
            }
            ...
            if (i == 3) {
                return getLong(ChronoField.ERA) == j ? this : m264of(1 - this.year);
            }
            throw new UnsupportedTemporalTypeException("Unsupported field: " + temporalField);
        }
    }
    ...
    static /* synthetic */ class C25092 {
        ...
        static {
            /*
                ...
                r1 = 1
                org.threeten.bp.temporal.ChronoUnit r2 = org.threeten.p022bp.temporal.ChronoUnit.YEARS     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                r0 = 2
                int[] r2 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x001d }
                org.threeten.bp.temporal.ChronoUnit r3 = org.threeten.p022bp.temporal.ChronoUnit.DECADES     // Catch:{ NoSuchFieldError -> 0x001d }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2[r3] = r0     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                r2 = 3
                int[] r3 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0028 }
                org.threeten.bp.temporal.ChronoUnit r4 = org.threeten.p022bp.temporal.ChronoUnit.CENTURIES     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r3[r4] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r3 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0033 }
                org.threeten.bp.temporal.ChronoUnit r4 = org.threeten.p022bp.temporal.ChronoUnit.MILLENNIA     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r5 = 4
                r3[r4] = r5     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r3 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x003e }
                org.threeten.bp.temporal.ChronoUnit r4 = org.threeten.p022bp.temporal.ChronoUnit.ERAS     // Catch:{ NoSuchFieldError -> 0x003e }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r5 = 5
                r3[r4] = r5     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                org.threeten.bp.temporal.ChronoField[] r3 = org.threeten.p022bp.temporal.ChronoField.values()
                int r3 = r3.length
                int[] r3 = new int[r3]
                $SwitchMap$org$threeten$bp$temporal$ChronoField = r3
                org.threeten.bp.temporal.ChronoField r4 = org.threeten.p022bp.temporal.ChronoField.YEAR_OF_ERA     // Catch:{ NoSuchFieldError -> 0x004f }
            ...
            L_0x004f:
                ...
                org.threeten.bp.temporal.ChronoField r3 = org.threeten.p022bp.temporal.ChronoField.YEAR     // Catch:{ NoSuchFieldError -> 0x0059 }
            ...
            L_0x0059:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.ERA     // Catch:{ NoSuchFieldError -> 0x0063 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0063 }
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0063 }
            L_0x0063:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.Year.C25092.<clinit>():void");
        }
    }
    ...
    public Year plus(long j, TemporalUnit temporalUnit) {
        ...
        int i = C25092.$SwitchMap$org$threeten$bp$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()];
        if (i == 1) {
            return plusYears(j);
        }
        if (i == 2) {
    ...
    public Year plusYears(long j) {
        return j == 0 ? this : m264of(ChronoField.YEAR.checkValidIntValue(((long) this.year) + j));
    }
    ...
    public YearMonth atMonth(Month month) {
        return YearMonth.m266of(this.year, month);
    }

    public YearMonth atMonth(int i) {
        return YearMonth.m265of(this.year, i);
    }
    ...
    static Year readExternal(DataInput dataInput) throws IOException {
        return m264of(dataInput.readInt());
    }
}
