...
public final class ServerProtocol {
    ...
    public static final String getGraphUrlBase() {
        return String.format(GRAPH_URL_FORMAT, new Object[]{FacebookSdk.getGraphDomain()});
    }

    public static final String getGraphVideoUrlBase() {
        return String.format(GRAPH_VIDEO_URL_FORMAT, new Object[]{FacebookSdk.getGraphDomain()});
    }
