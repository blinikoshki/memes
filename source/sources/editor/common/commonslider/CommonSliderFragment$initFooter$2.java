...
final class CommonSliderFragment$initFooter$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ CommonSliderFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CommonSliderFragment$initFooter$2(CommonSliderFragment commonSliderFragment) {
        super(0);
