...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C2727R.C2734style.Widget_MaterialComponents_Chip_Action;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2727R.attr.chipStyle);
    }
    ...
    public Chip(android.content.Context r9, android.util.AttributeSet r10, int r11) {
        /*
            ...
            r6.setElevation(r0)
            int[] r2 = com.google.android.material.C2727R.styleable.Chip
            r7 = 0
            int[] r5 = new int[r7]
            r0 = r9
            r1 = r10
            ...
            int r11 = com.google.android.material.C2727R.styleable.Chip_android_textColor
            android.content.res.ColorStateList r9 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r9, (android.content.res.TypedArray) r10, (int) r11)
            r8.setTextColor(r9)
        L_0x0051:
            int r9 = com.google.android.material.C2727R.styleable.Chip_shapeAppearance
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2727R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = obtainStyledAttributes.getBoolean(C2727R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil((double) obtainStyledAttributes.getDimension(C2727R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil((double) ViewUtils.dpToPx(getContext(), 48))));
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i2 = C2727R.string.mtrl_chip_close_icon_content_description;
