...
public class BytesRange {
    ...
    public String toHttpRangeHeaderValue() {
        return String.format((Locale) null, "bytes=%s-%s", new Object[]{valueOrEmpty(this.from), valueOrEmpty(this.f144to)});
    }

    public boolean contains(@Nullable BytesRange bytesRange) {
        return bytesRange != null && this.from <= bytesRange.from && this.f144to >= bytesRange.f144to;
    }

    public String toString() {
        return String.format((Locale) null, "%s-%s", new Object[]{valueOrEmpty(this.from), valueOrEmpty(this.f144to)});
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.from == bytesRange.from && this.f144to == bytesRange.f144to) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return HashCodeUtil.hashCode(this.from, this.f144to);
    }
