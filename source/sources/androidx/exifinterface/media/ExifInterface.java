...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, Ascii.f579CR, 10, Ascii.SUB, 10};
    ...
    public void setAttribute(String str, String str2) {
        ...
        if ((TAG_DATETIME.equals(str4) || TAG_DATETIME_ORIGINAL.equals(str4) || TAG_DATETIME_DIGITIZED.equals(str4)) && str5 != null) {
            ...
            if (str2.length() != 19 || (!find && !find2)) {
                ...
                str5 = str5.replaceAll(CoreConfig.ENTITY_TOKEN_PREFIX, ":");
            }
        }
                ...
                if (str5 == null) {
                    ...
                    switch (i) {
                        ...
                        case 7:
                            ...
                            continue;
                        case 3:
                            String[] split = str5.split(Util.EVENT_ID_SEPARATOR, -1);
                            ...
                            continue;
                        case 4:
                            String[] split2 = str5.split(Util.EVENT_ID_SEPARATOR, -1);
                            ...
                            continue;
                        case 5:
                            String[] split3 = str5.split(Util.EVENT_ID_SEPARATOR, -1);
                            ...
                            continue;
                        case 9:
                            String[] split5 = str5.split(Util.EVENT_ID_SEPARATOR, -1);
                            ...
                            break;
                        case 10:
                            String[] split6 = str5.split(Util.EVENT_ID_SEPARATOR, -1);
                            ...
                            break;
                        case 12:
                            String[] split8 = str5.split(Util.EVENT_ID_SEPARATOR, -1);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0054, code lost:
        if (editor.editor.equipment.core.CoreConfig.ENTITY_TOKEN_PREFIX.equals(r1) != false) goto L_0x0056;
     */
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            String[] split = str.split(Util.EVENT_ID_SEPARATOR, -1);
