...
/* renamed from: io.getstream.chat.android.client.api2.MoshiChatApi$sendMessage$1 */
/* compiled from: MoshiChatApi.kt */
final class MoshiChatApi$sendMessage$1 extends Lambda implements Function1<MessageResponse, Message> {
    public static final MoshiChatApi$sendMessage$1 INSTANCE = new MoshiChatApi$sendMessage$1();

    MoshiChatApi$sendMessage$1() {
        super(1);
    }
