...
public final class ZoneOffsetTransitionRule implements Serializable {
    ...
    /* renamed from: of */
    public static ZoneOffsetTransitionRule m294of(Month month2, int i, DayOfWeek dayOfWeek, LocalTime localTime, boolean z, TimeDefinition timeDefinition2, ZoneOffset zoneOffset, ZoneOffset zoneOffset2, ZoneOffset zoneOffset3) {
        int i2 = i;
    ...
    static ZoneOffsetTransitionRule readExternal(DataInput dataInput) throws IOException {
        ...
        Month of = Month.m255of(readInt >>> 28);
        int i = ((264241152 & readInt) >>> 22) - 32;
        int i2 = (3670016 & readInt) >>> 19;
        if (i2 == 0) {
            dayOfWeek = null;
        } else {
            dayOfWeek = DayOfWeek.m241of(i2);
        }
        ...
        if (i >= -28 && i <= 31 && i != 0) {
            return new ZoneOffsetTransitionRule(of, i, dayOfWeek2, LocalTime.ofSecondOfDay((long) Jdk8Methods.floorMod(readInt2, (int) SECS_PER_DAY)), Jdk8Methods.floorDiv(readInt2, (int) SECS_PER_DAY), timeDefinition2, ofTotalSeconds, ofTotalSeconds2, ofTotalSeconds3);
        }
        throw new IllegalArgumentException("Day of month indicator must be between -28 and 31 inclusive excluding zero");
    }
    ...
    public ZoneOffsetTransition createTransition(int i) {
        ...
        if (b < 0) {
            ...
            localDate = LocalDate.m244of(i, month2, month2.length(IsoChronology.INSTANCE.isLeapYear((long) i)) + 1 + this.dom);
            DayOfWeek dayOfWeek = this.dow;
            if (dayOfWeek != null) {
                localDate = localDate.with(TemporalAdjusters.previousOrSame(dayOfWeek));
            }
        } else {
            localDate = LocalDate.m244of(i, this.month, (int) b);
            DayOfWeek dayOfWeek2 = this.dow;
            if (dayOfWeek2 != null) {
                localDate = localDate.with(TemporalAdjusters.nextOrSame(dayOfWeek2));
            }
        }
        return new ZoneOffsetTransition(this.timeDefinition.createDateTime(LocalDateTime.m251of(localDate.plusDays((long) this.adjustDays), this.time), this.standardOffset, this.offsetBefore), this.offsetBefore, this.offsetAfter);
    }
    ...
    static /* synthetic */ class C25561 {
        ...
        static final /* synthetic */ int[] f499x9c587b4d;
        ...
        static {
            /*
                org.threeten.bp.zone.ZoneOffsetTransitionRule$TimeDefinition[] r0 = org.threeten.p022bp.zone.ZoneOffsetTransitionRule.TimeDefinition.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f499x9c587b4d = r0
                org.threeten.bp.zone.ZoneOffsetTransitionRule$TimeDefinition r1 = org.threeten.p022bp.zone.ZoneOffsetTransitionRule.TimeDefinition.UTC     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = f499x9c587b4d     // Catch:{ NoSuchFieldError -> 0x001d }
                org.threeten.bp.zone.ZoneOffsetTransitionRule$TimeDefinition r1 = org.threeten.p022bp.zone.ZoneOffsetTransitionRule.TimeDefinition.STANDARD     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.zone.ZoneOffsetTransitionRule.C25561.<clinit>():void");
        }
    }
    ...
    public enum TimeDefinition {
        ...
        public LocalDateTime createDateTime(LocalDateTime localDateTime, ZoneOffset zoneOffset, ZoneOffset zoneOffset2) {
            int i = C25561.f499x9c587b4d[ordinal()];
            if (i == 1) {
