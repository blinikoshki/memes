...
public class ConstraintReference implements Reference {
    ...
    static /* synthetic */ class C02091 {
        ...
        static {
            ...
            L_0x00b4:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.state.ConstraintReference.C02091.<clinit>():void");
        }
    }

    public ConstraintReference margin(int i) {
        if (this.mLast != null) {
            switch (C02091.f32x7d4bfe12[this.mLast.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeft = i;
                    break;
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        if (target != null) {
            int i = C02091.f32x7d4bfe12[constraint.ordinal()];
            switch (C02091.f32x7d4bfe12[constraint.ordinal()]) {
                case 1:
