...
@DebugMetadata(mo26807c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", mo26808f = "Limit.kt", mo26809i = {0, 0, 0}, mo26810l = {154}, mo26811m = "invokeSuspend", mo26812n = {"$this$flow", "$this$collectWhile$iv", "collector$iv"}, mo26813s = {"L$0", "L$1", "L$2"})
...
final class FlowKt__LimitKt$transformWhile$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__LimitKt$transformWhile$1.f406p$ = (FlowCollector) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        C2261xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            FlowCollector flowCollector = this.f406p$;
            Flow flow = this.$this_transformWhile;
            C2261xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$12 = new C2261xdf1aa1b6(this, flowCollector);
            try {
            ...
            flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 = (C2261xdf1aa1b6) this.L$2;
