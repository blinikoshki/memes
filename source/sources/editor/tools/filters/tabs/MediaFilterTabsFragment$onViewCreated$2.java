...
final class MediaFilterTabsFragment$onViewCreated$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ MediaFilterTabsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MediaFilterTabsFragment$onViewCreated$2(MediaFilterTabsFragment mediaFilterTabsFragment) {
        super(0);
