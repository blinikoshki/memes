...
public final class NalUnitUtil {
    ...
    public static void discardToSps(ByteBuffer byteBuffer) {
        ...
        while (true) {
            ...
            if (i3 < position) {
                ...
                if (i2 == 3) {
                    if (b == 1 && (byteBuffer.get(i3) & Ascii.f591US) == 7) {
    ...
    public static boolean isNalUnitSei(String str, byte b) {
        if (MimeTypes.VIDEO_H264.equals(str) && (b & Ascii.f591US) == 6) {
            return true;
        }
    ...
    public static com.google.android.exoplayer2.util.NalUnitUtil.SpsData parseSpsNalUnit(byte[] r21, int r22, int r23) {
        ...
        L_0x0152:
            ...
            com.google.android.exoplayer2.util.Log.m358w(r2, r0)
        L_0x016a:
