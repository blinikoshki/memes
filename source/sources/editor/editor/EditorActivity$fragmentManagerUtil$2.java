...
final class EditorActivity$fragmentManagerUtil$2 extends Lambda implements Function0<FragmentManagerUtil> {
    final /* synthetic */ EditorActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EditorActivity$fragmentManagerUtil$2(EditorActivity editorActivity) {
        super(0);
        this.this$0 = editorActivity;
    }

    public final FragmentManagerUtil invoke() {
        FragmentContainerView fragmentContainerView = EditorActivity.access$getBinding$p(this.this$0).fragmentContainer;
