...
final class TextTabsFragment$onViewCreated$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ TextTabsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TextTabsFragment$onViewCreated$1(TextTabsFragment textTabsFragment) {
        super(0);
