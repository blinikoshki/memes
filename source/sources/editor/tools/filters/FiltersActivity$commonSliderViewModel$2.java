...
final class FiltersActivity$commonSliderViewModel$2 extends Lambda implements Function0<CommonSliderViewModel> {
    final /* synthetic */ FiltersActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FiltersActivity$commonSliderViewModel$2(FiltersActivity filtersActivity) {
        super(0);
    ...
    public final CommonSliderViewModel invoke() {
        ...
        Function0 function0 = C49151.INSTANCE;
        if (function0 == null) {
            viewModel = ViewModelProviders.m17of((FragmentActivity) filtersActivity).get(CommonSliderViewModel.class);
            Intrinsics.checkNotNullExpressionValue(viewModel, "ViewModelProviders.of(this).get(T::class.java)");
        } else {
            viewModel = ViewModelProviders.m18of((FragmentActivity) filtersActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(function0)).get(CommonSliderViewModel.class);
