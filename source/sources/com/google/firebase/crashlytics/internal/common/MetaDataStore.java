    ...
    public void writeUserData(String str, UserMetadata userMetadata) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Logger.getLogger().mo53732e("Error serializing user metadata.", e);
    ...
    public UserMetadata readUserData(String str) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Logger.getLogger().mo53732e("Error deserializing user metadata.", e);
    ...
    public void writeKeyData(String str, Map<String, String> map) {
        ...
        try {
            ...
            try {
                ...
                bufferedWriter = bufferedWriter2;
                try {
                    Logger.getLogger().mo53732e("Error serializing key/value metadata.", e);
