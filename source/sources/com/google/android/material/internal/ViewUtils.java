...
public class ViewUtils {
    ...
    public static class RelativePadding {
        ...
        public RelativePadding(RelativePadding relativePadding) {
            ...
            this.f1509top = relativePadding.f1509top;
            this.end = relativePadding.end;
            this.bottom = relativePadding.bottom;
        }

        public void applyToView(View view) {
            ViewCompat.setPaddingRelative(view, this.start, this.f1509top, this.end, this.bottom);
        }
    }
    ...
    public static void doOnApplyWindowInsets(View view, AttributeSet attributeSet, int i, int i2, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        TypedArray obtainStyledAttributes = view.getContext().obtainStyledAttributes(attributeSet, C2727R.styleable.Insets, i, i2);
        final boolean z = obtainStyledAttributes.getBoolean(C2727R.styleable.Insets_paddingBottomSystemWindowInsets, false);
        final boolean z2 = obtainStyledAttributes.getBoolean(C2727R.styleable.Insets_paddingLeftSystemWindowInsets, false);
        final boolean z3 = obtainStyledAttributes.getBoolean(C2727R.styleable.Insets_paddingRightSystemWindowInsets, false);
