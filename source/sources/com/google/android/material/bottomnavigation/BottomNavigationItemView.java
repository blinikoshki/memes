...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C2727R.C2733layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C2727R.C2730drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C2727R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C2727R.C2731id.icon);
        TextView textView = (TextView) findViewById(C2727R.C2731id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C2727R.C2731id.largeLabel);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        wrap.setRoleDescription(getResources().getString(C2727R.string.item_view_role_description));
    }
