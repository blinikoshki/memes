...
final class SavedWatermarksViewModel$portUtil$2 extends Lambda implements Function0<ContentPortUtil> {
    final /* synthetic */ OutputTargetGenerator $outputTargetGenerator;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SavedWatermarksViewModel$portUtil$2(OutputTargetGenerator outputTargetGenerator) {
        super(0);
