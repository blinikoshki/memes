...
public class ColorKeyframeAnimation extends KeyframeAnimation<Integer> {
    ...
    public Integer getValue(Keyframe<Integer> keyframe, float f) {
        ...
        return (Integer) this.valueCallback.getValueInternal(keyframe.startFrame, keyframe.endFrame.floatValue(), Integer.valueOf(intValue), Integer.valueOf(intValue2), f, getLinearCurrentKeyframeProgress(), getProgress());
    }
}
