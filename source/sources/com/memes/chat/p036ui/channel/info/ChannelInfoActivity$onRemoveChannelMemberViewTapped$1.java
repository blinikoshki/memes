...
/* renamed from: com.memes.chat.ui.channel.info.ChannelInfoActivity$onRemoveChannelMemberViewTapped$1 */
/* compiled from: ChannelInfoActivity.kt */
final class ChannelInfoActivity$onRemoveChannelMemberViewTapped$1 implements DialogInterface.OnClickListener {
    final /* synthetic */ Member $channelMember;
    final /* synthetic */ ChannelInfoActivity this$0;

    ChannelInfoActivity$onRemoveChannelMemberViewTapped$1(ChannelInfoActivity channelInfoActivity, Member member) {
        this.this$0 = channelInfoActivity;
        this.$channelMember = member;
    }

    public final void onClick(DialogInterface dialogInterface, int i) {
        this.this$0.getChannelInfoViewModel().removeChannelMember(this.$channelMember);
    }
}
