...
public final class FlowableDelay<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class DelaySubscriber<T> implements FlowableSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            this.f239w.schedule(new OnNext(t), this.delay, this.unit);
        }

        public void onError(Throwable th) {
            this.f239w.schedule(new OnError(th), this.delayError ? this.delay : 0, this.unit);
        }

        public void onComplete() {
            this.f239w.schedule(new OnComplete(), this.delay, this.unit);
        }
        ...
        final class OnNext implements Runnable {
            ...
            public void run() {
                DelaySubscriber.this.downstream.onNext(this.f241t);
            }
        }
        ...
        final class OnError implements Runnable {
            ...
            public void run() {
                try {
                    DelaySubscriber.this.downstream.onError(this.f240t);
                } finally {
                    DelaySubscriber.this.f239w.dispose();
                }
            }
        }
