...
public class CountingMemoryCacheInspector<K, V> {
    ...
    public DumpInfo dumpCacheContent() {
        ...
        synchronized (this.mCountingBitmapCache) {
            ...
            for (Map.Entry<K, CountingMemoryCache.Entry<K, V>> value : this.mCountingBitmapCache.mCachedEntries.getMatchingEntries((Predicate) null)) {
            ...
            for (Map.Entry next : this.mCountingBitmapCache.mOtherEntries.entrySet()) {
