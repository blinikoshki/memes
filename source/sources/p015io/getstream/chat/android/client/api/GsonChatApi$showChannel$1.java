...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$showChannel$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$showChannel$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final GsonChatApi$showChannel$1 INSTANCE = new GsonChatApi$showChannel$1();

    GsonChatApi$showChannel$1() {
        super(1);
    }
