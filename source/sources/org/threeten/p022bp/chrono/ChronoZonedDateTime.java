...
public abstract class ChronoZonedDateTime<D extends ChronoLocalDate> extends DefaultInterfaceTemporal implements Temporal, Comparable<ChronoZonedDateTime<?>> {
    ...
    static /* synthetic */ class C25222 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.ChronoZonedDateTime.C25222.<clinit>():void");
        }
    }
    ...
    public int get(TemporalField temporalField) {
        ...
        int i = C25222.$SwitchMap$org$threeten$bp$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
        if (i == 1) {
    ...
    public int compareTo(org.threeten.p022bp.chrono.ChronoZonedDateTime<?> r5) {
        /*
            r4 = this;
            ...
            int r0 = r0.compareTo((org.threeten.p022bp.chrono.ChronoLocalDateTime<?>) r1)
            if (r0 != 0) goto L_0x0059
            ...
            int r0 = r0.compareTo((org.threeten.p022bp.chrono.Chronology) r5)
        L_0x0059:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.ChronoZonedDateTime.compareTo(org.threeten.bp.chrono.ChronoZonedDateTime):int");
    }
