...
final class ChronoZonedDateTimeImpl<D extends ChronoLocalDate> extends ChronoZonedDateTime<D> implements Serializable {
    ...
    public ChronoZonedDateTime<D> with(TemporalField temporalField, long j) {
        ...
        int i = C25231.$SwitchMap$org$threeten$bp$temporal$ChronoField[chronoField.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C25231 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.ChronoZonedDateTimeImpl.C25231.<clinit>():void");
        }
    }
    ...
    private Object writeReplace() {
        return new Ser(Ascii.f579CR, this);
    }
