...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$acceptInvite$2 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$acceptInvite$2 extends Lambda implements Function1<ChannelResponse, Channel> {
    final /* synthetic */ GsonChatApi this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GsonChatApi$acceptInvite$2(GsonChatApi gsonChatApi) {
        super(1);
