...
final class EditorActivity$wireframesViewModel$2 extends Lambda implements Function0<WireframesViewModel> {
    final /* synthetic */ EditorActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EditorActivity$wireframesViewModel$2(EditorActivity editorActivity) {
        super(0);
    ...
    public final WireframesViewModel invoke() {
        ...
        Function0 function0 = C46871.INSTANCE;
        if (function0 == null) {
            viewModel = ViewModelProviders.m17of((FragmentActivity) editorActivity).get(WireframesViewModel.class);
            Intrinsics.checkNotNullExpressionValue(viewModel, "ViewModelProviders.of(this).get(T::class.java)");
        } else {
            viewModel = ViewModelProviders.m18of((FragmentActivity) editorActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(function0)).get(WireframesViewModel.class);
