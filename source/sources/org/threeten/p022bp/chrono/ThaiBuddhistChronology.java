...
public final class ThaiBuddhistChronology extends Chronology implements Serializable {
    ...
    public ThaiBuddhistDate date(int i, int i2, int i3) {
        return new ThaiBuddhistDate(LocalDate.m243of(i - 543, i2, i3));
    }
    ...
    public ThaiBuddhistEra eraOf(int i) {
        return ThaiBuddhistEra.m286of(i);
    }
    ...
    static /* synthetic */ class C25311 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.ThaiBuddhistChronology.C25311.<clinit>():void");
        }
    }

    public ValueRange range(ChronoField chronoField) {
        int i = C25311.$SwitchMap$org$threeten$bp$temporal$ChronoField[chronoField.ordinal()];
        if (i == 1) {
            ValueRange range = ChronoField.PROLEPTIC_MONTH.range();
            return ValueRange.m288of(range.getMinimum() + 6516, range.getMaximum() + 6516);
        } else if (i == 2) {
            ValueRange range2 = ChronoField.YEAR.range();
            return ValueRange.m289of(1, 1 + (-(range2.getMinimum() + 543)), range2.getMaximum() + 543);
        } else if (i != 3) {
            return chronoField.range();
        } else {
            ValueRange range3 = ChronoField.YEAR.range();
            return ValueRange.m288of(range3.getMinimum() + 543, range3.getMaximum() + 543);
        }
    }
