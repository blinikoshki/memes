...
final class TextAdjustFragment$onViewCreated$3<T> implements Observer<Float> {
    final /* synthetic */ TextAdjustFragment this$0;

    TextAdjustFragment$onViewCreated$3(TextAdjustFragment textAdjustFragment) {
        this.this$0 = textAdjustFragment;
    }

    public final void onChanged(Float f) {
        ValueSlider valueSlider = TextAdjustFragment.access$getBinding$p(this.this$0).rotationSlider;
