...
final class ChannelUtils$getLastMessageReads$1<T> implements Comparator<ChannelUserRead> {
    public static final ChannelUtils$getLastMessageReads$1 INSTANCE = new ChannelUtils$getLastMessageReads$1();

    ChannelUtils$getLastMessageReads$1() {
    }
