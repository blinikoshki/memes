...
final class Ed25519 {
    ...
    /* renamed from: eq */
    private static int m577eq(int i, int i2) {
        int i3 = (~(i ^ i2)) & 255;
        int i4 = i3 & (i3 << 4);
        int i5 = i4 & (i4 << 2);
        return ((i5 & (i5 << 1)) >> 7) & 1;
    ...
    private static class XYZ {
        ...
        XYZ(XYZ xyz) {
            this.f756x = Arrays.copyOf(xyz.f756x, 10);
            this.f757y = Arrays.copyOf(xyz.f757y, 10);
            this.f758z = Arrays.copyOf(xyz.f758z, 10);
        }
        ...
        static XYZ fromPartialXYZT(XYZ xyz, PartialXYZT partialXYZT) {
            Field25519.mult(xyz.f756x, partialXYZT.xyz.f756x, partialXYZT.f755t);
            Field25519.mult(xyz.f757y, partialXYZT.xyz.f757y, partialXYZT.xyz.f758z);
            Field25519.mult(xyz.f758z, partialXYZT.xyz.f758z, partialXYZT.f755t);
            return xyz;
        }
        ...
        public byte[] toBytes() {
            ...
            Field25519.inverse(jArr, this.f758z);
            Field25519.mult(jArr2, this.f756x, jArr);
            Field25519.mult(jArr3, this.f757y, jArr);
        ...
        public boolean isOnCurve() {
            long[] jArr = new long[10];
            Field25519.square(jArr, this.f756x);
            long[] jArr2 = new long[10];
            Field25519.square(jArr2, this.f757y);
            long[] jArr3 = new long[10];
            Field25519.square(jArr3, this.f758z);
            ...
            Field25519.mult(jArr6, jArr6, Ed25519Constants.f761D);
    ...
    private static class XYZT {
        ...
        public static XYZT fromPartialXYZT(XYZT xyzt, PartialXYZT partialXYZT) {
            Field25519.mult(xyzt.xyz.f756x, partialXYZT.xyz.f756x, partialXYZT.f755t);
            Field25519.mult(xyzt.xyz.f757y, partialXYZT.xyz.f757y, partialXYZT.xyz.f758z);
            Field25519.mult(xyzt.xyz.f758z, partialXYZT.xyz.f758z, partialXYZT.f755t);
            Field25519.mult(xyzt.f759t, partialXYZT.xyz.f756x, partialXYZT.xyz.f757y);
            return xyzt;
        }
        ...
        public static XYZT fromBytesNegateVarTime(byte[] bArr) throws GeneralSecurityException {
            ...
            Field25519.mult(jArr5, jArr4, Ed25519Constants.f761D);
    ...
    private static class PartialXYZT {
        ...
        PartialXYZT(PartialXYZT partialXYZT) {
            ...
            this.f755t = Arrays.copyOf(partialXYZT.f755t, 10);
        }
    }
    ...
    private static class CachedXYZT extends CachedXYT {
        ...
        CachedXYZT(XYZT xyzt) {
            this();
            Field25519.sum(this.yPlusX, xyzt.xyz.f757y, xyzt.xyz.f756x);
            Field25519.sub(this.yMinusX, xyzt.xyz.f757y, xyzt.xyz.f756x);
            System.arraycopy(xyzt.xyz.f758z, 0, this.f754z, 0, 10);
            Field25519.mult(this.t2d, xyzt.f759t, Ed25519Constants.f762D2);
        }
        ...
        public void multByZ(long[] jArr, long[] jArr2) {
            Field25519.mult(jArr, jArr2, this.f754z);
        }
    }

    private static void add(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        long[] jArr = new long[10];
        Field25519.sum(partialXYZT.xyz.f756x, xyzt.xyz.f757y, xyzt.xyz.f756x);
        Field25519.sub(partialXYZT.xyz.f757y, xyzt.xyz.f757y, xyzt.xyz.f756x);
        Field25519.mult(partialXYZT.xyz.f757y, partialXYZT.xyz.f757y, cachedXYT.yMinusX);
        Field25519.mult(partialXYZT.xyz.f758z, partialXYZT.xyz.f756x, cachedXYT.yPlusX);
        Field25519.mult(partialXYZT.f755t, xyzt.f759t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f756x, xyzt.xyz.f758z);
        Field25519.sum(jArr, partialXYZT.xyz.f756x, partialXYZT.xyz.f756x);
        Field25519.sub(partialXYZT.xyz.f756x, partialXYZT.xyz.f758z, partialXYZT.xyz.f757y);
        Field25519.sum(partialXYZT.xyz.f757y, partialXYZT.xyz.f758z, partialXYZT.xyz.f757y);
        Field25519.sum(partialXYZT.xyz.f758z, jArr, partialXYZT.f755t);
        Field25519.sub(partialXYZT.f755t, jArr, partialXYZT.f755t);
    }
    ...
    private static void sub(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        ...
        Field25519.sum(partialXYZT.xyz.f756x, xyzt.xyz.f757y, xyzt.xyz.f756x);
        Field25519.sub(partialXYZT.xyz.f757y, xyzt.xyz.f757y, xyzt.xyz.f756x);
        Field25519.mult(partialXYZT.xyz.f757y, partialXYZT.xyz.f757y, cachedXYT.yPlusX);
        Field25519.mult(partialXYZT.xyz.f758z, partialXYZT.xyz.f756x, cachedXYT.yMinusX);
        Field25519.mult(partialXYZT.f755t, xyzt.f759t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f756x, xyzt.xyz.f758z);
        Field25519.sum(jArr, partialXYZT.xyz.f756x, partialXYZT.xyz.f756x);
        Field25519.sub(partialXYZT.xyz.f756x, partialXYZT.xyz.f758z, partialXYZT.xyz.f757y);
        Field25519.sum(partialXYZT.xyz.f757y, partialXYZT.xyz.f758z, partialXYZT.xyz.f757y);
        Field25519.sub(partialXYZT.xyz.f758z, jArr, partialXYZT.f755t);
        Field25519.sum(partialXYZT.f755t, jArr, partialXYZT.f755t);
    }

    private static void doubleXYZ(PartialXYZT partialXYZT, XYZ xyz) {
        long[] jArr = new long[10];
        Field25519.square(partialXYZT.xyz.f756x, xyz.f756x);
        Field25519.square(partialXYZT.xyz.f758z, xyz.f757y);
        Field25519.square(partialXYZT.f755t, xyz.f758z);
        Field25519.sum(partialXYZT.f755t, partialXYZT.f755t, partialXYZT.f755t);
        Field25519.sum(partialXYZT.xyz.f757y, xyz.f756x, xyz.f757y);
        Field25519.square(jArr, partialXYZT.xyz.f757y);
        Field25519.sum(partialXYZT.xyz.f757y, partialXYZT.xyz.f758z, partialXYZT.xyz.f756x);
        Field25519.sub(partialXYZT.xyz.f758z, partialXYZT.xyz.f758z, partialXYZT.xyz.f756x);
        Field25519.sub(partialXYZT.xyz.f756x, jArr, partialXYZT.xyz.f757y);
        Field25519.sub(partialXYZT.f755t, partialXYZT.f755t, partialXYZT.xyz.f758z);
    }
    ...
    private static void select(CachedXYT cachedXYT, int i, byte b) {
        int i2 = (b & 255) >> 7;
        int i3 = b - (((-i2) & b) << 1);
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][0], m577eq(i3, 1));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][1], m577eq(i3, 2));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][2], m577eq(i3, 3));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][3], m577eq(i3, 4));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][4], m577eq(i3, 5));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][5], m577eq(i3, 6));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][6], m577eq(i3, 7));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][7], m577eq(i3, 8));
    ...
    private static XYZ doubleScalarMultVarTime(byte[] bArr, XYZT xyzt, byte[] bArr2) {
        ...
        while (i2 >= 0) {
            ...
            if (slide2[i2] > 0) {
                add(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f760B2[slide2[i2] / 2]);
            } else if (slide2[i2] < 0) {
                sub(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f760B2[(-slide2[i2]) / 2]);
            }
            i2--;
        }
