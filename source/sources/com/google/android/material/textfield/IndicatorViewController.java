...
final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = (float) context2.getResources().getDimensionPixelSize(C2727R.dimen.design_textinput_caption_translate_y);
    }
    ...
    public void setErrorEnabled(boolean z) {
        if (this.errorEnabled != z) {
            ...
            if (z) {
                ...
                appCompatTextView.setId(C2727R.C2731id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        if (this.helperTextEnabled != z) {
            ...
            if (z) {
                ...
                appCompatTextView.setId(C2727R.C2731id.textinput_helper_text);
                if (Build.VERSION.SDK_INT >= 17) {
