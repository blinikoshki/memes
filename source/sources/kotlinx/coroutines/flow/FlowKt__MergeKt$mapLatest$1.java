...
@DebugMetadata(mo26807c = "kotlinx.coroutines.flow.FlowKt__MergeKt$mapLatest$1", mo26808f = "Merge.kt", mo26809i = {0, 0, 1, 1}, mo26810l = {214, 214}, mo26811m = "invokeSuspend", mo26812n = {"$this$transformLatest", "it", "$this$transformLatest", "it"}, mo26813s = {"L$0", "L$1", "L$0", "L$1"})
...
final class FlowKt__MergeKt$mapLatest$1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
        ...
        flowKt__MergeKt$mapLatest$1.f408p$ = flowCollector;
