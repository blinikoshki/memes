...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public LottieDrawable() {
        ...
        this.alpha = 255;
        lottieValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
    ...
    public void setColorFilter(ColorFilter colorFilter) {
        Log.w(C0947L.TAG, "Use addColorFilter instead.");
    }

    public void draw(Canvas canvas) {
        float f;
        C0947L.beginSection("Drawable#draw");
        if (this.compositionLayer != null) {
            ...
            C0947L.endSection("Drawable#draw");
            if (i > 0) {
                canvas.restore();
            }
        }
    ...
    public List<KeyPath> resolveKeyPath(KeyPath keyPath) {
        if (this.compositionLayer == null) {
            Log.w(C0947L.TAG, "Cannot resolve KeyPath. Composition is not set yet.");
    ...
    public Bitmap updateBitmap(String str, Bitmap bitmap) {
        ...
        if (imageAssetManager2 == null) {
            Log.w(C0947L.TAG, "Cannot update bitmap. Most likely the drawable is not added to a View which prevents Lottie from getting a Context.");
            return null;
        }
