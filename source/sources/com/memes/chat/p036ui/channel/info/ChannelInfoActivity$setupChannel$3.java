...
/* renamed from: com.memes.chat.ui.channel.info.ChannelInfoActivity$setupChannel$3 */
/* compiled from: ChannelInfoActivity.kt */
final class ChannelInfoActivity$setupChannel$3<T> implements Observer<ContentVisibilityAction> {
    final /* synthetic */ ChannelInfoActivity this$0;

    ChannelInfoActivity$setupChannel$3(ChannelInfoActivity channelInfoActivity) {
        this.this$0 = channelInfoActivity;
    }

    public final void onChanged(ContentVisibilityAction contentVisibilityAction) {
        ContentLayout contentLayout = this.this$0.getBinding().channelInfoContentLayout;
