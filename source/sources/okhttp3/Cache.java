...
public final class Cache implements Closeable, Flushable {
    ...
    public final CacheRequest put$okhttp(Response response) {
        ...
        if (HttpMethod.INSTANCE.invalidatesCache(response.request().method())) {
            ...
            return null;
        } else if (!Intrinsics.areEqual((Object) method, (Object) GPHPingbackClient.HTTP_GET)) {
            return null;
        } else {
    ...
    public final void update$okhttp(Response response, Response response2) {
        ...
        Intrinsics.checkNotNullParameter(response2, ServerParameters.NETWORK);
    ...
    private final void abortQuietly(DiskLruCache.Editor editor2) {
        if (editor2 != null) {
            try {
                editor2.abort();
            } catch (IOException unused) {
    ...
    public final File m2422deprecated_directory() {
        return this.cache.getDirectory();
    }
    ...
    @Metadata(mo26105bv = {1, 0, 3}, mo26106d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u0011\u0012\n\u0010\u0002\u001a\u00060\u0003R\u00020\u0004¢\u0006\u0002\u0010\u0005J\b\u0010\u000f\u001a\u00020\u0010H\u0016J\b\u0010\u0006\u001a\u00020\u0007H\u0016R\u000e\u0010\u0006\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\t\u001a\u00020\nX\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000eR\u0012\u0010\u0002\u001a\u00060\u0003R\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0011"}, mo26107d2 = {"Lokhttp3/Cache$RealCacheRequest;", "Lokhttp3/internal/cache/CacheRequest;", "editor", "Lokhttp3/internal/cache/DiskLruCache$Editor;", "Lokhttp3/internal/cache/DiskLruCache;", "(Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$Editor;)V", "body", "Lokio/Sink;", "cacheOut", "done", "", "getDone", "()Z", "setDone", "(Z)V", "abort", "", "okhttp"}, mo26108k = 1, mo26109mv = {1, 4, 0})
    /* compiled from: Cache.kt */
                ...
                public void close() throws IOException {
                    synchronized (this.this$0.this$0) {
                        if (!this.this$0.getDone()) {
                            ...
                            super.close();
                            this.this$0.f1504editor.commit();
                        }
                    }
                }
            };
    ...
    private static final class Entry {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x011c, code lost:
            kotlin.p017io.CloseableKt.closeFinally(r10, r0);
         */
        ...
        public final void writeTo(okhttp3.internal.cache.DiskLruCache.Editor r10) throws java.io.IOException {
            ...
            L_0x0113:
                ...
                kotlin.p017io.CloseableKt.closeFinally(r10, r1)
                return
            L_0x0119:
                r0 = move-exception
        ...
        @Metadata(mo26105bv = {1, 0, 3}, mo26106d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, mo26107d2 = {"Lokhttp3/Cache$Entry$Companion;", "", "()V", "RECEIVED_MILLIS", "", "SENT_MILLIS", "okhttp"}, mo26108k = 1, mo26109mv = {1, 4, 0})
        /* compiled from: Cache.kt */
