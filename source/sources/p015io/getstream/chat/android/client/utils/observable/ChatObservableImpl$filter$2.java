...
/* renamed from: io.getstream.chat.android.client.utils.observable.ChatObservableImpl$filter$2 */
/* compiled from: ChatObservableImpl.kt */
final class ChatObservableImpl$filter$2 extends Lambda implements Function1<ChatEvent, Boolean> {
    final /* synthetic */ Class[] $types;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChatObservableImpl$filter$2(Class[] clsArr) {
        super(1);
        this.$types = clsArr;
    }
