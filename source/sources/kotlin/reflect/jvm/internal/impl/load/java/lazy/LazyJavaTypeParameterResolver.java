...
public final class LazyJavaTypeParameterResolver implements TypeParameterResolver {
    ...
    /* renamed from: c */
    public final LazyJavaResolverContext f339c;
    /* access modifiers changed from: private */
    ...
    public LazyJavaTypeParameterResolver(LazyJavaResolverContext lazyJavaResolverContext, DeclarationDescriptor declarationDescriptor, JavaTypeParameterListOwner javaTypeParameterListOwner, int i) {
        ...
        this.f339c = lazyJavaResolverContext;
    ...
    public TypeParameterDescriptor resolveTypeParameter(JavaTypeParameter javaTypeParameter) {
        ...
        return invoke == null ? this.f339c.getTypeParameterResolver().resolveTypeParameter(javaTypeParameter) : invoke;
    }
}
