...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$stopWatching$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$stopWatching$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final GsonChatApi$stopWatching$1 INSTANCE = new GsonChatApi$stopWatching$1();

    GsonChatApi$stopWatching$1() {
        super(1);
    }
