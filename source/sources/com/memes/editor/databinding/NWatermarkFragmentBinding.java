...
public final class NWatermarkFragmentBinding implements ViewBinding {
    ...
    private NWatermarkFragmentBinding(LinearLayout linearLayout, CloseOnlyFooter closeOnlyFooter, AppCompatImageView appCompatImageView, AppCompatImageView appCompatImageView2, AppCompatImageView appCompatImageView3, SwitchCompat switchCompat, AppCompatImageView appCompatImageView4) {
    ...
    public static NWatermarkFragmentBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C4175R.C4181layout.n_watermark_fragment, viewGroup, false);
        if (z) {
                    ...
                    if (appCompatImageView3 != null) {
                        ...
                        if (switchCompat != null) {
                            ...
                            if (appCompatImageView4 != null) {
                                return new NWatermarkFragmentBinding((LinearLayout) view, closeOnlyFooter, appCompatImageView, appCompatImageView2, appCompatImageView3, switchCompat, appCompatImageView4);
                            }
                        }
                    }
                }
