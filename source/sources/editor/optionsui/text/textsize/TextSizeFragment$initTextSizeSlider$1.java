...
final class TextSizeFragment$initTextSizeSlider$1 extends Lambda implements Function2<Float, Boolean, Unit> {
    final /* synthetic */ TextSizeFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TextSizeFragment$initTextSizeSlider$1(TextSizeFragment textSizeFragment) {
        super(2);
    ...
    public final void invoke(float f, boolean z) {
        if (z) {
            this.this$0.getTextSizeViewModel().changeTextSize(f);
        }
    }
}
