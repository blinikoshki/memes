...
/* renamed from: com.memes.chat.ui.channel.info.ChannelInfoViewModel$channelMutingUseCase$2 */
/* compiled from: ChannelInfoViewModel.kt */
final class ChannelInfoViewModel$channelMutingUseCase$2 extends Lambda implements Function0<ChannelMutingUseCase> {
    final /* synthetic */ ChannelInfoViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChannelInfoViewModel$channelMutingUseCase$2(ChannelInfoViewModel channelInfoViewModel) {
        super(0);
