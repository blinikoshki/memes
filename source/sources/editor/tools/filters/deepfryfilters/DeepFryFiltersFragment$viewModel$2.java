...
final class DeepFryFiltersFragment$viewModel$2 extends Lambda implements Function0<DeepFryFiltersViewModel> {
    final /* synthetic */ DeepFryFiltersFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DeepFryFiltersFragment$viewModel$2(DeepFryFiltersFragment deepFryFiltersFragment) {
        super(0);
    ...
    public final DeepFryFiltersViewModel invoke() {
        ...
        Function0 function0 = C49271.INSTANCE;
        if (function0 == null) {
            viewModel = ViewModelProviders.m17of(requireActivity).get(DeepFryFiltersViewModel.class);
            Intrinsics.checkNotNullExpressionValue(viewModel, "ViewModelProviders.of(this).get(T::class.java)");
        } else {
            viewModel = ViewModelProviders.m18of(requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(function0)).get(DeepFryFiltersViewModel.class);
