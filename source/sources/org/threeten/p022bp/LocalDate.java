...
import org.threeten.p022bp.zone.ZoneOffsetTransition;
...
public final class LocalDate extends ChronoLocalDate implements Temporal, TemporalAdjuster, Serializable {
    ...
    public static final LocalDate MAX = m243of((int) Year.MAX_VALUE, 12, 31);
    public static final LocalDate MIN = m243of((int) Year.MIN_VALUE, 1, 1);
    ...
    /* renamed from: of */
    public static LocalDate m244of(int i, Month month2, int i2) {
    ...
    public static LocalDate ofYearDay(int i, int i2) {
        ...
        if (i2 != 366 || isLeapYear) {
            Month of = Month.m255of(((i2 - 1) / 31) + 1);
    ...
    private static LocalDate create(int i, Month month2, int i2) {
        ...
        throw new DateTimeException("Invalid date '" + month2.name() + StringUtils.SPACE + i2 + "'");
    }
    ...
    public ValueRange range(TemporalField temporalField) {
        ...
        if (chronoField.isDateBased()) {
            int i = C24942.$SwitchMap$org$threeten$bp$temporal$ChronoField[chronoField.ordinal()];
            if (i == 1) {
                return ValueRange.m288of(1, (long) lengthOfMonth());
            }
            if (i == 2) {
                return ValueRange.m288of(1, (long) lengthOfYear());
            }
            if (i == 3) {
                return ValueRange.m288of(1, (getMonth() != Month.FEBRUARY || isLeapYear()) ? 5 : 4);
            } else if (i != 4) {
                return temporalField.range();
            } else {
                return ValueRange.m288of(1, getYear() <= 0 ? C1844C.NANOS_PER_SECOND : 999999999);
            }
        } else {
    ...
    private int get0(TemporalField temporalField) {
        switch (C24942.$SwitchMap$org$threeten$bp$temporal$ChronoField[((ChronoField) temporalField).ordinal()]) {
            case 1:
                return this.day;
            case 2:
                return getDayOfYear();
    ...
    public Month getMonth() {
        return Month.m255of(this.month);
    }
    ...
    public DayOfWeek getDayOfWeek() {
        return DayOfWeek.m241of(Jdk8Methods.floorMod(toEpochDay() + 3, 7) + 1);
    }
    ...
    public LocalDate with(TemporalField temporalField, long j) {
        ...
        switch (C24942.$SwitchMap$org$threeten$bp$temporal$ChronoField[chronoField.ordinal()]) {
            case 1:
    ...
    public LocalDate withDayOfMonth(int i) {
        ...
        return m243of(this.year, (int) this.month, i);
    }
    ...
    static /* synthetic */ class C24942 {
        ...
        static {
            /*
                org.threeten.bp.temporal.ChronoUnit[] r0 = org.threeten.p022bp.temporal.ChronoUnit.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$org$threeten$bp$temporal$ChronoUnit = r0
                r1 = 1
                org.threeten.bp.temporal.ChronoUnit r2 = org.threeten.p022bp.temporal.ChronoUnit.DAYS     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                r0 = 2
                int[] r2 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x001d }
                org.threeten.bp.temporal.ChronoUnit r3 = org.threeten.p022bp.temporal.ChronoUnit.WEEKS     // Catch:{ NoSuchFieldError -> 0x001d }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2[r3] = r0     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                r2 = 3
                int[] r3 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0028 }
                org.threeten.bp.temporal.ChronoUnit r4 = org.threeten.p022bp.temporal.ChronoUnit.MONTHS     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r3[r4] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                r3 = 4
                int[] r4 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0033 }
                org.threeten.bp.temporal.ChronoUnit r5 = org.threeten.p022bp.temporal.ChronoUnit.YEARS     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r5 = r5.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r4[r5] = r3     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                r4 = 5
                int[] r5 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x003e }
                org.threeten.bp.temporal.ChronoUnit r6 = org.threeten.p022bp.temporal.ChronoUnit.DECADES     // Catch:{ NoSuchFieldError -> 0x003e }
                int r6 = r6.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r5[r6] = r4     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                r5 = 6
                int[] r6 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0049 }
                org.threeten.bp.temporal.ChronoUnit r7 = org.threeten.p022bp.temporal.ChronoUnit.CENTURIES     // Catch:{ NoSuchFieldError -> 0x0049 }
                int r7 = r7.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
                r6[r7] = r5     // Catch:{ NoSuchFieldError -> 0x0049 }
            L_0x0049:
                r6 = 7
                int[] r7 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0054 }
                org.threeten.bp.temporal.ChronoUnit r8 = org.threeten.p022bp.temporal.ChronoUnit.MILLENNIA     // Catch:{ NoSuchFieldError -> 0x0054 }
                int r8 = r8.ordinal()     // Catch:{ NoSuchFieldError -> 0x0054 }
                r7[r8] = r6     // Catch:{ NoSuchFieldError -> 0x0054 }
            L_0x0054:
                r7 = 8
                int[] r8 = $SwitchMap$org$threeten$bp$temporal$ChronoUnit     // Catch:{ NoSuchFieldError -> 0x0060 }
                org.threeten.bp.temporal.ChronoUnit r9 = org.threeten.p022bp.temporal.ChronoUnit.ERAS     // Catch:{ NoSuchFieldError -> 0x0060 }
                int r9 = r9.ordinal()     // Catch:{ NoSuchFieldError -> 0x0060 }
                r8[r9] = r7     // Catch:{ NoSuchFieldError -> 0x0060 }
            L_0x0060:
                org.threeten.bp.temporal.ChronoField[] r8 = org.threeten.p022bp.temporal.ChronoField.values()
                int r8 = r8.length
                int[] r8 = new int[r8]
                $SwitchMap$org$threeten$bp$temporal$ChronoField = r8
                org.threeten.bp.temporal.ChronoField r9 = org.threeten.p022bp.temporal.ChronoField.DAY_OF_MONTH     // Catch:{ NoSuchFieldError -> 0x0071 }
            ...
            L_0x0071:
                ...
                org.threeten.bp.temporal.ChronoField r8 = org.threeten.p022bp.temporal.ChronoField.DAY_OF_YEAR     // Catch:{ NoSuchFieldError -> 0x007b }
            ...
            L_0x007b:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.ALIGNED_WEEK_OF_MONTH     // Catch:{ NoSuchFieldError -> 0x0085 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0085 }
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0085 }
            L_0x0085:
                int[] r0 = $SwitchMap$org$threeten$bp$temporal$ChronoField     // Catch:{ NoSuchFieldError -> 0x008f }
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.YEAR_OF_ERA     // Catch:{ NoSuchFieldError -> 0x008f }
            ...
            L_0x008f:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.DAY_OF_WEEK     // Catch:{ NoSuchFieldError -> 0x0099 }
            ...
            L_0x0099:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.ALIGNED_DAY_OF_WEEK_IN_MONTH     // Catch:{ NoSuchFieldError -> 0x00a3 }
            ...
            L_0x00a3:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.ALIGNED_DAY_OF_WEEK_IN_YEAR     // Catch:{ NoSuchFieldError -> 0x00ad }
            ...
            L_0x00ad:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.EPOCH_DAY     // Catch:{ NoSuchFieldError -> 0x00b7 }
            ...
            L_0x00b7:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.ALIGNED_WEEK_OF_YEAR     // Catch:{ NoSuchFieldError -> 0x00c3 }
            ...
            L_0x00c3:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.MONTH_OF_YEAR     // Catch:{ NoSuchFieldError -> 0x00cf }
            ...
            L_0x00cf:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.PROLEPTIC_MONTH     // Catch:{ NoSuchFieldError -> 0x00db }
            ...
            L_0x00db:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.YEAR     // Catch:{ NoSuchFieldError -> 0x00e7 }
            ...
            L_0x00e7:
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.ERA     // Catch:{ NoSuchFieldError -> 0x00f3 }
            ...
            L_0x00f3:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.LocalDate.C24942.<clinit>():void");
        }
    }
    ...
    public Period until(ChronoLocalDate chronoLocalDate) {
        ...
        return Period.m263of(Jdk8Methods.safeToInt(prolepticMonth / 12), (int) (prolepticMonth % 12), i);
    }

    public LocalDateTime atTime(LocalTime localTime) {
        return LocalDateTime.m251of(this, localTime);
    }

    public LocalDateTime atTime(int i, int i2) {
        return atTime(LocalTime.m252of(i, i2));
    }

    public LocalDateTime atTime(int i, int i2, int i3) {
        return atTime(LocalTime.m253of(i, i2, i3));
    }

    public LocalDateTime atTime(int i, int i2, int i3, int i4) {
        return atTime(LocalTime.m254of(i, i2, i3, i4));
    }

    public OffsetDateTime atTime(OffsetTime offsetTime) {
        return OffsetDateTime.m260of(LocalDateTime.m251of(this, offsetTime.toLocalTime()), offsetTime.getOffset());
    }

    public LocalDateTime atStartOfDay() {
        return LocalDateTime.m251of(this, LocalTime.MIDNIGHT);
    }
    ...
    public ZonedDateTime atStartOfDay(ZoneId zoneId) {
        ...
        return ZonedDateTime.m272of(atTime, zoneId);
    }
    ...
    public String toString() {
        ...
        String str = "-0";
        sb.append(s < 10 ? str : CoreConfig.ENTITY_TOKEN_PREFIX);
        sb.append(s);
        if (s2 >= 10) {
    ...
    static LocalDate readExternal(DataInput dataInput) throws IOException {
        return m243of(dataInput.readInt(), (int) dataInput.readByte(), (int) dataInput.readByte());
    }
}
