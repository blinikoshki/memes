...
import com.google.android.gms.internal.p026firebaseauthapi.zzh;
import com.google.android.gms.internal.p026firebaseauthapi.zztw;
import com.google.android.gms.internal.p026firebaseauthapi.zzty;
import com.google.android.gms.internal.p026firebaseauthapi.zzus;
import com.google.android.gms.internal.p026firebaseauthapi.zzvw;
...
public class RecaptchaActivity extends FragmentActivity implements zzty {
    ...
    public final HttpURLConnection zzb(URL url) {
        try {
            ...
            zza.mo39950e("Error generating connection", new Object[0]);
            return null;
        }
    }
    ...
    public final Uri.Builder zzd(Intent intent, String str, String str2) {
        ...
        return appendQueryParameter.appendQueryParameter(FfmpegCommand.VIDEO_STREAM, valueOf.length() != 0 ? "X".concat(valueOf) : new String("X")).appendQueryParameter("eid", TtmlNode.TAG_P).appendQueryParameter("appName", stringExtra3).appendQueryParameter("sha1Cert", str2).appendQueryParameter("publicKey", zzb2);
    }
