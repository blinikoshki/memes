...
final class ChronoLocalDateTimeImpl<D extends ChronoLocalDate> extends ChronoLocalDateTime<D> implements Temporal, TemporalAdjuster, Serializable {
    ...
    /* renamed from: of */
    static <R extends ChronoLocalDate> ChronoLocalDateTimeImpl<R> m273of(R r, LocalTime localTime) {
    ...
    public ChronoLocalDateTimeImpl<D> plus(long j, TemporalUnit temporalUnit) {
        ...
        switch (C25201.$SwitchMap$org$threeten$bp$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
            case 1:
                return plusNanos(j);
            case 2:
    ...
    static /* synthetic */ class C25201 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.chrono.ChronoLocalDateTimeImpl.C25201.<clinit>():void");
        }
    }
    ...
    public long until(Temporal temporal, TemporalUnit temporalUnit) {
        ...
        if (chronoUnit.isTimeBased()) {
            ...
            switch (C25201.$SwitchMap$org$threeten$bp$temporal$ChronoUnit[chronoUnit.ordinal()]) {
                case 1:
    ...
    private Object writeReplace() {
        return new Ser(Ascii.f581FF, this);
    }
