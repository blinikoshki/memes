...
final class RemoteMemesDataSource$updateFirebaseToken$1<T, R> implements Function<Response<ApiMessageResponse>, UniversalResult<Object>> {
    public static final RemoteMemesDataSource$updateFirebaseToken$1 INSTANCE = new RemoteMemesDataSource$updateFirebaseToken$1();

    RemoteMemesDataSource$updateFirebaseToken$1() {
    }
