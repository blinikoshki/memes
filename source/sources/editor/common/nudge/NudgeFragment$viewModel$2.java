...
final class NudgeFragment$viewModel$2 extends Lambda implements Function0<NudgeViewModel> {
    final /* synthetic */ NudgeFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NudgeFragment$viewModel$2(NudgeFragment nudgeFragment) {
        super(0);
    ...
    public final NudgeViewModel invoke() {
        ...
        Function0 function0 = C46601.INSTANCE;
        if (function0 == null) {
