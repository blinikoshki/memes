...
final class LiveDataCombineTupleKt$combineTuple$10$5<T> implements Observer<T5> {
    final /* synthetic */ MediatorLiveData $mediator;

    LiveDataCombineTupleKt$combineTuple$10$5(MediatorLiveData mediatorLiveData) {
