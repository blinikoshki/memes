...
final class MediaImportViewModel$commandUtil$2 extends Lambda implements Function0<FfmpegCommandUtil> {
    final /* synthetic */ MediaImportViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MediaImportViewModel$commandUtil$2(MediaImportViewModel mediaImportViewModel) {
        super(0);
