...
abstract class LoginMethodHandler implements Parcelable {
    ...
    public static AccessToken createAccessTokenFromWebBundle(Collection<String> collection, Bundle bundle, AccessTokenSource accessTokenSource, String str) throws FacebookException {
        ...
        ArrayList arrayList = !Utility.isNullOrEmpty(string2) ? new ArrayList(Arrays.asList(string2.split(Util.EVENT_ID_SEPARATOR))) : collection;
        String string3 = bundle2.getString("denied_scopes");
        ArrayList arrayList2 = !Utility.isNullOrEmpty(string3) ? new ArrayList(Arrays.asList(string3.split(Util.EVENT_ID_SEPARATOR))) : null;
        String string4 = bundle2.getString("expired_scopes");
        ArrayList arrayList3 = !Utility.isNullOrEmpty(string4) ? new ArrayList(Arrays.asList(string4.split(Util.EVENT_ID_SEPARATOR))) : null;
        if (Utility.isNullOrEmpty(string)) {
            return null;
        }
