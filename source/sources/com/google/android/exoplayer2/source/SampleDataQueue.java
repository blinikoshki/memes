...
class SampleDataQueue {
    ...
    private void readEncryptionData(DecoderInputBuffer decoderInputBuffer, SampleQueue.SampleExtrasHolder sampleExtrasHolder) {
        ...
        if (cryptoInfo.f197iv == null) {
            cryptoInfo.f197iv = new byte[16];
        } else {
            Arrays.fill(cryptoInfo.f197iv, (byte) 0);
        }
        readData(j2, cryptoInfo.f197iv, (int) b2);
        long j3 = j2 + ((long) b2);
        if (z) {
        ...
        cryptoInfo.set(i, iArr2, iArr4, cryptoData.encryptionKey, cryptoInfo.f197iv, cryptoData.cryptoMode, cryptoData.encryptedBlocks, cryptoData.clearBlocks);
