...
final class StockMemesFragment$onViewCreated$2<T> implements Observer<String> {
    final /* synthetic */ StockMemesFragment this$0;

    StockMemesFragment$onViewCreated$2(StockMemesFragment stockMemesFragment) {
    ...
    public final void onChanged(String str) {
        ...
        if (charSequence == null || StringsKt.isBlank(charSequence)) {
            TextView textView = StockMemesFragment.access$getBinding$p(this.this$0).searchQueryResultTextView;
            Intrinsics.checkNotNullExpressionValue(textView, "binding.searchQueryResultTextView");
            textView.setVisibility(8);
            TextView textView2 = StockMemesFragment.access$getBinding$p(this.this$0).searchQueryResultTextView;
            Intrinsics.checkNotNullExpressionValue(textView2, "binding.searchQueryResultTextView");
            textView2.setText((CharSequence) null);
            return;
        }
        TextView textView3 = StockMemesFragment.access$getBinding$p(this.this$0).searchQueryResultTextView;
        Intrinsics.checkNotNullExpressionValue(textView3, "binding.searchQueryResultTextView");
        textView3.setVisibility(0);
        TextView textView4 = StockMemesFragment.access$getBinding$p(this.this$0).searchQueryResultTextView;
