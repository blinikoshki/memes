...
/* renamed from: com.memes.plus.ui.profile.profile_posts.ProfilePostsFragment$facebookIntegrationViewModel$2 */
/* compiled from: ProfilePostsFragment.kt */
final class ProfilePostsFragment$facebookIntegrationViewModel$2 extends Lambda implements Function0<FacebookIntegrationViewModel> {
    final /* synthetic */ ProfilePostsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ProfilePostsFragment$facebookIntegrationViewModel$2(ProfilePostsFragment profilePostsFragment) {
        super(0);
    ...
    public final FacebookIntegrationViewModel invoke() {
        ...
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<FacebookIntegrationViewModel>(this) {
            final /* synthetic */ ProfilePostsFragment$facebookIntegrationViewModel$2 this$0;
