...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m410or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m411or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m409or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m408in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f595f;

        /* renamed from: p */
        final Predicate<B> f596p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f596p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f595f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f596p.apply(this.f595f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f595f.equals(compositionPredicate.f595f) || !this.f596p.equals(compositionPredicate.f596p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f595f.hashCode() ^ this.f596p.hashCode();
        }

        public String toString() {
            return this.f596p + "(" + this.f595f + ")";
        }
    }
