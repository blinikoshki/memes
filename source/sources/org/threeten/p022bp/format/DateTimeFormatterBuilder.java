...
import org.threeten.p022bp.format.SimpleDateTimeTextProvider;
...
import org.threeten.p022bp.temporal.WeekFields;
import org.threeten.p022bp.zone.ZoneRulesProvider;
...
public final class DateTimeFormatterBuilder {
    ...
    static class NumberPrinterParser implements DateTimePrinterParser {
        static final int[] EXCEED_POINTS = {0, 10, 100, 1000, 10000, AacUtil.AAC_LC_MAX_RATE_BYTES_PER_SECOND, 1000000, 10000000, 100000000, 1000000000};
        ...
        public boolean print(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            ...
            if (str.length() <= this.maxWidth) {
                ...
                if (value2 >= 0) {
                    int i = C25384.$SwitchMap$org$threeten$bp$format$SignStyle[this.signStyle.ordinal()];
                    if (i == 1) {
                    ...
                    int i3 = C25384.$SwitchMap$org$threeten$bp$format$SignStyle[this.signStyle.ordinal()];
                    if (i3 == 1 || i3 == 2 || i3 == 3) {
        ...
        public int parse(org.threeten.p022bp.format.DateTimeParseContext r20, java.lang.CharSequence r21, int r22) {
            /*
                r19 = this;
                r6 = r19
                r0 = r22
            ...
            L_0x005f:
                org.threeten.bp.format.SignStyle r2 = r6.signStyle
                org.threeten.bp.format.SignStyle r3 = org.threeten.p022bp.format.SignStyle.ALWAYS
            ...
            L_0x013c:
                ...
                org.threeten.bp.format.SignStyle r1 = org.threeten.p022bp.format.SignStyle.EXCEEDS_PAD
            ...
            L_0x017b:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.format.DateTimeFormatterBuilder.NumberPrinterParser.parse(org.threeten.bp.format.DateTimeParseContext, java.lang.CharSequence, int):int");
        }
        ...
        public String toString() {
            if (this.minWidth == 1 && this.maxWidth == 19 && this.signStyle == SignStyle.NORMAL) {
                ...
                return "Value(" + this.field + Util.EVENT_ID_SEPARATOR + this.minWidth + ")";
            } else {
                return "Value(" + this.field + Util.EVENT_ID_SEPARATOR + this.minWidth + Util.EVENT_ID_SEPARATOR + this.maxWidth + Util.EVENT_ID_SEPARATOR + this.signStyle + ")";
            }
        }
    }

    /* renamed from: org.threeten.bp.format.DateTimeFormatterBuilder$4 */
    static /* synthetic */ class C25384 {
        ...
        static {
            /*
                org.threeten.bp.format.SignStyle[] r0 = org.threeten.p022bp.format.SignStyle.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$org$threeten$bp$format$SignStyle = r0
                org.threeten.bp.format.SignStyle r1 = org.threeten.p022bp.format.SignStyle.EXCEEDS_PAD     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$org$threeten$bp$format$SignStyle     // Catch:{ NoSuchFieldError -> 0x001d }
                org.threeten.bp.format.SignStyle r1 = org.threeten.p022bp.format.SignStyle.ALWAYS     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$org$threeten$bp$format$SignStyle     // Catch:{ NoSuchFieldError -> 0x0028 }
                org.threeten.bp.format.SignStyle r1 = org.threeten.p022bp.format.SignStyle.NORMAL     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$org$threeten$bp$format$SignStyle     // Catch:{ NoSuchFieldError -> 0x0033 }
                org.threeten.bp.format.SignStyle r1 = org.threeten.p022bp.format.SignStyle.NOT_NEGATIVE     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.format.DateTimeFormatterBuilder.C25384.<clinit>():void");
        }
    }

    /* renamed from: org.threeten.bp.format.DateTimeFormatterBuilder$ReducedPrinterParser */
    static final class ReducedPrinterParser extends NumberPrinterParser {
        static final LocalDate BASE_DATE = LocalDate.m243of(2000, 1, 1);
    ...
    static final class FractionPrinterParser implements DateTimePrinterParser {
        ...
        public String toString() {
            ...
            return "Fraction(" + this.field + Util.EVENT_ID_SEPARATOR + this.minWidth + Util.EVENT_ID_SEPARATOR + this.maxWidth + str + ")";
        }
    }
    ...
    static final class TextPrinterParser implements DateTimePrinterParser {
        ...
        public String toString() {
            ...
            return "Text(" + this.field + Util.EVENT_ID_SEPARATOR + this.textStyle + ")";
        }
    }
    ...
    static final class InstantPrinterParser implements DateTimePrinterParser {
        ...
        public int parse(DateTimeParseContext dateTimeParseContext, CharSequence charSequence, int i) {
            ...
            int parse = new DateTimeFormatterBuilder().append(DateTimeFormatter.ISO_LOCAL_DATE).appendLiteral('T').appendValue(ChronoField.HOUR_OF_DAY, 2).appendLiteral(':').appendValue(ChronoField.MINUTE_OF_HOUR, 2).appendLiteral(':').appendValue(ChronoField.SECOND_OF_MINUTE, 2).appendFraction(ChronoField.NANO_OF_SECOND, i6, i4, true).appendLiteral('Z').toFormatter().toPrinterParser(false).parse(copy, charSequence, i3);
            if (parse < 0) {
                return parse;
            }
    ...
    static final class OffsetIdPrinterParser implements DateTimePrinterParser {
        ...
        public boolean print(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            ...
            if (safeToInt == 0) {
                ...
                int length = sb.length();
                sb.append(safeToInt < 0 ? CoreConfig.ENTITY_TOKEN_PREFIX : "+");
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int parse(org.threeten.p022bp.format.DateTimeParseContext r16, java.lang.CharSequence r17, int r18) {
            /*
                r15 = this;
                r0 = r15
                r7 = r17
                ...
                org.threeten.bp.temporal.ChronoField r2 = org.threeten.p022bp.temporal.ChronoField.OFFSET_SECONDS
                r3 = 0
                r1 = r16
                r5 = r18
                r6 = r18
            ...
            L_0x00b6:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.format.DateTimeFormatterBuilder.OffsetIdPrinterParser.parse(org.threeten.bp.format.DateTimeParseContext, java.lang.CharSequence, int):int");
        }
    ...
    static final class LocalizedOffsetPrinterParser implements DateTimePrinterParser {
        ...
        public int parse(DateTimeParseContext dateTimeParseContext, CharSequence charSequence, int i) {
            ...
            if (i8 == length || charSequence2.charAt(i8) != ':') {
                return dateTimeParseContext.setParsedField(ChronoField.OFFSET_SECONDS, (long) (i4 * 3600 * i7), i8, i8);
            }
            int i9 = i8 + 1;
            int i10 = length - 2;
            if (i9 > i10) {
            ...
            if (i13 == length || charSequence2.charAt(i13) != ':') {
                return dateTimeParseContext.setParsedField(ChronoField.OFFSET_SECONDS, (long) (i4 * ((i7 * 3600) + (i14 * 60))), i13, i13);
            }
            int i15 = i13 + 1;
            if (i15 > i10) {
                return ~i15;
            ...
            return dateTimeParseContext.setParsedField(ChronoField.OFFSET_SECONDS, (long) (i4 * ((i7 * 3600) + (i14 * 60) + i19)), i18, i18);
        }
    }
    ...
    static final class ZoneTextPrinterParser implements DateTimePrinterParser {
        ...
        public int parse(DateTimeParseContext dateTimeParseContext, CharSequence charSequence, int i) {
            ...
            if (i > length) {
                ...
                for (Map.Entry entry : treeMap.entrySet()) {
                    ...
                    if (dateTimeParseContext.subSequenceEquals(charSequence, i, str, 0, str.length())) {
                        dateTimeParseContext.setParsed(ZoneId.m267of((String) entry.getValue()));
                        return i + str.length();
                    }
                }
                if (charAt != 'Z') {
        ...
        private int parseOffset(DateTimeParseContext dateTimeParseContext, CharSequence charSequence, int i, String str) {
            ...
            int i2 = i + length;
            if (i2 >= charSequence.length()) {
                dateTimeParseContext.setParsed(ZoneId.m267of(str));
                return i2;
            }
            ...
            if (!z) {
                for (String next : set) {
                    if (next.equalsIgnoreCase(str)) {
                        return ZoneId.m267of(next);
                    }
                }
                return null;
            } else if (set.contains(str)) {
                return ZoneId.m267of(str);
            } else {
                return null;
            }
        }
    ...
    static final class WeekFieldsPrinterParser implements DateTimePrinterParser {
        ...
        public boolean print(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            return evaluate(WeekFields.m291of(dateTimePrintContext.getLocale())).print(dateTimePrintContext, sb);
        }

        public int parse(DateTimeParseContext dateTimeParseContext, CharSequence charSequence, int i) {
            return evaluate(WeekFields.m291of(dateTimeParseContext.getLocale())).parse(dateTimeParseContext, charSequence, i);
        }
