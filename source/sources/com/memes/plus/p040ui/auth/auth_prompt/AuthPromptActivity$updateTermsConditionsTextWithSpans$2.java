...
/* renamed from: com.memes.plus.ui.auth.auth_prompt.AuthPromptActivity$updateTermsConditionsTextWithSpans$2 */
/* compiled from: AuthPromptActivity.kt */
final class AuthPromptActivity$updateTermsConditionsTextWithSpans$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ AuthPromptActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AuthPromptActivity$updateTermsConditionsTextWithSpans$2(AuthPromptActivity authPromptActivity) {
        super(0);
