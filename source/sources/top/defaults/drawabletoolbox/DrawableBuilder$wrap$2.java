...
final class DrawableBuilder$wrap$2 extends FunctionReference implements Function1<Drawable, Drawable> {
    DrawableBuilder$wrap$2(DrawableBuilder drawableBuilder) {
    ...
    public final Drawable invoke(Drawable drawable) {
        ...
        return ((DrawableBuilder) this.receiver).wrapScaleIfNeeded(drawable);
    }
}
