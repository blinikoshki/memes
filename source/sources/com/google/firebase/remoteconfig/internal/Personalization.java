                ...
                if (!optString.isEmpty()) {
                    synchronized (this.loggedChoiceIds) {
                        if (!optString.equals(this.loggedChoiceIds.get(str))) {
                            ...
                            this.analyticsConnector.logEvent(ANALYTICS_ORIGIN_PERSONALIZATION, EXTERNAL_EVENT, bundle);
                            Bundle bundle2 = new Bundle();
                            bundle2.putString(INTERNAL_CHOICE_ID_PARAM, optString);
                            this.analyticsConnector.logEvent(ANALYTICS_ORIGIN_PERSONALIZATION, INTERNAL_EVENT, bundle2);
                        }
                    }
                }
            }
