...
/* renamed from: com.memes.plus.ui.posts.PostsTabFragment$facebookIntegrationViewModel$2 */
/* compiled from: PostsTabFragment.kt */
final class PostsTabFragment$facebookIntegrationViewModel$2 extends Lambda implements Function0<FacebookIntegrationViewModel> {
    final /* synthetic */ PostsTabFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PostsTabFragment$facebookIntegrationViewModel$2(PostsTabFragment postsTabFragment) {
        super(0);
    ...
    public final FacebookIntegrationViewModel invoke() {
        ...
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<FacebookIntegrationViewModel>(this) {
            final /* synthetic */ PostsTabFragment$facebookIntegrationViewModel$2 this$0;
