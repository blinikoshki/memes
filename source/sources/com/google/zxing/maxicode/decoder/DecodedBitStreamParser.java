...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f787FS = '\u001c';

    /* renamed from: GS */
    private static final char f788GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f789NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f790RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f788GS + format + f788GS + format2 + f788GS);
            } else {
                sb.insert(0, str + f788GS + format + f788GS + format2 + f788GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f591US, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f580EM, Ascii.SUB, Ascii.ESC, Ascii.f582FS, Ascii.f583GS, Ascii.f587RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f579CR, Ascii.f589SO, Ascii.f588SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, Ascii.f592VT, Ascii.f581FF, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        String[] strArr = SETS;
        return String.valueOf(new char[]{strArr[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f591US, 32})), strArr[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f580EM, Ascii.SUB})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f582FS, Ascii.f583GS, Ascii.f587RS, 19, Ascii.DC4})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f579CR, Ascii.f589SO})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.f588SI, Ascii.DLE, 17, Ascii.DC2, 7, 8})), strArr[0].charAt(getInt(bArr, new byte[]{9, 10, Ascii.f592VT, Ascii.f581FF, 1, 2}))});
    }
