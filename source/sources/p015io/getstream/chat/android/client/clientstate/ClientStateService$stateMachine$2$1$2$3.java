...
/* renamed from: io.getstream.chat.android.client.clientstate.ClientStateService$stateMachine$2$1$2$3 */
/* compiled from: ClientStateService.kt */
final class ClientStateService$stateMachine$2$1$2$3 extends Lambda implements Function3<FiniteStateMachine<ClientState, ClientStateService.ClientStateEvent>, ClientState.Idle, ClientStateService.ClientStateEvent.DisconnectedEvent, ClientState> {
    public static final ClientStateService$stateMachine$2$1$2$3 INSTANCE = new ClientStateService$stateMachine$2$1$2$3();

    ClientStateService$stateMachine$2$1$2$3() {
        super(3);
    }

    public final ClientState invoke(FiniteStateMachine<ClientState, ClientStateService.ClientStateEvent> finiteStateMachine, ClientState.Idle idle, ClientStateService.ClientStateEvent.DisconnectedEvent disconnectedEvent) {
