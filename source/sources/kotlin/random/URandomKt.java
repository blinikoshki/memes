...
public final class URandomKt {
    ...
    public static final int m2210nextUInta8DCA5k(Random random, int i, int i2) {
        ...
        return UInt.m1115constructorimpl(random.nextInt(i ^ Integer.MIN_VALUE, i2 ^ Integer.MIN_VALUE) ^ Integer.MIN_VALUE);
    }
    ...
    public static final int nextUInt(Random random, UIntRange uIntRange) {
        ...
        } else if (UnsignedKt.uintCompare(uIntRange.m2215getLastpVg5ArA(), -1) < 0) {
            return m2210nextUInta8DCA5k(random, uIntRange.m2214getFirstpVg5ArA(), UInt.m1115constructorimpl(uIntRange.m2215getLastpVg5ArA() + 1));
        } else {
            if (UnsignedKt.uintCompare(uIntRange.m2214getFirstpVg5ArA(), 0) > 0) {
                return UInt.m1115constructorimpl(m2210nextUInta8DCA5k(random, UInt.m1115constructorimpl(uIntRange.m2214getFirstpVg5ArA() - 1), uIntRange.m2215getLastpVg5ArA()) + 1);
            }
    ...
    public static final long nextULong(Random random) {
        ...
        return ULong.m1185constructorimpl(random.nextLong());
    }
    ...
    public static final long m2213nextULongjmpaWc(Random random, long j, long j2) {
        ...
        return ULong.m1185constructorimpl(random.nextLong(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) ^ Long.MIN_VALUE);
    }
    ...
    public static final long nextULong(Random random, ULongRange uLongRange) {
        ...
        } else if (UnsignedKt.ulongCompare(uLongRange.m2222getLastsVKNKU(), -1) < 0) {
            return m2213nextULongjmpaWc(random, uLongRange.m2221getFirstsVKNKU(), ULong.m1185constructorimpl(uLongRange.m2222getLastsVKNKU() + ULong.m1185constructorimpl(((long) 1) & 4294967295L)));
        } else {
            if (UnsignedKt.ulongCompare(uLongRange.m2221getFirstsVKNKU(), 0) <= 0) {
                return nextULong(random);
            }
            long j = ((long) 1) & 4294967295L;
            return ULong.m1185constructorimpl(m2213nextULongjmpaWc(random, ULong.m1185constructorimpl(uLongRange.m2221getFirstsVKNKU() - ULong.m1185constructorimpl(j)), uLongRange.m2222getLastsVKNKU()) + ULong.m1185constructorimpl(j));
        }
    }
    ...
    public static final byte[] nextUBytes(Random random, int i) {
        Intrinsics.checkNotNullParameter(random, "$this$nextUBytes");
        return UByteArray.m1091constructorimpl(random.nextBytes(i));
    }
    ...
    public static final void m2205checkUIntRangeBoundsJ1ME1BU(int i, int i2) {
        if (!(UnsignedKt.uintCompare(i2, i) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m1109boximpl(i), UInt.m1109boximpl(i2)).toString());
        }
    }
    ...
    public static final void m2206checkULongRangeBoundseb3DHEI(long j, long j2) {
        if (!(UnsignedKt.ulongCompare(j2, j) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m1179boximpl(j), ULong.m1179boximpl(j2)).toString());
        }
    }
}
