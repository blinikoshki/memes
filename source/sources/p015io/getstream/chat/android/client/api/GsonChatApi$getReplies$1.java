...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$getReplies$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$getReplies$1 extends Lambda implements Function1<GetRepliesResponse, List<? extends Message>> {
    public static final GsonChatApi$getReplies$1 INSTANCE = new GsonChatApi$getReplies$1();

    GsonChatApi$getReplies$1() {
        super(1);
    }
