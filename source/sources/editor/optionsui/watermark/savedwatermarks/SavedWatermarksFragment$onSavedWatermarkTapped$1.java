...
final class SavedWatermarksFragment$onSavedWatermarkTapped$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Watermark $watermark;
    final /* synthetic */ SavedWatermarksFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SavedWatermarksFragment$onSavedWatermarkTapped$1(SavedWatermarksFragment savedWatermarksFragment, Watermark watermark) {
        super(0);
    ...
    public final void invoke() {
        this.this$0.getViewModel().importWatermark(this.$watermark);
    }
}
