...
final class TextSpacingFragment$initLineSpacingSlider$1 extends Lambda implements Function2<Float, Boolean, Unit> {
    final /* synthetic */ TextSpacingFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TextSpacingFragment$initLineSpacingSlider$1(TextSpacingFragment textSpacingFragment) {
        super(2);
    ...
    public final void invoke(float f, boolean z) {
        if (z) {
            this.this$0.getViewModel().changeLineSpacing(f);
        }
    }
}
