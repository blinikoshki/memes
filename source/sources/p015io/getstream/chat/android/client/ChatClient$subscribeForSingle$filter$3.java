...
/* renamed from: io.getstream.chat.android.client.ChatClient$subscribeForSingle$filter$3 */
/* compiled from: ChatClient.kt */
final class ChatClient$subscribeForSingle$filter$3 extends Lambda implements Function1<ChatEvent, Boolean> {
    final /* synthetic */ Class $eventType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChatClient$subscribeForSingle$filter$3(Class cls) {
        super(1);
        this.$eventType = cls;
    }
