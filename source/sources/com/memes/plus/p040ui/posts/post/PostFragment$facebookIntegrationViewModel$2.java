...
/* renamed from: com.memes.plus.ui.posts.post.PostFragment$facebookIntegrationViewModel$2 */
/* compiled from: PostFragment.kt */
final class PostFragment$facebookIntegrationViewModel$2 extends Lambda implements Function0<FacebookIntegrationViewModel> {
    final /* synthetic */ PostFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PostFragment$facebookIntegrationViewModel$2(PostFragment postFragment) {
        super(0);
    ...
    public final FacebookIntegrationViewModel invoke() {
        ...
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<FacebookIntegrationViewModel>(this) {
            final /* synthetic */ PostFragment$facebookIntegrationViewModel$2 this$0;
