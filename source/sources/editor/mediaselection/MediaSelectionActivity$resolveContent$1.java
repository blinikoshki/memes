...
final class MediaSelectionActivity$resolveContent$1<O> implements ActivityResultCallback<Pair<? extends MediaContent, ? extends Boolean>> {
    final /* synthetic */ LocalMedia $localMedia;
    final /* synthetic */ MediaSelectionActivity this$0;

    MediaSelectionActivity$resolveContent$1(MediaSelectionActivity mediaSelectionActivity, LocalMedia localMedia) {
    ...
    public final void onActivityResult(Pair<MediaContent, Boolean> pair) {
        ...
        if (!pair.component2().booleanValue()) {
            ...
            this.this$0.resolvedMediaContentsMap.put(this.$localMedia.getIdentifier(), component1);
            this.this$0.getViewModel().setIdBasedMediaSelected(new IdBasedMedia(this.$localMedia.getIdentifier(), component1), true);
        }
    }
}
