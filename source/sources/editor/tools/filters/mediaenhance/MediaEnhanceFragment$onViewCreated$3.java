...
final class MediaEnhanceFragment$onViewCreated$3<T> implements Observer<Boolean> {
    final /* synthetic */ MediaEnhanceFragment this$0;

    MediaEnhanceFragment$onViewCreated$3(MediaEnhanceFragment mediaEnhanceFragment) {
        this.this$0 = mediaEnhanceFragment;
    }

    public final void onChanged(Boolean bool) {
        SmallOptionButton smallOptionButton = MediaEnhanceFragment.access$getBinding$p(this.this$0).saturationOptionView;
        Intrinsics.checkNotNullExpressionValue(smallOptionButton, "binding.saturationOptionView");
