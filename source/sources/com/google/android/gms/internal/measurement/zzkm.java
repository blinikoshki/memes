...
final class zzkm extends zzkj {
                ...
                if (b >= -32) {
                    if (b >= -16) {
                        if (i9 >= 3) {
                            i8 = i9 - 3;
                            long j7 = j5 + 1;
                            byte zzp = zzkh.zzp(bArr2, j5);
                            if (zzp > -65 || (((b << Ascii.f582FS) + (zzp + 112)) >> 30) != 0) {
                                break;
                            }
                            long j8 = j7 + 1;
                            if (zzkh.zzp(bArr2, j7) > -65) {
                                break;
                            }
                            j = j8 + 1;
                            if (zzkh.zzp(bArr2, j8) > -65) {
                                break;
                            }
                        } else {
                        ...
                        i8 = i9 - 2;
                        long j9 = j5 + 1;
                        byte zzp2 = zzkh.zzp(bArr2, j5);
                        if (zzp2 > -65 || ((b == -32 && zzp2 < -96) || (b == -19 && zzp2 >= -96))) {
                            break;
                        }
                        j5 = j9 + 1;
                        if (zzkh.zzp(bArr2, j9) > -65) {
                            break;
                        }
                    } else {
                        return zze(bArr2, b, j5, i9);
    ...
    public final String zzc(byte[] bArr, int i, int i2) throws zzic {
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            int i5 = 0;
            while (r12 < i4) {
                byte zzp = zzkh.zzp(bArr, (long) r12);
                if (!zzki.zza(zzp)) {
                    break;
                }
                i = r12 + 1;
            ...
            while (r12 < i4) {
                int i6 = r12 + 1;
                byte zzp2 = zzkh.zzp(bArr, (long) r12);
                if (zzki.zza(zzp2)) {
                    int i7 = i3 + 1;
                    cArr[i3] = (char) zzp2;
                    r12 = i6;
                    while (true) {
                        ...
                        byte zzp3 = zzkh.zzp(bArr, (long) r12);
                        if (!zzki.zza(zzp3)) {
                            break;
                        }
                        r12++;
                    ...
                    if (i6 < i4) {
                        zzki.zzc(zzp2, zzkh.zzp(bArr, (long) i6), cArr, i3);
                        r12 = i6 + 1;
                        i3++;
                    } else {
                        throw zzic.zzf();
                    ...
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        zzki.zze(zzp2, zzkh.zzp(bArr, (long) i6), zzkh.zzp(bArr, (long) i8), cArr, i3);
                        r12 = i8 + 1;
                        i3++;
                    } else {
                        throw zzic.zzf();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    zzki.zzf(zzp2, zzkh.zzp(bArr, (long) i6), zzkh.zzp(bArr, (long) i9), zzkh.zzp(bArr, (long) i10), cArr, i3);
                    i3 += 2;
                    r12 = i10 + 1;
                } else {
                    throw zzic.zzf();
    ...
    public final int zzd(java.lang.CharSequence r23, byte[] r24, int r25, int r26) {
        ...
        L_0x001a:
            ...
            long r11 = r11 + r4
            byte r3 = (byte) r13
            com.google.android.gms.internal.measurement.zzkh.zzq(r1, r4, r3)
            int r2 = r2 + 1
            r4 = r11
            goto L_0x001a
        L_0x002f:
        ...
        L_0x0031:
            ...
            long r14 = r4 + r11
            byte r13 = (byte) r13
            com.google.android.gms.internal.measurement.zzkh.zzq(r1, r4, r13)
            r4 = r11
            r12 = r14
        L_0x0045:
        ...
        L_0x0049:
            ...
            r5 = r5 | r13
            byte r5 = (byte) r5
            com.google.android.gms.internal.measurement.zzkh.zzq(r1, r14, r5)
            r20 = r11
            r11 = 128(0x80, float:1.794E-43)
            r12 = r3
            r4 = r20
        ...
        L_0x007c:
            ...
            r5 = r5 | r11
            byte r5 = (byte) r5
            com.google.android.gms.internal.measurement.zzkh.zzq(r1, r3, r5)
            r12 = r18
            r4 = 1
            goto L_0x0045
        L_0x00aa:
            ...
            byte r15 = (byte) r15
            com.google.android.gms.internal.measurement.zzkh.zzq(r1, r4, r15)
            long r4 = r13 + r11
            int r15 = r2 >>> 12
            r15 = r15 & 63
            r11 = 128(0x80, float:1.794E-43)
            ...
            byte r12 = (byte) r12
            com.google.android.gms.internal.measurement.zzkh.zzq(r1, r13, r12)
            r12 = 1
            long r14 = r4 + r12
            int r16 = r2 >>> 6
            r12 = r16 & 63
            r12 = r12 | r11
            byte r12 = (byte) r12
            com.google.android.gms.internal.measurement.zzkh.zzq(r1, r4, r12)
            r4 = 1
            long r12 = r14 + r4
            r2 = r2 & 63
            r2 = r2 | r11
            byte r2 = (byte) r2
            com.google.android.gms.internal.measurement.zzkh.zzq(r1, r14, r2)
            r2 = r3
        L_0x00f6:
            int r2 = r2 + 1
            r3 = 128(0x80, float:1.794E-43)
        ...
        L_0x0101:
            r2 = r3
        L_0x0102:
            com.google.android.gms.internal.measurement.zzkl r0 = new com.google.android.gms.internal.measurement.zzkl
            int r2 = r2 + -1
            r0.<init>(r2, r8)
            throw r0
        L_0x010a:
