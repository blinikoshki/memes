...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$deleteDevice$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$deleteDevice$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final GsonChatApi$deleteDevice$1 INSTANCE = new GsonChatApi$deleteDevice$1();

    GsonChatApi$deleteDevice$1() {
        super(1);
    }
