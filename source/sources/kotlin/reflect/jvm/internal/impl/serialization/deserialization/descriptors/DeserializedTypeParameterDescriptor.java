...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    /* renamed from: c */
    public final DeserializationContext f366c;
    ...
    public List<KotlinType> resolveUpperBounds() {
        List<ProtoBuf.Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.proto, this.f366c.getTypeTable());
        ...
        TypeDeserializer typeDeserializer = this.f366c.getTypeDeserializer();
