...
final class PermissionCheckerFragment$handlePermissionResult$2 extends Lambda implements Function1<AlertBuilder<? extends DialogInterface>, Unit> {
    final /* synthetic */ PermissionCheckerFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PermissionCheckerFragment$handlePermissionResult$2(PermissionCheckerFragment permissionCheckerFragment) {
        super(1);
    ...
    public final void invoke(AlertBuilder<? extends DialogInterface> alertBuilder) {
        ...
        String permanentlyDeniedMessage = access$getQuickPermissionsRequest$p != null ? access$getQuickPermissionsRequest$p.getPermanentlyDeniedMessage() : null;
        if (permanentlyDeniedMessage == null) {
            permanentlyDeniedMessage = "";
        }
        alertBuilder.setMessage(permanentlyDeniedMessage);
        alertBuilder.positiveButton("SETTINGS", (Function1<? super DialogInterface, Unit>) new Function1<DialogInterface, Unit>(this) {
            final /* synthetic */ PermissionCheckerFragment$handlePermissionResult$2 this$0;
            ...
            public final void invoke(DialogInterface dialogInterface) {
                ...
                this.this$0.this$0.openAppSettings();
            }
        });
