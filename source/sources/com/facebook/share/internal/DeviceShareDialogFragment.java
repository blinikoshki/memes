...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        View inflate = getActivity().getLayoutInflater().inflate(C1285R.C1290layout.com_facebook_device_auth_dialog_fragment, (ViewGroup) null);
        this.progressBar = (ProgressBar) inflate.findViewById(C1285R.C1288id.progress_bar);
        ...
        ((TextView) inflate.findViewById(C1285R.C1288id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C1285R.string.com_facebook_device_auth_instructions)));
