...
final class RemoteMemesDataSource$fetchUserTaggedPosts$1<T, R> implements Function<Response<ApiListResponse<Post>>, UniversalResult<Post>> {
    final /* synthetic */ UserProfileRequest $request;

    RemoteMemesDataSource$fetchUserTaggedPosts$1(UserProfileRequest userProfileRequest) {
    ...
    public final UniversalResult<Post> apply(Response<ApiListResponse<Post>> response) {
        ...
        UniversalResult<Post> processListResponse = MemesCoreMapper.INSTANCE.processListResponse(this.$request.getPage(), response);
