...
/* renamed from: com.memes.plus.ui.create_post.ExportPostActivity$attachObservers$9 */
/* compiled from: ExportPostActivity.kt */
final class ExportPostActivity$attachObservers$9<T> implements Observer<SubscriptionCheckResult> {
    final /* synthetic */ ExportPostActivity this$0;

    ExportPostActivity$attachObservers$9(ExportPostActivity exportPostActivity) {
    ...
    public final void onChanged(SubscriptionCheckResult subscriptionCheckResult) {
        if (subscriptionCheckResult == SubscriptionCheckResult.ACTIVE) {
            this.this$0.editorPlan.changePlan(EditorPlanType.Premium);
            this.this$0.updatePremiumButtonLayout(false);
            return;
        }
        this.this$0.updatePremiumButtonLayout(true);
    }
}
