...
public final class ServerEvent extends Message<ServerEvent, Builder> {
    ...
    public static final Double DEFAULT_SERVER_TS = Double.valueOf(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
    ...
    private static final class ProtoAdapter_ServerEvent extends ProtoAdapter<ServerEvent> {
        ...
        public final ServerEvent redact(ServerEvent serverEvent) {
            ...
            if (newBuilder.event_data != null) {
                newBuilder.event_data = ServerEventData.ADAPTER.redact(newBuilder.event_data);
            }
