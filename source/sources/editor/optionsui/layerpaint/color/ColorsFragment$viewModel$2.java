...
final class ColorsFragment$viewModel$2 extends Lambda implements Function0<ColorsViewModel> {
    final /* synthetic */ ColorsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ColorsFragment$viewModel$2(ColorsFragment colorsFragment) {
        super(0);
    ...
    public final ColorsViewModel invoke() {
        ...
        ViewModel viewModel = ViewModelProviders.m18of(requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<ColorsViewModel>(this) {
            final /* synthetic */ ColorsFragment$viewModel$2 this$0;
