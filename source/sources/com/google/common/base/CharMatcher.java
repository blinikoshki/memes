...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m396is(char c) {
        return new C2984Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m396is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo46498or(CharMatcher charMatcher) {
        return new C2985Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m396is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C2985Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C2985Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C2984Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo46498or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo46498or(charMatcher);
        }
