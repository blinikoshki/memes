...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$markAllRead$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$markAllRead$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final GsonChatApi$markAllRead$1 INSTANCE = new GsonChatApi$markAllRead$1();

    GsonChatApi$markAllRead$1() {
        super(1);
    }
