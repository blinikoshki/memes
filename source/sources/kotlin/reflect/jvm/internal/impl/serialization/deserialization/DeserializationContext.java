...
public final class DeserializationContext {
    ...
    public DeserializationContext(DeserializationComponents deserializationComponents, NameResolver nameResolver2, DeclarationDescriptor declarationDescriptor, TypeTable typeTable2, VersionRequirementTable versionRequirementTable2, BinaryVersion binaryVersion, DeserializedContainerSource deserializedContainerSource, TypeDeserializer typeDeserializer2, List<ProtoBuf.TypeParameter> list) {
        ...
        this.containerSource = deserializedContainerSource2;
        String str2 = "Deserializer for \"" + declarationDescriptor.getName() + Typography.quote;
        if (deserializedContainerSource2 == null || (presentableString = deserializedContainerSource.getPresentableString()) == null) {
            str = "[container not found]";
        } else {
            str = presentableString;
        }
        this.typeDeserializer = new TypeDeserializer(this, typeDeserializer2, list, str2, str, false, 32, (DefaultConstructorMarker) null);
