...
/* renamed from: io.getstream.chat.android.client.ChatClient$banUser$1 */
/* compiled from: ChatClient.kt */
final class ChatClient$banUser$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final ChatClient$banUser$1 INSTANCE = new ChatClient$banUser$1();

    ChatClient$banUser$1() {
        super(1);
    }
