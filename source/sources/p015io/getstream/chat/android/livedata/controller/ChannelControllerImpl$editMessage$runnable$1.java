...
/* renamed from: io.getstream.chat.android.livedata.controller.ChannelControllerImpl$editMessage$runnable$1 */
/* compiled from: ChannelControllerImpl.kt */
final class ChannelControllerImpl$editMessage$runnable$1 extends Lambda implements Function0<Call<Message>> {
    final /* synthetic */ Ref.ObjectRef $editedMessage;
    final /* synthetic */ ChannelControllerImpl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChannelControllerImpl$editMessage$runnable$1(ChannelControllerImpl channelControllerImpl, Ref.ObjectRef objectRef) {
        super(0);
    ...
    public final Call<Message> invoke() {
        return this.this$0.getClient().updateMessage((Message) this.$editedMessage.element);
    }
}
