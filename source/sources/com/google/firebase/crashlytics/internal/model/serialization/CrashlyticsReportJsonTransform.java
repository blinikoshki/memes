...
public class CrashlyticsReportJsonTransform {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 719853845:
                    ...
                    break;
                case 1874684019:
                    if (nextName.equals(ServerParameters.PLATFORM)) {
                        c = 5;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -1606742899:
                    ...
                    break;
                case -1335157162:
                    if (nextName.equals(ServerParameters.DEVICE_KEY)) {
                        c = 3;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 94848180:
                    ...
                    break;
                case 104069929:
                    if (nextName.equals(ServerParameters.MODEL)) {
                        c = 6;
                        break;
                    }
                    break;
    ...
    private static CrashlyticsReport.Session.Event.Device parseEventDevice(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case -1708606089:
                    if (nextName.equals(ServerParameters.DEVICE_CURRENT_BATTERY_LEVEL)) {
                        c = 0;
                        break;
                    }
                    break;
