...
final class GiphyGifsFragment$onViewCreated$4 implements View.OnClickListener {
    final /* synthetic */ GiphyGifsFragment this$0;

    GiphyGifsFragment$onViewCreated$4(GiphyGifsFragment giphyGifsFragment) {
        this.this$0 = giphyGifsFragment;
    }

    public final void onClick(View view) {
        EditText editText = GiphyGifsFragment.access$getBinding$p(this.this$0).includedSearchLayout.searchEditText;
