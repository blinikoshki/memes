...
final class RemoteMemesDataSource$fetchUserPosts$1<T, R> implements Function<Response<ApiListResponse<Post>>, UniversalResult<Post>> {
    final /* synthetic */ UserProfileRequest $request;

    RemoteMemesDataSource$fetchUserPosts$1(UserProfileRequest userProfileRequest) {
