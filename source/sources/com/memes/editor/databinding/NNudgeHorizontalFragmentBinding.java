...
public final class NNudgeHorizontalFragmentBinding implements ViewBinding {
    ...
    private NNudgeHorizontalFragmentBinding(LinearLayout linearLayout, NudgeButton nudgeButton, CancelDoneFooter cancelDoneFooter, NudgeButton nudgeButton2, NudgeButton nudgeButton3, NudgeButton nudgeButton4) {
    ...
    public static NNudgeHorizontalFragmentBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static NNudgeHorizontalFragmentBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C4175R.C4181layout.n_nudge_horizontal_fragment, viewGroup, false);
        if (z) {
    ...
    public static NNudgeHorizontalFragmentBinding bind(View view) {
                ...
                if (nudgeButton2 != null) {
                    ...
                    if (nudgeButton3 != null) {
                        ...
                        if (nudgeButton4 != null) {
                            return new NNudgeHorizontalFragmentBinding((LinearLayout) view, nudgeButton, cancelDoneFooter, nudgeButton2, nudgeButton3, nudgeButton4);
                        }
                    }
                }
            }
