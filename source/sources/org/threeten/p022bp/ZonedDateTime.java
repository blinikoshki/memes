...
public final class ZonedDateTime extends ChronoZonedDateTime<LocalDate> implements Temporal, Serializable {
    ...
    /* renamed from: of */
    public static ZonedDateTime m271of(LocalDate localDate, LocalTime localTime, ZoneId zoneId) {
        return m272of(LocalDateTime.m251of(localDate, localTime), zoneId);
    }

    /* renamed from: of */
    public static ZonedDateTime m272of(LocalDateTime localDateTime, ZoneId zoneId) {
        return ofLocal(localDateTime, zoneId, (ZoneOffset) null);
    }

    /* renamed from: of */
    public static ZonedDateTime m270of(int i, int i2, int i3, int i4, int i5, int i6, int i7, ZoneId zoneId) {
        return ofLocal(LocalDateTime.m247of(i, i2, i3, i4, i5, i6, i7), zoneId, (ZoneOffset) null);
    }
    ...
    public static org.threeten.p022bp.ZonedDateTime from(org.threeten.p022bp.temporal.TemporalAccessor r4) {
        /*
            boolean r0 = r4 instanceof org.threeten.p022bp.ZonedDateTime
            if (r0 == 0) goto L_0x0007
            org.threeten.bp.ZonedDateTime r4 = (org.threeten.p022bp.ZonedDateTime) r4
            return r4
        L_0x0007:
            org.threeten.bp.ZoneId r0 = org.threeten.p022bp.ZoneId.from(r4)     // Catch:{ DateTimeException -> 0x002d }
            org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.INSTANT_SECONDS     // Catch:{ DateTimeException -> 0x002d }
            boolean r1 = r4.isSupported(r1)     // Catch:{ DateTimeException -> 0x002d }
            if (r1 == 0) goto L_0x0024
            org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.INSTANT_SECONDS     // Catch:{ DateTimeException -> 0x0024 }
            long r1 = r4.getLong(r1)     // Catch:{ DateTimeException -> 0x0024 }
            org.threeten.bp.temporal.ChronoField r3 = org.threeten.p022bp.temporal.ChronoField.NANO_OF_SECOND     // Catch:{ DateTimeException -> 0x0024 }
            int r3 = r4.get(r3)     // Catch:{ DateTimeException -> 0x0024 }
            org.threeten.bp.ZonedDateTime r4 = create(r1, r3, r0)     // Catch:{ DateTimeException -> 0x0024 }
            return r4
        L_0x0024:
            org.threeten.bp.LocalDateTime r1 = org.threeten.p022bp.LocalDateTime.from(r4)     // Catch:{ DateTimeException -> 0x002d }
            org.threeten.bp.ZonedDateTime r4 = m272of(r1, r0)     // Catch:{ DateTimeException -> 0x002d }
            return r4
        L_0x002d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.ZonedDateTime.from(org.threeten.bp.temporal.TemporalAccessor):org.threeten.bp.ZonedDateTime");
    }
    ...
    static /* synthetic */ class C25162 {
        ...
        static {
            /*
                ...
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.INSTANT_SECONDS     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$org$threeten$bp$temporal$ChronoField     // Catch:{ NoSuchFieldError -> 0x001d }
                org.threeten.bp.temporal.ChronoField r1 = org.threeten.p022bp.temporal.ChronoField.OFFSET_SECONDS     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.threeten.p022bp.ZonedDateTime.C25162.<clinit>():void");
        }
    }
    ...
    public int get(TemporalField temporalField) {
        ...
        int i = C25162.$SwitchMap$org$threeten$bp$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
        if (i == 1) {
    ...
    public ZonedDateTime with(TemporalAdjuster temporalAdjuster) {
        if (temporalAdjuster instanceof LocalDate) {
            return resolveLocal(LocalDateTime.m251of((LocalDate) temporalAdjuster, this.dateTime.toLocalTime()));
        }
        if (temporalAdjuster instanceof LocalTime) {
            return resolveLocal(LocalDateTime.m251of(this.dateTime.toLocalDate(), (LocalTime) temporalAdjuster));
        }
    ...
    public ZonedDateTime with(TemporalField temporalField, long j) {
        ...
        int i = C25162.$SwitchMap$org$threeten$bp$temporal$ChronoField[chronoField.ordinal()];
        if (i == 1) {
    ...
    public OffsetDateTime toOffsetDateTime() {
        return OffsetDateTime.m260of(this.dateTime, this.offset);
    }
