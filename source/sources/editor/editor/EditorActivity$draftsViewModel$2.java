...
final class EditorActivity$draftsViewModel$2 extends Lambda implements Function0<EditorDraftsViewModel> {
    final /* synthetic */ EditorActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EditorActivity$draftsViewModel$2(EditorActivity editorActivity) {
        super(0);
    ...
    public final EditorDraftsViewModel invoke() {
        ViewModel viewModel = ViewModelProviders.m18of((FragmentActivity) this.this$0, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<EditorDraftsViewModel>(this) {
            final /* synthetic */ EditorActivity$draftsViewModel$2 this$0;
