...
public class GlPhotoColorBalanceFilter extends GlPhotoFilter {
    ...
    public GlPhotoColorBalanceFilter() {
        super(GlPhotoFilter.NO_FILTER_VERTEX_SHADER, GPU_IMAGE_COLOR_BALANCE_FRAGMENT_SHADER);
    }
