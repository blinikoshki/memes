...
final /* synthetic */ class AssertionsKt__AssertionsKt {
    ...
    public static final Throwable checkResultIsFailure(String str, Object obj) {
        ...
        Unit unit = (Unit) obj;
        Asserter asserter = AssertionsKt.getAsserter();
        asserter.fail(UtilsKt.messagePrefix(str) + "Expected an exception to be thrown, but was completed successfully.");
        throw new KotlinNothingValueException();
    }
    ...
    static /* synthetic */ Throwable assertFailsWith$default(String str, Function0 function0, int i, Object obj) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            obj2 = Result.m1029constructorimpl(function0.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj2 = Result.m1029constructorimpl(ResultKt.createFailure(th));
        }
