...
/* renamed from: io.getstream.chat.android.livedata.ChatDomainImpl$syncModule$2 */
/* compiled from: ChatDomainImpl.kt */
final class ChatDomainImpl$syncModule$2 extends Lambda implements Function0<SyncProvider> {
    final /* synthetic */ ChatDomainImpl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChatDomainImpl$syncModule$2(ChatDomainImpl chatDomainImpl) {
        super(0);
