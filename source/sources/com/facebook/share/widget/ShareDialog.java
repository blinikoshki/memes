...
public final class ShareDialog extends FacebookDialogBase<ShareContent, Sharer.Result> implements Sharer {
    ...
    public List<FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler> getOrderedModeHandlers() {
        ...
        arrayList.add(new NativeHandler(this, (C16601) null));
        arrayList.add(new FeedHandler(this, (C16601) null));
        arrayList.add(new WebShareHandler(this, (C16601) null));
        arrayList.add(new CameraEffectHandler(this, (C16601) null));
        arrayList.add(new ShareStoryHandler(this, (C16601) null));
        return arrayList;
    }
    ...
    private class NativeHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ NativeHandler(ShareDialog shareDialog, C16601 r2) {
            this();
        }
    ...
    private class WebShareHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ WebShareHandler(ShareDialog shareDialog, C16601 r2) {
            this();
        }
    ...
    private class FeedHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ FeedHandler(ShareDialog shareDialog, C16601 r2) {
            this();
        }
    ...
    private class CameraEffectHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ CameraEffectHandler(ShareDialog shareDialog, C16601 r2) {
            this();
        }
    ...
    private class ShareStoryHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ ShareStoryHandler(ShareDialog shareDialog, C16601 r2) {
            this();
        }
    ...
    public void logDialogShare(Context context, ShareContent shareContent, Mode mode) {
        ...
        int i = C16601.$SwitchMap$com$facebook$share$widget$ShareDialog$Mode[mode.ordinal()];
        String str = "unknown";
    ...
    static /* synthetic */ class C16601 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.widget.ShareDialog.C16601.<clinit>():void");
        }
    }
}
