...
public final class HmacKeyManager extends KeyTypeManager<HmacKey> {
    ...
    public HmacKeyManager() {
        super(HmacKey.class, new KeyTypeManager.PrimitiveFactory<Mac, HmacKey>(Mac.class) {
            public Mac getPrimitive(HmacKey hmacKey) throws GeneralSecurityException {
                ...
                int i = C35173.$SwitchMap$com$google$crypto$tink$proto$HashType[hash.ordinal()];
                if (i == 1) {
    ...
    static /* synthetic */ class C35173 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.mac.HmacKeyManager.C35173.<clinit>():void");
        }
    }
    ...
    public static void validateParams(HmacParams hmacParams) throws GeneralSecurityException {
        if (hmacParams.getTagSize() >= 10) {
            int i = C35173.$SwitchMap$com$google$crypto$tink$proto$HashType[hmacParams.getHash().ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
