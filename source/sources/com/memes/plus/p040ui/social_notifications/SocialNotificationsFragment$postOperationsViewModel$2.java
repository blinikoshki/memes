...
/* renamed from: com.memes.plus.ui.social_notifications.SocialNotificationsFragment$postOperationsViewModel$2 */
/* compiled from: SocialNotificationsFragment.kt */
final class SocialNotificationsFragment$postOperationsViewModel$2 extends Lambda implements Function0<PostOperationsViewModel> {
    final /* synthetic */ SocialNotificationsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SocialNotificationsFragment$postOperationsViewModel$2(SocialNotificationsFragment socialNotificationsFragment) {
        super(0);
    ...
    public final PostOperationsViewModel invoke() {
        ...
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) requireActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<PostOperationsViewModel>(this) {
            final /* synthetic */ SocialNotificationsFragment$postOperationsViewModel$2 this$0;
