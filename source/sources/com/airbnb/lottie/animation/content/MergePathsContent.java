...
public class MergePathsContent implements PathContent, GreedyContent {
    ...
    public Path getPath() {
        this.path.reset();
        int i = C09871.f91x7df623d1[this.mergePaths.getMode().ordinal()];
        if (i == 1) {
            addPaths();
        } else if (i == 2) {
    ...
    static /* synthetic */ class C09871 {
        ...
        static final /* synthetic */ int[] f91x7df623d1;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f91x7df623d1     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f91x7df623d1     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f91x7df623d1     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f91x7df623d1     // Catch:{ NoSuchFieldError -> 0x003e }
                com.airbnb.lottie.model.content.MergePaths$MergePathsMode r1 = com.airbnb.lottie.model.content.MergePaths.MergePathsMode.ExcludeIntersections     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.animation.content.MergePathsContent.C09871.<clinit>():void");
        }
    }
