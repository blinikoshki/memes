...
class UtcDates {
    ...
    static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        return localizedPattern.replaceAll("d", resources.getString(C2727R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", resources.getString(C2727R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", resources.getString(C2727R.string.mtrl_picker_text_input_year_abbr));
    }
    ...
    private static String removeYearFromDateFormatPattern(String str) {
        ...
        if (findCharactersInDateFormatPattern2 < str.length()) {
            str2 = str2 + Util.EVENT_ID_SEPARATOR;
        }
