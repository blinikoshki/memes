...
import com.google.android.gms.internal.p026firebaseauthapi.zzup;
...
public final class zzf {
    ...
    public final Task<zze> zzb(FirebaseAuth firebaseAuth, String str, Activity activity, boolean z) {
        ...
        if (client == null || zzw.zze()) {
            ...
            client.attest(bArr, app.getOptions().getApiKey()).addOnSuccessListener(new zzb(this, taskCompletionSource, firebaseAuth, zza2, activity)).addOnFailureListener(new zza(this, firebaseAuth, zza2, activity, taskCompletionSource));
        }
