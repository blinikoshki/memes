...
final class EditorActivity$textSpacingViewModel$2 extends Lambda implements Function0<TextSpacingViewModel> {
    final /* synthetic */ EditorActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EditorActivity$textSpacingViewModel$2(EditorActivity editorActivity) {
        super(0);
    ...
    public final TextSpacingViewModel invoke() {
        ...
        Function0 function0 = C46841.INSTANCE;
        if (function0 == null) {
            viewModel = ViewModelProviders.m17of((FragmentActivity) editorActivity).get(TextSpacingViewModel.class);
            Intrinsics.checkNotNullExpressionValue(viewModel, "ViewModelProviders.of(this).get(T::class.java)");
        } else {
            viewModel = ViewModelProviders.m18of((FragmentActivity) editorActivity, (ViewModelProvider.Factory) new BaseViewModelFactory(function0)).get(TextSpacingViewModel.class);
