...
/* renamed from: com.memes.plus.ui.editorproxy.VideoTrimmerProxyActivity$subscriptionStatusViewModel$2 */
/* compiled from: VideoTrimmerProxyActivity.kt */
final class VideoTrimmerProxyActivity$subscriptionStatusViewModel$2 extends Lambda implements Function0<SubscriptionStatusViewModel> {
    final /* synthetic */ VideoTrimmerProxyActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoTrimmerProxyActivity$subscriptionStatusViewModel$2(VideoTrimmerProxyActivity videoTrimmerProxyActivity) {
        super(0);
        this.this$0 = videoTrimmerProxyActivity;
    }
    ...
    public final SubscriptionStatusViewModel invoke() {
        ViewModel viewModel = new ViewModelProvider((ViewModelStoreOwner) this.this$0, (ViewModelProvider.Factory) new BaseViewModelFactory(new Function0<SubscriptionStatusViewModel>(this) {
            final /* synthetic */ VideoTrimmerProxyActivity$subscriptionStatusViewModel$2 this$0;
