...
final class TextFontsAdapter$layoutInflater$2 extends Lambda implements Function0<LayoutInflater> {
    final /* synthetic */ TextFontsAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TextFontsAdapter$layoutInflater$2(TextFontsAdapter textFontsAdapter) {
        super(0);
