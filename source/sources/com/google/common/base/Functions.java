...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f593f;

        /* renamed from: g */
        private final Function<B, C> f594g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f594g = (Function) Preconditions.checkNotNull(function);
            this.f593f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f594g.apply(this.f593f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f593f.equals(functionComposition.f593f) || !this.f594g.equals(functionComposition.f594g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f593f.hashCode() ^ this.f594g.hashCode();
        }

        public String toString() {
            return this.f594g + "(" + this.f593f + ")";
        }
    }
