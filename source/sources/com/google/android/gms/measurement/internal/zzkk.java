...
public final class zzkk extends zzgf {
    ...
    static boolean zzP(Context context, boolean z) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            return zzaq(context, "com.google.android.gms.measurement.AppMeasurementJobService");
        }
        return zzaq(context, "com.google.android.gms.measurement.AppMeasurementService");
    }
    ...
    private final int zzap(String str) {
        if ("_ldl".equals(str)) {
            ...
            this.zzx.zzc();
            return 256;
        } else if (!this.zzx.zzc().zzn((String) null, zzdw.zzaf) || !"_lgclid".equals(str)) {
            this.zzx.zzc();
            return 36;
        } else {
            this.zzx.zzc();
    ...
    public final boolean zzA(String str, String str2, String str3) {
        if (TextUtils.isEmpty(str)) {
            zzmg.zzb();
            if (this.zzx.zzc().zzn((String) null, zzdw.zzah) && !TextUtils.isEmpty(str3)) {
                return true;
            }
    ...
    public final int zzD(java.lang.String r15, java.lang.String r16, java.lang.String r17, java.lang.Object r18, android.os.Bundle r19, java.util.List<java.lang.String> r20, boolean r21, boolean r22) {
        /*
            ...
            java.lang.String[] r2 = com.google.android.gms.measurement.internal.zzgj.zzc
            boolean r2 = zzar(r8, r2)
            if (r2 != 0) goto L_0x0022
            r0 = 20
            return r0
        L_0x0022:
            com.google.android.gms.measurement.internal.zzfl r2 = r7.zzx
            com.google.android.gms.measurement.internal.zzjb r2 = r2.zzy()
            r2.zzg()
            r2.zzb()
            boolean r6 = r2.zzD()
        ...
        L_0x0060:
            ...
            com.google.android.gms.measurement.internal.zzfl r10 = r7.zzx
            com.google.android.gms.measurement.internal.zzei r10 = r10.zzat()
            com.google.android.gms.measurement.internal.zzeg r10 = r10.zzh()
            java.lang.Integer r6 = java.lang.Integer.valueOf(r6)
            java.lang.String r11 = "Parameter array is too long; discarded. Value kind, name, array length"
            r10.zzd(r11, r3, r8, r6)
            com.google.android.gms.measurement.internal.zzfl r6 = r7.zzx
            r6.zzc()
        ...
        L_0x00ae:
            ...
            com.google.android.gms.measurement.internal.zzdv<java.lang.Boolean> r2 = com.google.android.gms.measurement.internal.zzdw.zzR
            r10 = r15
        ...
        L_0x0100:
            ...
            com.google.android.gms.measurement.internal.zzeg r1 = r1.zzh()
    ...
    public final android.os.Bundle zzF(java.lang.String r21, java.lang.String r22, android.os.Bundle r23, java.util.List<java.lang.String> r24, boolean r25) {
        /*
            ...
            r11 = r23
            r12 = r24
            java.lang.String[] r0 = com.google.android.gms.measurement.internal.zzgi.zzd
            boolean r13 = zzar(r10, r0)
            ...
            com.google.android.gms.measurement.internal.zzfl r0 = r9.zzx
            com.google.android.gms.measurement.internal.zzae r0 = r0.zzc()
            com.google.android.gms.measurement.internal.zzdv<java.lang.Boolean> r1 = com.google.android.gms.measurement.internal.zzdw.zzX
            r8 = r21
        ...
        L_0x00d0:
            ...
            com.google.android.gms.measurement.internal.zzfl r2 = r9.zzx
            ...
            com.google.android.gms.measurement.internal.zzfl r4 = r9.zzx
            com.google.android.gms.measurement.internal.zzed r4 = r4.zzm()
    ...
    /* access modifiers changed from: package-private */
    public final void zzG(zzej zzej, int i) {
        int i2 = 0;
        for (String str : new TreeSet(zzej.zzd.keySet())) {
            if (zzh(str) && (i2 = i2 + 1) > i) {
                ...
                sb.append(i);
                sb.append(" params");
                this.zzx.zzat().zzd().zzc(sb.toString(), this.zzx.zzm().zzc(zzej.zza), this.zzx.zzm().zzf(zzej.zzd));
                zzam(zzej.zzd, 5);
                zzej.zzd.remove(str);
            }
        }
    ...
    public final int zzJ(String str, Object obj) {
        boolean z;
        if ("_ldl".equals(str)) {
            z = zzt("user property referrer", str, zzap(str), obj);
        } else {
            z = zzt("user property", str, zzap(str), obj);
        }
        return z ? 0 : 7;
    }
    ...
    public final Object zzK(String str, Object obj) {
        if ("_ldl".equals(str)) {
            return zzao(zzap(str), obj, true, false);
        }
        return zzao(zzap(str), obj, false, false);
    }
    ...
    /* access modifiers changed from: package-private */
    public final void zzM(zzkj zzkj, String str, int i, String str2, String str3, int i2) {
        Bundle bundle = new Bundle();
        zzam(bundle, i);
        ...
        zzkw.zzb();
        if (this.zzx.zzc().zzn((String) null, zzdw.zzaA)) {
            zzkj.zza(str, bundle);
            return;
        }
        this.zzx.zzas();
        this.zzx.zzk().zzs(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_err", bundle);
    }
    ...
    public final boolean zzW(Context context, String str) {
        ...
        try {
            ...
            this.zzx.zzat().zzb().zzb("Error obtaining certificate", e);
            return true;
        } catch (PackageManager.NameNotFoundException e2) {
            this.zzx.zzat().zzb().zzb("Package name not found", e2);
            return true;
        }
    }
    ...
    public final void zzad(zzs zzs, String str) {
        Bundle bundle = new Bundle();
    ...
    public final void zzae(zzs zzs, long j) {
        Bundle bundle = new Bundle();
        bundle.putLong("r", j);
        try {
            zzs.zzb(bundle);
    ...
    public final void zzaf(zzs zzs, int i) {
        Bundle bundle = new Bundle();
        bundle.putInt("r", i);
        try {
            zzs.zzb(bundle);
    ...
    public final void zzag(zzs zzs, byte[] bArr) {
        Bundle bundle = new Bundle();
    ...
    public final void zzah(zzs zzs, boolean z) {
        Bundle bundle = new Bundle();
    ...
    public final void zzai(zzs zzs, Bundle bundle) {
        try {
            zzs.zzb(bundle);
        } catch (RemoteException e) {
    ...
    public final void zzaj(zzs zzs, ArrayList<Bundle> arrayList) {
        Bundle bundle = new Bundle();
    ...
    public final URL zzal(long j, String str, String str2, long j2) {
        try {
            ...
            Preconditions.checkNotEmpty(str);
            String format = String.format("https://www.googleadservices.com/pagead/conversion/app/deeplink?id_type=adid&sdk_version=%s&rdid=%s&bundleid=%s&retry=%s", new Object[]{String.format("v%s.%s", new Object[]{39000L, Integer.valueOf(zzZ())}), str2, str, Long.valueOf(j2)});
    ...
    public final long zzd() {
        ...
        if (this.zze.get() == 0) {
            synchronized (this.zze) {
                long nextLong = new Random(System.nanoTime() ^ this.zzx.zzax().currentTimeMillis()).nextLong();
                int i = this.zzf + 1;
                this.zzf = i;
                j = nextLong + ((long) i);
            }
    ...
    public final int zzo(String str) {
        ...
        if (!zzl("user property", zzgk.zza, (String[]) null, str)) {
            return 15;
        }
        this.zzx.zzc();
            ...
            for (String str6 : new TreeSet(bundle.keySet())) {
                ...
                if (i != 0) {
                    ...
                    if (zzs(bundle2.get(str6))) {
                        this.zzx.zzat().zzh().zzd("Nested Bundle parameters are not allowed; discarded. event name, param name, child param name", str5, str3, str6);
                        str4 = str6;
                        i2 = 22;
                    } else {
                        String str7 = str3;
                    ...
                    if (i2 != 0 && !"_ev".equals(str4)) {
                        ...
                        bundle2.remove(str4);
                    } else if (zzh(str4) && !zzar(str4, zzgj.zzd) && (i3 = i3 + 1) > 0) {
                        this.zzx.zzat().zzd().zzc("Item cannot contain custom parameters", this.zzx.zzm().zzc(str5), this.zzx.zzm().zzf(bundle2));
                        zzam(bundle2, 23);
                        bundle2.remove(str4);
                    }
                }
