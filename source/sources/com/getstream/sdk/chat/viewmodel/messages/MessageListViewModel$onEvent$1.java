...
final class MessageListViewModel$onEvent$1<T> implements Call.Callback<Message> {
    final /* synthetic */ MessageListViewModel this$0;

    MessageListViewModel$onEvent$1(MessageListViewModel messageListViewModel) {
    ...
    public final void onResult(Result<Message> result) {
        ...
        if (result.isSuccess()) {
            this.this$0._targetMessage.setValue(result.data());
        }
    }
}
