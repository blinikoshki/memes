...
@Metadata(mo26105bv = {1, 0, 3}, mo26106d1 = {"\u0000/\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00020\u0001J\u0018\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tH\u0016J\u0010\u0010\n\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\fH\u0016J\u0016\u0010\r\u001a\u00020\u00052\f\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002H\u0016¨\u0006\u000f"}, mo26107d2 = {"com/memes/plus/ui/profile/user_profile/UserProfileViewModel$fetchPosts$1", "Lcom/memes/plus/util/SmartSingleObserver;", "Lcom/memes/plus/data/mapped_response/UniversalResult;", "Lcom/memes/plus/ui/posts/Post;", "onError", "", "message", "", "throwable", "", "onSubscribe", "d", "Lio/reactivex/disposables/Disposable;", "onSuccess", "universalResult", "app_release"}, mo26108k = 1, mo26109mv = {1, 4, 2})
/* renamed from: com.memes.plus.ui.profile.user_profile.UserProfileViewModel$fetchPosts$1 */
/* compiled from: UserProfileViewModel.kt */
public final class UserProfileViewModel$fetchPosts$1 extends SmartSingleObserver<UniversalResult<Post>> {
    final /* synthetic */ UserProfileViewModel this$0;

    UserProfileViewModel$fetchPosts$1(UserProfileViewModel userProfileViewModel) {
    ...
    public void onSuccess(UniversalResult<Post> universalResult) {
        ...
        if (universalResult.isError()) {
            ...
            this.this$0.getPostsLiveData().setValue(new AdapterUpdate(0, universalResult.getItems(), 1, (DefaultConstructorMarker) null));
    ...
    public void onError(String str, Throwable th) {
        ...
        UserProfileViewModel userProfileViewModel = this.this$0;
        userProfileViewModel.showError(userProfileViewModel.getPostsContentLayoutLiveData(), str);
        this.this$0.setSeeMoreButtonVisibility(false);
    }
}
