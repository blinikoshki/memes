...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    @p015io.reactivex.annotations.BackpressureSupport(p015io.reactivex.annotations.BackpressureKind.FULL)
    @p015io.reactivex.annotations.SchedulerSupport("none")
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <T, R> p015io.reactivex.Flowable<R> zip(org.reactivestreams.Publisher<? extends org.reactivestreams.Publisher<? extends T>> r1, p015io.reactivex.functions.Function<? super java.lang.Object[], ? extends R> r2) {
        /*
            java.lang.String r0 = "zipper is null"
            p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r2, (java.lang.String) r0)
            io.reactivex.Flowable r1 = fromPublisher(r1)
            io.reactivex.Single r1 = r1.toList()
            io.reactivex.functions.Function r2 = p015io.reactivex.internal.operators.flowable.FlowableInternalHelper.zipIterable(r2)
            io.reactivex.Flowable r1 = r1.flatMapPublisher(r2)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.Flowable.zip(org.reactivestreams.Publisher, io.reactivex.functions.Function):io.reactivex.Flowable");
    }
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo23472as(FlowableConverter<T, ? extends R> flowableConverter) {
    ...
    @p015io.reactivex.annotations.SchedulerSupport("none")
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final <U, V> p015io.reactivex.Flowable<T> delay(org.reactivestreams.Publisher<U> r1, p015io.reactivex.functions.Function<? super T, ? extends org.reactivestreams.Publisher<V>> r2) {
        /*
            r0 = this;
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.Flowable.delay(org.reactivestreams.Publisher, io.reactivex.functions.Function):io.reactivex.Flowable");
    }
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo23796to(Function<? super Flowable<T>, R> function) {
        try {
