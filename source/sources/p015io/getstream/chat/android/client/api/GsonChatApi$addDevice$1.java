...
/* renamed from: io.getstream.chat.android.client.api.GsonChatApi$addDevice$1 */
/* compiled from: GsonChatApi.kt */
final class GsonChatApi$addDevice$1 extends Lambda implements Function1<CompletableResponse, Unit> {
    public static final GsonChatApi$addDevice$1 INSTANCE = new GsonChatApi$addDevice$1();

    GsonChatApi$addDevice$1() {
        super(1);
    }
